...
// AI Generated Motion Component for: minus-vertical
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for minus-vertical (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-minus-vertical {
...
@keyframes motion-ai-idle-minus-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-minus-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-minus-vertical 3s ease-in-out infinite alternate;
}
</style>