...
// AI Generated Motion Component for: briefcase-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for briefcase-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-briefcase-off {
...
@keyframes motion-ai-idle-briefcase-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-briefcase-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-briefcase-off 3s ease-in-out infinite alternate;
}
</style>