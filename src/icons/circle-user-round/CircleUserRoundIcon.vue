...
// AI Generated Motion Component for: circle-user-round
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circle-user-round (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circle-user-round {
...
@keyframes motion-ai-idle-circle-user-round {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circle-user-round 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circle-user-round 3s ease-in-out infinite alternate;
}
</style>