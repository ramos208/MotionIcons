...
// AI Generated Motion Component for: brand-swift
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-swift (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-swift {
...
@keyframes motion-ai-idle-brand-swift {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-swift 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-swift 3s ease-in-out infinite alternate;
}
</style>