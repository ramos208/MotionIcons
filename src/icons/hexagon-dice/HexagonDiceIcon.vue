...
// AI Generated Motion Component for: hexagon-dice
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hexagon-dice (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hexagon-dice {
...
@keyframes motion-ai-idle-hexagon-dice {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hexagon-dice 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hexagon-dice 3s ease-in-out infinite alternate;
}
</style>