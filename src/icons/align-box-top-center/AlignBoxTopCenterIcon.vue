...
@keyframes motion-ai-align-box-top-center {
...
@keyframes motion-ai-idle-align-box-top-center {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-align-box-top-center 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-align-box-top-center 3s ease-in-out infinite alternate;
}
</style>