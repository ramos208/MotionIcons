...
// AI Generated Motion Component for: badge-cent
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for badge-cent (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-badge-cent {
...
@keyframes motion-ai-idle-badge-cent {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-cent 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-cent 3s ease-in-out infinite alternate;
}
</style>