...
// AI Generated Motion Component for: trending-down-3
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for trending-down-3 (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-trending-down-3 {
...
@keyframes motion-ai-idle-trending-down-3 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-trending-down-3 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-trending-down-3 3s ease-in-out infinite alternate;
}
</style>