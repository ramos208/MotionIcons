...
// AI Generated Motion Component for: topology-complex
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for topology-complex (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-topology-complex {
...
@keyframes motion-ai-idle-topology-complex {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-topology-complex 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-topology-complex 3s ease-in-out infinite alternate;
}
</style>