...
// AI Generated Motion Component for: sort-alpha-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sort-alpha-down (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sort-alpha-down {
...
@keyframes motion-ai-idle-sort-alpha-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sort-alpha-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sort-alpha-down 3s ease-in-out infinite alternate;
}
</style>