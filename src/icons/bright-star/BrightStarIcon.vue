...
// AI Generated Motion Component for: bright-star
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bright-star (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bright-star {
...
@keyframes motion-ai-idle-bright-star {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bright-star 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bright-star 3s ease-in-out infinite alternate;
}
</style>