...
@keyframes motion-ai-idle-sonatype {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sonatype 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sonatype 3s ease-in-out infinite alternate;
}
</style>