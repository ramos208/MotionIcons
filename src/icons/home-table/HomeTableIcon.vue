<template>
  ...
  >
    ...
    >
      <path d="M4 7L4 17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M1 7L23 7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 10L20 10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 7L20 17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: home-table
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for home-table (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-home-table {
...
@keyframes motion-ai-idle-home-table {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-home-table 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-home-table 3s ease-in-out infinite alternate;
}
</style>