...
// AI Generated Motion Component for: folders-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for folders-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-folders-off {
...
@keyframes motion-ai-idle-folders-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-folders-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-folders-off 3s ease-in-out infinite alternate;
}
</style>