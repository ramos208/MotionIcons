...
@keyframes motion-ai-layer-bring-to-front {
...
@keyframes motion-ai-idle-layer-bring-to-front {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-layer-bring-to-front 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-layer-bring-to-front 2.5s ease-in-out infinite alternate;
}
</style>