...
// AI Generated Motion Component for: moon-cloud-big-rain
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for moon-cloud-big-rain (hugeicons). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-moon-cloud-big-rain {
...
@keyframes motion-ai-idle-moon-cloud-big-rain {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-moon-cloud-big-rain 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-moon-cloud-big-rain 3s ease-in-out infinite alternate;
}
</style>