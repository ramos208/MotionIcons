...
// AI Generated Motion Component for: vaccine-bottle-off
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for vaccine-bottle-off (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-vaccine-bottle-off {
...
@keyframes motion-ai-idle-vaccine-bottle-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-vaccine-bottle-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-vaccine-bottle-off 2s ease-in-out infinite alternate;
}
</style>