...
@keyframes motion-ai-chat-download {
...
@keyframes motion-ai-idle-chat-download {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-download 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-download 2.5s ease-in-out infinite alternate;
}
</style>