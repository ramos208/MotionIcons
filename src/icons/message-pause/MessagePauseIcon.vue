...
// AI Generated Motion Component for: message-pause
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-pause (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-pause {
...
@keyframes motion-ai-idle-message-pause {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-pause 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-pause 2.5s ease-in-out infinite alternate;
}
</style>