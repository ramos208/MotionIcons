...
// AI Generated Motion Component for: help-octagon
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for help-octagon (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-help-octagon {
...
@keyframes motion-ai-idle-help-octagon {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-help-octagon 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-help-octagon 3s ease-in-out infinite alternate;
}
</style>