...
// AI Generated Motion Component for: arrow-right-end-on-rectangle
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-right-end-on-rectangle (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-right-end-on-rectangle {
...
@keyframes motion-ai-idle-arrow-right-end-on-rectangle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-right-end-on-rectangle 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-right-end-on-rectangle 3s ease-in-out infinite alternate;
}
</style>