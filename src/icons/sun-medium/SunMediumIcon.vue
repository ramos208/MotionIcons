...
// AI Generated Motion Component for: sun-medium
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for sun-medium (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sun-medium {
...
@keyframes motion-ai-idle-sun-medium {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sun-medium 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sun-medium 3s ease-in-out infinite alternate;
}
</style>