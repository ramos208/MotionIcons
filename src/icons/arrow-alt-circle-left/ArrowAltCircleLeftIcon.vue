...
// AI Generated Motion Component for: arrow-alt-circle-left
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-alt-circle-left (fontawesome). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-alt-circle-left {
...
@keyframes motion-ai-idle-arrow-alt-circle-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-alt-circle-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-alt-circle-left 3s ease-in-out infinite alternate;
}
</style>