...
@keyframes motion-ai-chat-upload {
...
@keyframes motion-ai-idle-chat-upload {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-upload 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-upload 2.5s ease-in-out infinite alternate;
}
</style>