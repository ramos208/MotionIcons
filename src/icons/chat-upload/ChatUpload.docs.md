...
## AI Philosophy
> Dynamic kinetic adaptation for chat-upload (hugeicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
