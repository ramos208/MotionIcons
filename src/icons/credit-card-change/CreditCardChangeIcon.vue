...
@keyframes motion-ai-credit-card-change {
...
@keyframes motion-ai-idle-credit-card-change {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-credit-card-change 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-credit-card-change 3s ease-in-out infinite alternate;
}
</style>