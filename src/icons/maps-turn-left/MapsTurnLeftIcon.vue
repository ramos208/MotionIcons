...
// AI Generated Motion Component for: maps-turn-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for maps-turn-left (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-maps-turn-left {
...
@keyframes motion-ai-idle-maps-turn-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-maps-turn-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-maps-turn-left 3s ease-in-out infinite alternate;
}
</style>