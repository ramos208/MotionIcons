...
@keyframes motion-ai-chat-bubble-warning {
...
@keyframes motion-ai-idle-chat-bubble-warning {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-bubble-warning 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-bubble-warning 2.5s ease-in-out infinite alternate;
}
</style>