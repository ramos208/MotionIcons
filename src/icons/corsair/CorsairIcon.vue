...
@keyframes motion-ai-idle-corsair {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-corsair 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-corsair 2s ease-in-out infinite alternate;
}
</style>