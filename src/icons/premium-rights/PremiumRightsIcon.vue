...
// AI Generated Motion Component for: premium-rights
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for premium-rights (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-premium-rights {
...
@keyframes motion-ai-idle-premium-rights {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-premium-rights 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-premium-rights 3s ease-in-out infinite alternate;
}
</style>