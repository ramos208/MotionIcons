...
@keyframes motion-ai-scooter-electric {
...
@keyframes motion-ai-idle-scooter-electric {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-scooter-electric 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-scooter-electric 3s ease-in-out infinite alternate;
}
</style>