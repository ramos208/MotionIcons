...
@keyframes motion-ai-constrained-surface {
...
@keyframes motion-ai-idle-constrained-surface {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-constrained-surface 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-constrained-surface 3s ease-in-out infinite alternate;
}
</style>