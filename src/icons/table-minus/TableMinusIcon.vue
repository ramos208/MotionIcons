...
// AI Generated Motion Component for: table-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for table-minus (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-table-minus {
...
@keyframes motion-ai-idle-table-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-table-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-table-minus 3s ease-in-out infinite alternate;
}
</style>