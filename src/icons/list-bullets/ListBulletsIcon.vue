...
// AI Generated Motion Component for: list-bullets
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for list-bullets (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-list-bullets {
...
@keyframes motion-ai-idle-list-bullets {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-list-bullets 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-list-bullets 3s ease-in-out infinite alternate;
}
</style>