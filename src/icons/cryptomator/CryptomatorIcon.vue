...
@keyframes motion-ai-cryptomator {
...
@keyframes motion-ai-idle-cryptomator {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cryptomator 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cryptomator 3s ease-in-out infinite alternate;
}
</style>