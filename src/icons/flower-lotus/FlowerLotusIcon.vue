...
// AI Generated Motion Component for: flower-lotus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for flower-lotus (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-flower-lotus {
...
@keyframes motion-ai-idle-flower-lotus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flower-lotus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flower-lotus 3s ease-in-out infinite alternate;
}
</style>