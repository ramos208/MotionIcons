...
// AI Generated Motion Component for: circle-dotted-letter-o
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circle-dotted-letter-o (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circle-dotted-letter-o {
...
@keyframes motion-ai-idle-circle-dotted-letter-o {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circle-dotted-letter-o 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circle-dotted-letter-o 3s ease-in-out infinite alternate;
}
</style>