...
@keyframes motion-ai-bubble-chat-temporary {
...
@keyframes motion-ai-idle-bubble-chat-temporary {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bubble-chat-temporary 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bubble-chat-temporary 2.5s ease-in-out infinite alternate;
}
</style>