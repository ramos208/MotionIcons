...
@keyframes motion-ai-codenewbie {
...
@keyframes motion-ai-idle-codenewbie {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-codenewbie 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-codenewbie 2s ease-in-out infinite alternate;
}
</style>