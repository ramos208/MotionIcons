...
// AI Generated Motion Component for: lens-convex
// Category: search
// Physics Presets: Dynamic kinetic adaptation for lens-convex (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lens-convex {
...
@keyframes motion-ai-idle-lens-convex {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lens-convex 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lens-convex 3s ease-in-out infinite alternate;
}
</style>