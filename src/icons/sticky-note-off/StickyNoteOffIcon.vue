...
// AI Generated Motion Component for: sticky-note-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sticky-note-off (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sticky-note-off {
...
@keyframes motion-ai-idle-sticky-note-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sticky-note-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sticky-note-off 3s ease-in-out infinite alternate;
}
</style>