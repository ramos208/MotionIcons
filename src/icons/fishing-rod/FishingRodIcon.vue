...
// AI Generated Motion Component for: fishing-rod
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for fishing-rod (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-fishing-rod {
...
@keyframes motion-ai-idle-fishing-rod {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-fishing-rod 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-fishing-rod 3s ease-in-out infinite alternate;
}
</style>