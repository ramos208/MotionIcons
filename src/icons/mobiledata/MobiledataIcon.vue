...
// AI Generated Motion Component for: mobiledata
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mobiledata (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mobiledata {
...
@keyframes motion-ai-idle-mobiledata {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mobiledata 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mobiledata 3s ease-in-out infinite alternate;
}
</style>