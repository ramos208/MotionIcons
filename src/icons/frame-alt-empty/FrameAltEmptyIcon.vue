<template>
  ...
  >
    ...
    >
      <path d="M6 3L6 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 3L18 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 6L21 6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 18L21 18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: frame-alt-empty
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for frame-alt-empty (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-frame-alt-empty {
...
@keyframes motion-ai-idle-frame-alt-empty {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-frame-alt-empty 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-frame-alt-empty 3s ease-in-out infinite alternate;
}
</style>