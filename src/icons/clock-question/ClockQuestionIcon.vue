...
// AI Generated Motion Component for: clock-question
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for clock-question (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-clock-question {
...
@keyframes motion-ai-idle-clock-question {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-clock-question 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-clock-question 3s ease-in-out infinite alternate;
}
</style>