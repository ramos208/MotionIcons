...
@keyframes motion-ai-magic-wand04 {
...
@keyframes motion-ai-idle-magic-wand04 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-magic-wand04 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-magic-wand04 2s ease-in-out infinite alternate;
}
</style>