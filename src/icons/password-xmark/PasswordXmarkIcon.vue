...
@keyframes motion-ai-password-xmark {
...
@keyframes motion-ai-idle-password-xmark {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-password-xmark 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-password-xmark 3s ease-in-out infinite alternate;
}
</style>