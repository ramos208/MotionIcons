...
// AI Generated Motion Component for: emoji-look-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for emoji-look-left (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-emoji-look-left {
...
@keyframes motion-ai-idle-emoji-look-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-emoji-look-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-emoji-look-left 3s ease-in-out infinite alternate;
}
</style>