...
@keyframes motion-ai-hand-contactless {
...
@keyframes motion-ai-idle-hand-contactless {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-contactless 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-contactless 3s ease-in-out infinite alternate;
}
</style>