...
// AI Generated Motion Component for: chevrons-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for chevrons-up (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chevrons-up {
...
@keyframes motion-ai-idle-chevrons-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chevrons-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chevrons-up 3s ease-in-out infinite alternate;
}
</style>