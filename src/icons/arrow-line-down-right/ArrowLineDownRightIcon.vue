...
// AI Generated Motion Component for: arrow-line-down-right
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-line-down-right (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-line-down-right {
...
@keyframes motion-ai-idle-arrow-line-down-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-line-down-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-line-down-right 3s ease-in-out infinite alternate;
}
</style>