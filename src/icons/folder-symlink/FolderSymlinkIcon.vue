...
@keyframes motion-ai-folder-symlink {
...
@keyframes motion-ai-idle-folder-symlink {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-folder-symlink 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-folder-symlink 3s ease-in-out infinite alternate;
}
</style>