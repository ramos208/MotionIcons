...
// AI Generated Motion Component for: legal-hammer
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for legal-hammer (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-legal-hammer {
...
@keyframes motion-ai-idle-legal-hammer {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-legal-hammer 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-legal-hammer 3s ease-in-out infinite alternate;
}
</style>