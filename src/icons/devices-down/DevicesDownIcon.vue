...
// AI Generated Motion Component for: devices-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for devices-down (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-devices-down {
...
@keyframes motion-ai-idle-devices-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-devices-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-devices-down 3s ease-in-out infinite alternate;
}
</style>