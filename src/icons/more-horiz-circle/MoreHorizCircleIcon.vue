...
@keyframes motion-ai-more-horiz-circle {
...
@keyframes motion-ai-idle-more-horiz-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-more-horiz-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-more-horiz-circle 3s ease-in-out infinite alternate;
}
</style>