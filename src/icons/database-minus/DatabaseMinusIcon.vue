...
// AI Generated Motion Component for: database-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for database-minus (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-database-minus {
...
@keyframes motion-ai-idle-database-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-database-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-database-minus 3s ease-in-out infinite alternate;
}
</style>