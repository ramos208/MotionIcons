...
// AI Generated Motion Component for: ev-charger
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ev-charger (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ev-charger {
...
@keyframes motion-ai-idle-ev-charger {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ev-charger 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ev-charger 3s ease-in-out infinite alternate;
}
</style>