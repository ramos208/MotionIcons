...
// AI Generated Motion Component for: arrow-down-bar
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-down-bar (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-down-bar {
...
@keyframes motion-ai-idle-arrow-down-bar {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-down-bar 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-down-bar 3s ease-in-out infinite alternate;
}
</style>