...
// AI Generated Motion Component for: vauxhall
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for vauxhall (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-vauxhall {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-vauxhall 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-vauxhall 3s ease-in-out infinite alternate;
}
</style>