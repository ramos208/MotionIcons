...
@keyframes motion-ai-airplayaudio {
...
@keyframes motion-ai-idle-airplayaudio {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-airplayaudio 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-airplayaudio 3s ease-in-out infinite alternate;
}
</style>