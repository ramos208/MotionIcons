...
// AI Generated Motion Component for: sign-language
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sign-language (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sign-language {
...
@keyframes motion-ai-idle-sign-language {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sign-language 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sign-language 3s ease-in-out infinite alternate;
}
</style>