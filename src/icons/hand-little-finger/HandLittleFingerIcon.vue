...
// AI Generated Motion Component for: hand-little-finger
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-little-finger (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hand-little-finger {
...
@keyframes motion-ai-idle-hand-little-finger {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-little-finger 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-little-finger 3s ease-in-out infinite alternate;
}
</style>