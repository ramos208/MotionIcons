...
@keyframes motion-ai-hand-brake {
...
@keyframes motion-ai-idle-hand-brake {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-brake 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-brake 3s ease-in-out infinite alternate;
}
</style>