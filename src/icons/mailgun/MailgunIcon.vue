...
// AI Generated Motion Component for: mailgun
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for mailgun (simpleicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-mailgun {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mailgun 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-mailgun 2.5s ease-in-out infinite alternate;
}
</style>