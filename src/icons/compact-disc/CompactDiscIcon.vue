...
// AI Generated Motion Component for: compact-disc
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for compact-disc (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-compact-disc {
...
@keyframes motion-ai-idle-compact-disc {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-compact-disc 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-compact-disc 3s ease-in-out infinite alternate;
}
</style>