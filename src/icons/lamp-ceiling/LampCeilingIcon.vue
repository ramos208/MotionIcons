...
// AI Generated Motion Component for: lamp-ceiling
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for lamp-ceiling (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lamp-ceiling {
...
@keyframes motion-ai-idle-lamp-ceiling {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lamp-ceiling 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lamp-ceiling 3s ease-in-out infinite alternate;
}
</style>