...
@keyframes motion-ai-file-terminal {
...
@keyframes motion-ai-idle-file-terminal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-terminal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-file-terminal 2s ease-in-out infinite alternate;
}
</style>