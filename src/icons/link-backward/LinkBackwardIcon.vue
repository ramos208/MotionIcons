...
// AI Generated Motion Component for: link-backward
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for link-backward (hugeicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-link-backward {
...
@keyframes motion-ai-idle-link-backward {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-link-backward 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-link-backward 3s ease-in-out infinite alternate;
}
</style>