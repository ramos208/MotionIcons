...
// AI Generated Motion Component for: corner-up-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for corner-up-left (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-corner-up-left {
...
@keyframes motion-ai-idle-corner-up-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-corner-up-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-corner-up-left 3s ease-in-out infinite alternate;
}
</style>