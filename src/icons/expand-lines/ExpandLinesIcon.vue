...
// AI Generated Motion Component for: expand-lines
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for expand-lines (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-expand-lines {
...
@keyframes motion-ai-idle-expand-lines {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-expand-lines 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-expand-lines 3s ease-in-out infinite alternate;
}
</style>