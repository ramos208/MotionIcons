...
@keyframes motion-ai-anchor-point {
...
@keyframes motion-ai-idle-anchor-point {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-anchor-point 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-anchor-point 3s ease-in-out infinite alternate;
}
</style>