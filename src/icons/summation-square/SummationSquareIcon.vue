...
@keyframes motion-ai-summation-square {
...
@keyframes motion-ai-idle-summation-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-summation-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-summation-square 3s ease-in-out infinite alternate;
}
</style>