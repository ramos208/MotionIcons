...
@keyframes motion-ai-cloud-little-rain {
...
@keyframes motion-ai-idle-cloud-little-rain {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-little-rain 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-little-rain 3s ease-in-out infinite alternate;
}
</style>