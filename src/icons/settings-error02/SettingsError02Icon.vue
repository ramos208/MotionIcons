...
@keyframes motion-ai-settings-error02 {
...
@keyframes motion-ai-idle-settings-error02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-settings-error02 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-settings-error02 3s ease-in-out infinite alternate;
}
</style>