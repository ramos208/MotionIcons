...
// AI Generated Motion Component for: chat
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for chat (hugeicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat 2.5s ease-in-out infinite alternate;
}
</style>