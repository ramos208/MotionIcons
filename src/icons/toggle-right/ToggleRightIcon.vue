...
// AI Generated Motion Component for: toggle-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for toggle-right (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-toggle-right {
...
@keyframes motion-ai-idle-toggle-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-toggle-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-toggle-right 3s ease-in-out infinite alternate;
}
</style>