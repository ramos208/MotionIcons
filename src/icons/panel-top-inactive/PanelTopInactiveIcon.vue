...
// AI Generated Motion Component for: panel-top-inactive
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for panel-top-inactive (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-panel-top-inactive {
...
@keyframes motion-ai-idle-panel-top-inactive {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-panel-top-inactive 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-panel-top-inactive 3s ease-in-out infinite alternate;
}
</style>