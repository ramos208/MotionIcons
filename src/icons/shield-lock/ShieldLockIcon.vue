...
// AI Generated Motion Component for: shield-lock
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for shield-lock (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-shield-lock {
...
@keyframes motion-ai-idle-shield-lock {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shield-lock 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-shield-lock 3s ease-in-out infinite alternate;
}
</style>