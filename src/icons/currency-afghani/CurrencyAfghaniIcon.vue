...
// AI Generated Motion Component for: currency-afghani
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-afghani (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-afghani {
...
@keyframes motion-ai-idle-currency-afghani {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-afghani 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-afghani 3s ease-in-out infinite alternate;
}
</style>