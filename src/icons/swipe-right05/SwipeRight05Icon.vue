...
@keyframes motion-ai-swipe-right05 {
...
@keyframes motion-ai-idle-swipe-right05 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-swipe-right05 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-swipe-right05 3s ease-in-out infinite alternate;
}
</style>