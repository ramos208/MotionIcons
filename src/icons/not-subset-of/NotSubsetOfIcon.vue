...
// AI Generated Motion Component for: not-subset-of
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for not-subset-of (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-not-subset-of {
...
@keyframes motion-ai-idle-not-subset-of {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-not-subset-of 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-not-subset-of 3s ease-in-out infinite alternate;
}
</style>