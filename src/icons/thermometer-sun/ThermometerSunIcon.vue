...
// AI Generated Motion Component for: thermometer-sun
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for thermometer-sun (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-thermometer-sun {
...
@keyframes motion-ai-idle-thermometer-sun {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thermometer-sun 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thermometer-sun 3s ease-in-out infinite alternate;
}
</style>