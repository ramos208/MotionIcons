...
// AI Generated Motion Component for: monitor-arrow-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for monitor-arrow-up (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-monitor-arrow-up {
...
@keyframes motion-ai-idle-monitor-arrow-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-monitor-arrow-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-monitor-arrow-up 3s ease-in-out infinite alternate;
}
</style>