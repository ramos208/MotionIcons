...
// AI Generated Motion Component for: house-medical
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for house-medical (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-house-medical {
...
@keyframes motion-ai-idle-house-medical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-medical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-medical 3s ease-in-out infinite alternate;
}
</style>