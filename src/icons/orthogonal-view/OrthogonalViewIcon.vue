...
@keyframes motion-ai-orthogonal-view {
...
@keyframes motion-ai-idle-orthogonal-view {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-orthogonal-view 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-orthogonal-view 3s ease-in-out infinite alternate;
}
</style>