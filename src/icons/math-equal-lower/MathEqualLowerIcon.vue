...
// AI Generated Motion Component for: math-equal-lower
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for math-equal-lower (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-math-equal-lower {
...
@keyframes motion-ai-idle-math-equal-lower {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-math-equal-lower 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-math-equal-lower 3s ease-in-out infinite alternate;
}
</style>