...
// AI Generated Motion Component for: person-simple-swim
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for person-simple-swim (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-person-simple-swim {
...
@keyframes motion-ai-idle-person-simple-swim {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-simple-swim 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-simple-swim 3s ease-in-out infinite alternate;
}
</style>