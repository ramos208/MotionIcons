<template>
  ...
  >
    ...
    >
      <path d="M22 5H16M16 5L19 2M16 5L19 8" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M13 2.04938C12.6711 2.01672 12.3375 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22C17.5228 22 22 17.5228 22 12C22 11.6625 21.9833 11.3289 21.9506 11" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: bubble-income
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bubble-income (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bubble-income {
...
@keyframes motion-ai-idle-bubble-income {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bubble-income 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bubble-income 3s ease-in-out infinite alternate;
}
</style>