...
// AI Generated Motion Component for: arrow-turn-left-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-turn-left-up (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-turn-left-up {
...
@keyframes motion-ai-idle-arrow-turn-left-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-turn-left-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-turn-left-up 3s ease-in-out infinite alternate;
}
</style>