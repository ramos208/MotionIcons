<template>
  ...
  >
    ...
    >
      <path d="M10.5 8.5L12.5 7V17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: one-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for one-circle (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-one-circle {
...
@keyframes motion-ai-idle-one-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-one-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-one-circle 3s ease-in-out infinite alternate;
}
</style>