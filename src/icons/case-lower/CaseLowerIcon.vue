...
// AI Generated Motion Component for: case-lower
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for case-lower (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-case-lower {
...
@keyframes motion-ai-idle-case-lower {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-case-lower 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-case-lower 3s ease-in-out infinite alternate;
}
</style>