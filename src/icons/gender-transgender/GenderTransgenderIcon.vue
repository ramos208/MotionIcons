...
// AI Generated Motion Component for: gender-transgender
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for gender-transgender (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-gender-transgender {
...
@keyframes motion-ai-idle-gender-transgender {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-gender-transgender 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-gender-transgender 3s ease-in-out infinite alternate;
}
</style>