...
@keyframes motion-ai-oil-industry {
...
@keyframes motion-ai-idle-oil-industry {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-oil-industry 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-oil-industry 3s ease-in-out infinite alternate;
}
</style>