...
// AI Generated Motion Component for: arrows-left
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrows-left (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrows-left {
...
@keyframes motion-ai-idle-arrows-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrows-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrows-left 3s ease-in-out infinite alternate;
}
</style>