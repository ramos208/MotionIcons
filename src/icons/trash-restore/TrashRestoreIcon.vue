...
// AI Generated Motion Component for: trash-restore
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for trash-restore (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-trash-restore {
...
@keyframes motion-ai-idle-trash-restore {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-trash-restore 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-trash-restore 3s ease-in-out infinite alternate;
}
</style>