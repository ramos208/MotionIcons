...
// AI Generated Motion Component for: currency-rubel
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-rubel (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-rubel {
...
@keyframes motion-ai-idle-currency-rubel {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-rubel 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-rubel 3s ease-in-out infinite alternate;
}
</style>