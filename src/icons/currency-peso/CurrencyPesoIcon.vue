...
// AI Generated Motion Component for: currency-peso
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-peso (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-peso {
...
@keyframes motion-ai-idle-currency-peso {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-peso 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-peso 3s ease-in-out infinite alternate;
}
</style>