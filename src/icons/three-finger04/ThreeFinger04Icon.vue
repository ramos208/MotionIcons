...
// AI Generated Motion Component for: three-finger04
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for three-finger04 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-three-finger04 {
...
@keyframes motion-ai-idle-three-finger04 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-three-finger04 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-three-finger04 3s ease-in-out infinite alternate;
}
</style>