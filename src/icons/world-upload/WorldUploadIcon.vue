...
// AI Generated Motion Component for: world-upload
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for world-upload (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-world-upload {
...
@keyframes motion-ai-idle-world-upload {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-world-upload 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-world-upload 3s ease-in-out infinite alternate;
}
</style>