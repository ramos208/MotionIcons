...
// AI Generated Motion Component for: researchgate
// Category: search
// Physics Presets: Dynamic kinetic adaptation for researchgate (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-researchgate {
...
@keyframes motion-ai-idle-researchgate {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-researchgate 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-researchgate 3s ease-in-out infinite alternate;
}
</style>