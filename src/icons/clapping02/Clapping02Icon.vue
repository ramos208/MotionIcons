...
@keyframes motion-ai-clapping02 {
...
@keyframes motion-ai-idle-clapping02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-clapping02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-clapping02 3s ease-in-out infinite alternate;
}
</style>