...
// AI Generated Motion Component for: people-carry
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for people-carry (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-people-carry {
...
@keyframes motion-ai-idle-people-carry {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-people-carry 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-people-carry 3s ease-in-out infinite alternate;
}
</style>