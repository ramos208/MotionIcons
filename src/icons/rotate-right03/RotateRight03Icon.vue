...
@keyframes motion-ai-rotate-right03 {
...
@keyframes motion-ai-idle-rotate-right03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rotate-right03 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-rotate-right03 4s linear infinite alternate;
}
</style>