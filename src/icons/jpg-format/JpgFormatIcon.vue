...
// AI Generated Motion Component for: jpg-format
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for jpg-format (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-jpg-format {
...
@keyframes motion-ai-idle-jpg-format {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-jpg-format 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-jpg-format 3s ease-in-out infinite alternate;
}
</style>