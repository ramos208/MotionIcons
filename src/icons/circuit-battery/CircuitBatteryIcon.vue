...
// AI Generated Motion Component for: circuit-battery
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circuit-battery (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circuit-battery {
...
@keyframes motion-ai-idle-circuit-battery {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circuit-battery 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circuit-battery 3s ease-in-out infinite alternate;
}
</style>