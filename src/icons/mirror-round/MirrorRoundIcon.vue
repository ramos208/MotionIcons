...
// AI Generated Motion Component for: mirror-round
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mirror-round (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mirror-round {
...
@keyframes motion-ai-idle-mirror-round {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mirror-round 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mirror-round 3s ease-in-out infinite alternate;
}
</style>