...
// AI Generated Motion Component for: timer-reset
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for timer-reset (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-timer-reset {
...
@keyframes motion-ai-idle-timer-reset {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-timer-reset 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-timer-reset 3s ease-in-out infinite alternate;
}
</style>