...
// AI Generated Motion Component for: send-horizontal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for send-horizontal (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-send-horizontal {
...
@keyframes motion-ai-idle-send-horizontal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-send-horizontal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-send-horizontal 3s ease-in-out infinite alternate;
}
</style>