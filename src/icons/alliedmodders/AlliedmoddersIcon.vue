...
// AI Generated Motion Component for: alliedmodders
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for alliedmodders (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-alliedmodders {
...
@keyframes motion-ai-idle-alliedmodders {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-alliedmodders 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-alliedmodders 3s ease-in-out infinite alternate;
}
</style>