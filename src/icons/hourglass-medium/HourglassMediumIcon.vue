...
// AI Generated Motion Component for: hourglass-medium
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hourglass-medium (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hourglass-medium {
...
@keyframes motion-ai-idle-hourglass-medium {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hourglass-medium 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hourglass-medium 3s ease-in-out infinite alternate;
}
</style>