...
// AI Generated Motion Component for: broadcast-tower
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for broadcast-tower (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-broadcast-tower {
...
@keyframes motion-ai-idle-broadcast-tower {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-broadcast-tower 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-broadcast-tower 3s ease-in-out infinite alternate;
}
</style>