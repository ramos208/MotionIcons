...
// AI Generated Motion Component for: wifi-low-signal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for wifi-low-signal (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-wifi-low-signal {
...
@keyframes motion-ai-idle-wifi-low-signal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wifi-low-signal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wifi-low-signal 3s ease-in-out infinite alternate;
}
</style>