...
@keyframes motion-ai-loader-pinwheel {
...
@keyframes motion-ai-idle-loader-pinwheel {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-loader-pinwheel 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-loader-pinwheel 4s linear infinite alternate;
}
</style>