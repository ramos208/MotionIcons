...
@keyframes motion-ai-imagetoolbox {
...
@keyframes motion-ai-idle-imagetoolbox {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-imagetoolbox 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-imagetoolbox 3s ease-in-out infinite alternate;
}
</style>