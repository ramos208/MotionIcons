...
@keyframes motion-ai-archive-arrow-down {
...
@keyframes motion-ai-idle-archive-arrow-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-archive-arrow-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-archive-arrow-down 3s ease-in-out infinite alternate;
}
</style>