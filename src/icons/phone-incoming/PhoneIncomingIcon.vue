...
// AI Generated Motion Component for: phone-incoming
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for phone-incoming (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-phone-incoming {
...
@keyframes motion-ai-idle-phone-incoming {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-phone-incoming 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-phone-incoming 3s ease-in-out infinite alternate;
}
</style>