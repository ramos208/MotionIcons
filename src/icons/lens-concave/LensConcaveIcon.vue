...
// AI Generated Motion Component for: lens-concave
// Category: search
// Physics Presets: Dynamic kinetic adaptation for lens-concave (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lens-concave {
...
@keyframes motion-ai-idle-lens-concave {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lens-concave 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lens-concave 3s ease-in-out infinite alternate;
}
</style>