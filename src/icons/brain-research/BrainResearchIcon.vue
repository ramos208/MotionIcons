...
// AI Generated Motion Component for: brain-research
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for brain-research (iconoir). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brain-research {
...
@keyframes motion-ai-idle-brain-research {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brain-research 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brain-research 3s ease-in-out infinite alternate;
}
</style>