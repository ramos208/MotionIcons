...
// AI Generated Motion Component for: brain-warning
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for brain-warning (iconoir). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brain-warning {
...
@keyframes motion-ai-idle-brain-warning {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brain-warning 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brain-warning 3s ease-in-out infinite alternate;
}
</style>