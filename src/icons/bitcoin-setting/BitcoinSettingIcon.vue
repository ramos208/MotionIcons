...
// AI Generated Motion Component for: bitcoin-setting
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bitcoin-setting (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bitcoin-setting {
...
@keyframes motion-ai-idle-bitcoin-setting {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bitcoin-setting 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bitcoin-setting 3s ease-in-out infinite alternate;
}
</style>