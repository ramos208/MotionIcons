...
// AI Generated Motion Component for: camera-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for camera-minus (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-camera-minus {
...
@keyframes motion-ai-idle-camera-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-camera-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-camera-minus 3s ease-in-out infinite alternate;
}
</style>