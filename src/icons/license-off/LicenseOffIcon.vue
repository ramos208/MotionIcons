...
// AI Generated Motion Component for: license-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for license-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-license-off {
...
@keyframes motion-ai-idle-license-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-license-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-license-off 3s ease-in-out infinite alternate;
}
</style>