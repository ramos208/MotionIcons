...
@keyframes motion-ai-comment-nodes {
...
@keyframes motion-ai-idle-comment-nodes {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-comment-nodes 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-comment-nodes 3s ease-in-out infinite alternate;
}
</style>