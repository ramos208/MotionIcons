...
@keyframes motion-ai-apachedolphinscheduler {
...
@keyframes motion-ai-idle-apachedolphinscheduler {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-apachedolphinscheduler 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-apachedolphinscheduler 3s ease-in-out infinite alternate;
}
</style>