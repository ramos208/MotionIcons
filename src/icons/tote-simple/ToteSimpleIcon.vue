...
// AI Generated Motion Component for: tote-simple
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for tote-simple (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-tote-simple {
...
@keyframes motion-ai-idle-tote-simple {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-tote-simple 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-tote-simple 3s ease-in-out infinite alternate;
}
</style>