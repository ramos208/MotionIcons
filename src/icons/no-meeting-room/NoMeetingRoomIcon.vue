...
@keyframes motion-ai-no-meeting-room {
...
@keyframes motion-ai-idle-no-meeting-room {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-no-meeting-room 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-no-meeting-room 3s ease-in-out infinite alternate;
}
</style>