...
// AI Generated Motion Component for: brand-meetup
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-meetup (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-meetup {
...
@keyframes motion-ai-idle-brand-meetup {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-meetup 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-meetup 3s ease-in-out infinite alternate;
}
</style>