...
// AI Generated Motion Component for: roamresearch
// Category: search
// Physics Presets: Dynamic kinetic adaptation for roamresearch (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-roamresearch {
...
@keyframes motion-ai-idle-roamresearch {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-roamresearch 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-roamresearch 3s ease-in-out infinite alternate;
}
</style>