...
// AI Generated Motion Component for: layout-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for layout-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-layout-off {
...
@keyframes motion-ai-idle-layout-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-layout-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-layout-off 3s ease-in-out infinite alternate;
}
</style>