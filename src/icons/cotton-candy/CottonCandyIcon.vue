...
@keyframes motion-ai-cotton-candy {
...
@keyframes motion-ai-idle-cotton-candy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cotton-candy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cotton-candy 3s ease-in-out infinite alternate;
}
</style>