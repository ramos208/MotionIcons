...
// AI Generated Motion Component for: table-shortcut
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for table-shortcut (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-table-shortcut {
...
@keyframes motion-ai-idle-table-shortcut {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-table-shortcut 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-table-shortcut 3s ease-in-out infinite alternate;
}
</style>