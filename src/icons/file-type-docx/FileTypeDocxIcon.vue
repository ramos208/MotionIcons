...
// AI Generated Motion Component for: file-type-docx
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for file-type-docx (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-file-type-docx {
...
@keyframes motion-ai-idle-file-type-docx {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-type-docx 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-type-docx 3s ease-in-out infinite alternate;
}
</style>