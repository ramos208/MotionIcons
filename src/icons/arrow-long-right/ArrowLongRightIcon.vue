...
// AI Generated Motion Component for: arrow-long-right
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-long-right (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-long-right {
...
@keyframes motion-ai-idle-arrow-long-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-long-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-long-right 3s ease-in-out infinite alternate;
}
</style>