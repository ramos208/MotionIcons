...
// AI Generated Motion Component for: wallet-minimal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for wallet-minimal (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-wallet-minimal {
...
@keyframes motion-ai-idle-wallet-minimal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wallet-minimal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wallet-minimal 3s ease-in-out infinite alternate;
}
</style>