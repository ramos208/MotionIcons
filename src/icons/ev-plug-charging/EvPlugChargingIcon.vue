...
@keyframes motion-ai-ev-plug-charging {
...
@keyframes motion-ai-idle-ev-plug-charging {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ev-plug-charging 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ev-plug-charging 3s ease-in-out infinite alternate;
}
</style>