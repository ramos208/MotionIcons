...
@keyframes motion-ai-hierarchy-files {
...
@keyframes motion-ai-idle-hierarchy-files {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hierarchy-files 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hierarchy-files 3s ease-in-out infinite alternate;
}
</style>