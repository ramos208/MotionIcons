...
@keyframes motion-ai-database-monitor {
...
@keyframes motion-ai-idle-database-monitor {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-database-monitor 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-database-monitor 3s ease-in-out infinite alternate;
}
</style>