...
@keyframes motion-ai-chat-income {
...
@keyframes motion-ai-idle-chat-income {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-income 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-income 2.5s ease-in-out infinite alternate;
}
</style>