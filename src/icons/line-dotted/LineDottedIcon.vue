...
// AI Generated Motion Component for: line-dotted
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for line-dotted (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-line-dotted {
...
@keyframes motion-ai-idle-line-dotted {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-line-dotted 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-line-dotted 3s ease-in-out infinite alternate;
}
</style>