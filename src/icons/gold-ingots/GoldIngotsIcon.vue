...
@keyframes motion-ai-gold-ingots {
...
@keyframes motion-ai-idle-gold-ingots {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-gold-ingots 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-gold-ingots 3s ease-in-out infinite alternate;
}
</style>