...
// AI Generated Motion Component for: lawn-mower
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for lawn-mower (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lawn-mower {
...
@keyframes motion-ai-idle-lawn-mower {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lawn-mower 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lawn-mower 3s ease-in-out infinite alternate;
}
</style>