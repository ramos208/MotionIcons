...
@keyframes motion-ai-idle-soda-can {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-soda-can 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-soda-can 3s ease-in-out infinite alternate;
}
</style>