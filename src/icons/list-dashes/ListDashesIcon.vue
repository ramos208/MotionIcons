...
// AI Generated Motion Component for: list-dashes
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for list-dashes (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-list-dashes {
...
@keyframes motion-ai-idle-list-dashes {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-list-dashes 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-list-dashes 3s ease-in-out infinite alternate;
}
</style>