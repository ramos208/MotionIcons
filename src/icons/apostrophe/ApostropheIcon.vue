...
// AI Generated Motion Component for: apostrophe
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for apostrophe (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-apostrophe {
...
@keyframes motion-ai-idle-apostrophe {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-apostrophe 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-apostrophe 3s ease-in-out infinite alternate;
}
</style>