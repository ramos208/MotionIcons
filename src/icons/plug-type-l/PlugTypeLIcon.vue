...
@keyframes motion-ai-plug-type-l {
...
@keyframes motion-ai-idle-plug-type-l {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-plug-type-l 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-plug-type-l 3s ease-in-out infinite alternate;
}
</style>