...
// AI Generated Motion Component for: spacing-horizontal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for spacing-horizontal (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-spacing-horizontal {
...
@keyframes motion-ai-idle-spacing-horizontal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-spacing-horizontal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-spacing-horizontal 3s ease-in-out infinite alternate;
}
</style>