...
// AI Generated Motion Component for: applepay
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for applepay (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-applepay {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-applepay 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-applepay 3s ease-in-out infinite alternate;
}
</style>