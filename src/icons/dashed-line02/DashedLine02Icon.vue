...
// AI Generated Motion Component for: dashed-line02
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for dashed-line02 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-dashed-line02 {
...
@keyframes motion-ai-idle-dashed-line02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dashed-line02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dashed-line02 3s ease-in-out infinite alternate;
}
</style>