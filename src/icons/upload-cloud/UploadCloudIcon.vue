...
// AI Generated Motion Component for: upload-cloud
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for upload-cloud (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-upload-cloud {
...
@keyframes motion-ai-idle-upload-cloud {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-upload-cloud 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-upload-cloud 3s ease-in-out infinite alternate;
}
</style>