...
// AI Generated Motion Component for: battery-vertical-empty
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for battery-vertical-empty (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-battery-vertical-empty {
...
@keyframes motion-ai-idle-battery-vertical-empty {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-battery-vertical-empty 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-battery-vertical-empty 3s ease-in-out infinite alternate;
}
</style>