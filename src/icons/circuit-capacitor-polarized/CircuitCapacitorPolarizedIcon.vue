...
// AI Generated Motion Component for: circuit-capacitor-polarized
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circuit-capacitor-polarized (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circuit-capacitor-polarized {
...
@keyframes motion-ai-idle-circuit-capacitor-polarized {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circuit-capacitor-polarized 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circuit-capacitor-polarized 3s ease-in-out infinite alternate;
}
</style>