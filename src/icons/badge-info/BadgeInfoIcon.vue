...
// AI Generated Motion Component for: badge-info
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for badge-info (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-badge-info {
...
@keyframes motion-ai-idle-badge-info {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-info 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-info 3s ease-in-out infinite alternate;
}
</style>