...
// AI Generated Motion Component for: percent-badge
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for percent-badge (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-percent-badge {
...
@keyframes motion-ai-idle-percent-badge {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-percent-badge 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-percent-badge 3s ease-in-out infinite alternate;
}
</style>