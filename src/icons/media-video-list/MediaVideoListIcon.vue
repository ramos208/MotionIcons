...
// AI Generated Motion Component for: media-video-list
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for media-video-list (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-media-video-list {
...
@keyframes motion-ai-idle-media-video-list {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-media-video-list 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-media-video-list 3s ease-in-out infinite alternate;
}
</style>