...
// AI Generated Motion Component for: brightness-half
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brightness-half (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brightness-half {
...
@keyframes motion-ai-idle-brightness-half {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brightness-half 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brightness-half 3s ease-in-out infinite alternate;
}
</style>