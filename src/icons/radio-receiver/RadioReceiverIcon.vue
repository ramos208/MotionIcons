...
// AI Generated Motion Component for: radio-receiver
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for radio-receiver (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-radio-receiver {
...
@keyframes motion-ai-idle-radio-receiver {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-radio-receiver 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-radio-receiver 3s ease-in-out infinite alternate;
}
</style>