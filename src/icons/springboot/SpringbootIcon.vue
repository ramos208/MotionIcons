...
// AI Generated Motion Component for: springboot
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for springboot (simpleicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-springboot {
...
@keyframes motion-ai-idle-springboot {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-springboot 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-springboot 2.5s ease-in-out infinite alternate;
}
</style>