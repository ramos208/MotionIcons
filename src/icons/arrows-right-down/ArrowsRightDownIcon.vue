...
// AI Generated Motion Component for: arrows-right-down
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrows-right-down (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrows-right-down {
...
@keyframes motion-ai-idle-arrows-right-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrows-right-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrows-right-down 3s ease-in-out infinite alternate;
}
</style>