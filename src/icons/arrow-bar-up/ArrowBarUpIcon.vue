...
// AI Generated Motion Component for: arrow-bar-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-bar-up (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-bar-up {
...
@keyframes motion-ai-idle-arrow-bar-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-bar-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-bar-up 3s ease-in-out infinite alternate;
}
</style>