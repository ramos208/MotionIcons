...
// AI Generated Motion Component for: dot-outline
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for dot-outline (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-dot-outline {
...
@keyframes motion-ai-idle-dot-outline {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dot-outline 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dot-outline 3s ease-in-out infinite alternate;
}
</style>