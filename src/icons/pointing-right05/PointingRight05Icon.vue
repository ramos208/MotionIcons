...
// AI Generated Motion Component for: pointing-right05
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for pointing-right05 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pointing-right05 {
...
@keyframes motion-ai-idle-pointing-right05 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pointing-right05 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pointing-right05 3s ease-in-out infinite alternate;
}
</style>