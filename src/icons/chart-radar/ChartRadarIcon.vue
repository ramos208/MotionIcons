...
@keyframes motion-ai-chart-radar {
...
@keyframes motion-ai-idle-chart-radar {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chart-radar 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chart-radar 3s ease-in-out infinite alternate;
}
</style>