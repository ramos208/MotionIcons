...
// AI Generated Motion Component for: mountain-snow
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for mountain-snow (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mountain-snow {
...
@keyframes motion-ai-idle-mountain-snow {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mountain-snow 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mountain-snow 3s ease-in-out infinite alternate;
}
</style>