...
// AI Generated Motion Component for: copy-simple
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for copy-simple (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-copy-simple {
...
@keyframes motion-ai-idle-copy-simple {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-copy-simple 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-copy-simple 3s ease-in-out infinite alternate;
}
</style>