...
@keyframes motion-ai-pen-tablet-connect-wifi {
...
@keyframes motion-ai-idle-pen-tablet-connect-wifi {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pen-tablet-connect-wifi 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pen-tablet-connect-wifi 3s ease-in-out infinite alternate;
}
</style>