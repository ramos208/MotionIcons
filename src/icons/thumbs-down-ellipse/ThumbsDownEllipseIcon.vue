...
@keyframes motion-ai-thumbs-down-ellipse {
...
@keyframes motion-ai-idle-thumbs-down-ellipse {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thumbs-down-ellipse 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thumbs-down-ellipse 3s ease-in-out infinite alternate;
}
</style>