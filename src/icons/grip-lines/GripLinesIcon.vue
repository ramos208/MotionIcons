...
// AI Generated Motion Component for: grip-lines
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for grip-lines (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-grip-lines {
...
@keyframes motion-ai-idle-grip-lines {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grip-lines 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grip-lines 3s ease-in-out infinite alternate;
}
</style>