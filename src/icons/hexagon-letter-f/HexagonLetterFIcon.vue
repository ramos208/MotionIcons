...
// AI Generated Motion Component for: hexagon-letter-f
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hexagon-letter-f (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hexagon-letter-f {
...
@keyframes motion-ai-idle-hexagon-letter-f {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hexagon-letter-f 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hexagon-letter-f 3s ease-in-out infinite alternate;
}
</style>