...
// AI Generated Motion Component for: send-horizonal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for send-horizonal (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-send-horizonal {
...
@keyframes motion-ai-idle-send-horizonal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-send-horizonal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-send-horizonal 3s ease-in-out infinite alternate;
}
</style>