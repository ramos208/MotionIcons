...
// AI Generated Motion Component for: hand-heart
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-heart (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hand-heart {
...
@keyframes motion-ai-idle-hand-heart {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-heart 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-heart 3s ease-in-out infinite alternate;
}
</style>