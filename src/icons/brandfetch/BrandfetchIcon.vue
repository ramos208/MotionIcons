...
// AI Generated Motion Component for: brandfetch
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brandfetch (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brandfetch {
...
@keyframes motion-ai-idle-brandfetch {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brandfetch 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brandfetch 3s ease-in-out infinite alternate;
}
</style>