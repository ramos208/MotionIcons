...
// AI Generated Motion Component for: layout-panel-top
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for layout-panel-top (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-layout-panel-top {
...
@keyframes motion-ai-idle-layout-panel-top {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-layout-panel-top 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-layout-panel-top 3s ease-in-out infinite alternate;
}
</style>