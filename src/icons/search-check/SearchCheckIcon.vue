...
// AI Generated Motion Component for: search-check
// Category: search
// Physics Presets: Dynamic kinetic adaptation for search-check (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-search-check {
...
@keyframes motion-ai-idle-search-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-search-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-search-check 3s ease-in-out infinite alternate;
}
</style>