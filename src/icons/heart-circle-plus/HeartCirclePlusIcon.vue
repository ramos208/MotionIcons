...
// AI Generated Motion Component for: heart-circle-plus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for heart-circle-plus (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-heart-circle-plus {
...
@keyframes motion-ai-idle-heart-circle-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-heart-circle-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-heart-circle-plus 3s ease-in-out infinite alternate;
}
</style>