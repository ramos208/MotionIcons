...
@keyframes motion-ai-three-d-scale {
...
@keyframes motion-ai-idle-three-d-scale {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-three-d-scale 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-three-d-scale 3s ease-in-out infinite alternate;
}
</style>