...
// AI Generated Motion Component for: air-traffic-control
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for air-traffic-control (phosphor). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-air-traffic-control {
...
@keyframes motion-ai-idle-air-traffic-control {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-air-traffic-control 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-air-traffic-control 2s ease-in-out infinite alternate;
}
</style>