...
// AI Generated Motion Component for: cloud-lock-open
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for cloud-lock-open (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cloud-lock-open {
...
@keyframes motion-ai-idle-cloud-lock-open {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-lock-open 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-lock-open 3s ease-in-out infinite alternate;
}
</style>