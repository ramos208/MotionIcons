...
// AI Generated Motion Component for: chart-bar-popular
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for chart-bar-popular (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chart-bar-popular {
...
@keyframes motion-ai-idle-chart-bar-popular {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chart-bar-popular 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chart-bar-popular 3s ease-in-out infinite alternate;
}
</style>