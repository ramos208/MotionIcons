...
@keyframes motion-ai-workflow-square05 {
...
@keyframes motion-ai-idle-workflow-square05 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-workflow-square05 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-workflow-square05 3s ease-in-out infinite alternate;
}
</style>