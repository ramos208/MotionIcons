...
// AI Generated Motion Component for: map-marked
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for map-marked (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-map-marked {
...
@keyframes motion-ai-idle-map-marked {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-map-marked 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-map-marked 3s ease-in-out infinite alternate;
}
</style>