...
// AI Generated Motion Component for: message-circle-cancel
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-circle-cancel (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-circle-cancel {
...
@keyframes motion-ai-idle-message-circle-cancel {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-circle-cancel 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-circle-cancel 2.5s ease-in-out infinite alternate;
}
</style>