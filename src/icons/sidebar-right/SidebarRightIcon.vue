...
@keyframes motion-ai-sidebar-right {
...
@keyframes motion-ai-idle-sidebar-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sidebar-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sidebar-right 3s ease-in-out infinite alternate;
}
</style>