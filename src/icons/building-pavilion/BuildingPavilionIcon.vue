...
// AI Generated Motion Component for: building-pavilion
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for building-pavilion (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-building-pavilion {
...
@keyframes motion-ai-idle-building-pavilion {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-building-pavilion 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-building-pavilion 3s ease-in-out infinite alternate;
}
</style>