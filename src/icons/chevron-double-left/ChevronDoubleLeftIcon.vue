...
// AI Generated Motion Component for: chevron-double-left
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for chevron-double-left (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chevron-double-left {
...
@keyframes motion-ai-idle-chevron-double-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chevron-double-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chevron-double-left 3s ease-in-out infinite alternate;
}
</style>