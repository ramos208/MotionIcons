...
// AI Generated Motion Component for: inspection-panel
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for inspection-panel (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-inspection-panel {
...
@keyframes motion-ai-idle-inspection-panel {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-inspection-panel 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-inspection-panel 3s ease-in-out infinite alternate;
}
</style>