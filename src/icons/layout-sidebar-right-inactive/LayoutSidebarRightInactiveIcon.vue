...
// AI Generated Motion Component for: layout-sidebar-right-inactive
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for layout-sidebar-right-inactive (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-layout-sidebar-right-inactive {
...
@keyframes motion-ai-idle-layout-sidebar-right-inactive {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-layout-sidebar-right-inactive 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-layout-sidebar-right-inactive 3s ease-in-out infinite alternate;
}
</style>