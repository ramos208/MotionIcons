...
@keyframes motion-ai-diagram-successor {
...
@keyframes motion-ai-idle-diagram-successor {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-diagram-successor 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-diagram-successor 3s ease-in-out infinite alternate;
}
</style>