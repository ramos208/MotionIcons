...
@keyframes motion-ai-image-upload {
...
@keyframes motion-ai-idle-image-upload {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-image-upload 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-image-upload 3s ease-in-out infinite alternate;
}
</style>