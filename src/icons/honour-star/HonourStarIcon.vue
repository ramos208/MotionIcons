...
@keyframes motion-ai-honour-star {
...
@keyframes motion-ai-idle-honour-star {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-honour-star 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-honour-star 3s ease-in-out infinite alternate;
}
</style>