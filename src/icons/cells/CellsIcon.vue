...
@keyframes motion-ai-idle-cells {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cells 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cells 3s ease-in-out infinite alternate;
}
</style>