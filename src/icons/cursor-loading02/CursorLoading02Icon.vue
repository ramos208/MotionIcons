...
// AI Generated Motion Component for: cursor-loading02
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for cursor-loading02 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cursor-loading02 {
...
@keyframes motion-ai-idle-cursor-loading02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cursor-loading02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cursor-loading02 3s ease-in-out infinite alternate;
}
</style>