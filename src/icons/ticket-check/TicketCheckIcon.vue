...
// AI Generated Motion Component for: ticket-check
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ticket-check (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ticket-check {
...
@keyframes motion-ai-idle-ticket-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ticket-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ticket-check 3s ease-in-out infinite alternate;
}
</style>