...
@keyframes motion-ai-block-game {
...
@keyframes motion-ai-idle-block-game {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-block-game 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-block-game 3s ease-in-out infinite alternate;
}
</style>