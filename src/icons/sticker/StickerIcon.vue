...
@keyframes motion-ai-idle-sticker {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sticker 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sticker 3s ease-in-out infinite alternate;
}
</style>