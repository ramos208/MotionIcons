...
@keyframes motion-ai-box-3d-point {
...
@keyframes motion-ai-idle-box-3d-point {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-box-3d-point 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-box-3d-point 3s ease-in-out infinite alternate;
}
</style>