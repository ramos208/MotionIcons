...
// AI Generated Motion Component for: mood-heart
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mood-heart (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mood-heart {
...
@keyframes motion-ai-idle-mood-heart {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mood-heart 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mood-heart 3s ease-in-out infinite alternate;
}
</style>