...
// AI Generated Motion Component for: magnifying-glass
// Category: search
// Physics Presets: Dynamic kinetic adaptation for magnifying-glass (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-magnifying-glass {
...
@keyframes motion-ai-idle-magnifying-glass {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-magnifying-glass 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-magnifying-glass 3s ease-in-out infinite alternate;
}
</style>