...
// AI Generated Motion Component for: shelving-unit
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for shelving-unit (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-shelving-unit {
...
@keyframes motion-ai-idle-shelving-unit {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shelving-unit 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-shelving-unit 3s ease-in-out infinite alternate;
}
</style>