...
// AI Generated Motion Component for: waves-arrow-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for waves-arrow-up (lucide). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-waves-arrow-up {
...
@keyframes motion-ai-idle-waves-arrow-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-waves-arrow-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-waves-arrow-up 3s ease-in-out infinite alternate;
}
</style>