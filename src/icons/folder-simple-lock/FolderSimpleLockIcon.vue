...
// AI Generated Motion Component for: folder-simple-lock
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for folder-simple-lock (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-folder-simple-lock {
...
@keyframes motion-ai-idle-folder-simple-lock {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-folder-simple-lock 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-folder-simple-lock 3s ease-in-out infinite alternate;
}
</style>