...
// AI Generated Motion Component for: earphone-bluetooth
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for earphone-bluetooth (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-earphone-bluetooth {
...
@keyframes motion-ai-idle-earphone-bluetooth {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-earphone-bluetooth 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-earphone-bluetooth 3s ease-in-out infinite alternate;
}
</style>