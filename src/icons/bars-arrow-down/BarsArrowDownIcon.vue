...
// AI Generated Motion Component for: bars-arrow-down
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for bars-arrow-down (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bars-arrow-down {
...
@keyframes motion-ai-idle-bars-arrow-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bars-arrow-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bars-arrow-down 3s ease-in-out infinite alternate;
}
</style>