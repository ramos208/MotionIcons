...
// AI Generated Motion Component for: monitor-cloud
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for monitor-cloud (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-monitor-cloud {
...
@keyframes motion-ai-idle-monitor-cloud {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-monitor-cloud 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-monitor-cloud 3s ease-in-out infinite alternate;
}
</style>