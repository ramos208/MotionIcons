...
@keyframes motion-ai-hospital-user {
...
@keyframes motion-ai-idle-hospital-user {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hospital-user 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hospital-user 3s ease-in-out infinite alternate;
}
</style>