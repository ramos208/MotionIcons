...
// AI Generated Motion Component for: zodiac-gemini
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for zodiac-gemini (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zodiac-gemini {
...
@keyframes motion-ai-idle-zodiac-gemini {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zodiac-gemini 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zodiac-gemini 3s ease-in-out infinite alternate;
}
</style>