...
// AI Generated Motion Component for: dice-faces02
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for dice-faces02 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-dice-faces02 {
...
@keyframes motion-ai-idle-dice-faces02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dice-faces02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dice-faces02 3s ease-in-out infinite alternate;
}
</style>