...
@keyframes motion-ai-medicine-syrup {
...
@keyframes motion-ai-idle-medicine-syrup {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-medicine-syrup 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-medicine-syrup 3s ease-in-out infinite alternate;
}
</style>