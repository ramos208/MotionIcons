...
// AI Generated Motion Component for: shield-code
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for shield-code (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-shield-code {
...
@keyframes motion-ai-idle-shield-code {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shield-code 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-shield-code 2s ease-in-out infinite alternate;
}
</style>