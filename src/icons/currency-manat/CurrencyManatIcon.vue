...
// AI Generated Motion Component for: currency-manat
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-manat (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-manat {
...
@keyframes motion-ai-idle-currency-manat {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-manat 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-manat 3s ease-in-out infinite alternate;
}
</style>