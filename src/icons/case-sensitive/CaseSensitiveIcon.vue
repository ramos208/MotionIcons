...
// AI Generated Motion Component for: case-sensitive
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for case-sensitive (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-case-sensitive {
...
@keyframes motion-ai-idle-case-sensitive {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-case-sensitive 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-case-sensitive 3s ease-in-out infinite alternate;
}
</style>