...
// AI Generated Motion Component for: squares-intersect
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for squares-intersect (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-squares-intersect {
...
@keyframes motion-ai-idle-squares-intersect {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-squares-intersect 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-squares-intersect 3s ease-in-out infinite alternate;
}
</style>