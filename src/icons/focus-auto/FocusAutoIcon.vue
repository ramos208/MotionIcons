...
// AI Generated Motion Component for: focus-auto
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for focus-auto (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-focus-auto {
...
@keyframes motion-ai-idle-focus-auto {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-focus-auto 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-focus-auto 3s ease-in-out infinite alternate;
}
</style>