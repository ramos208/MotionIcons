...
@keyframes motion-ai-arrows-spin {
...
@keyframes motion-ai-idle-arrows-spin {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrows-spin 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrows-spin 3s ease-in-out infinite alternate;
}
</style>