...
// AI Generated Motion Component for: brand-meta
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-meta (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-meta {
...
@keyframes motion-ai-idle-brand-meta {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-meta 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-meta 3s ease-in-out infinite alternate;
}
</style>