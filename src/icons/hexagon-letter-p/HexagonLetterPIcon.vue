...
// AI Generated Motion Component for: hexagon-letter-p
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hexagon-letter-p (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hexagon-letter-p {
...
@keyframes motion-ai-idle-hexagon-letter-p {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hexagon-letter-p 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hexagon-letter-p 3s ease-in-out infinite alternate;
}
</style>