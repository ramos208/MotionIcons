...
// AI Generated Motion Component for: grains-slash
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for grains-slash (phosphor). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-grains-slash {
...
@keyframes motion-ai-idle-grains-slash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grains-slash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grains-slash 3s ease-in-out infinite alternate;
}
</style>