...
// AI Generated Motion Component for: square-function
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for square-function (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-square-function {
...
@keyframes motion-ai-idle-square-function {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-square-function 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-square-function 3s ease-in-out infinite alternate;
}
</style>