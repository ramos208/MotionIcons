<template>
  ...
  >
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 8v8"/><path d="M14 8l-2.5 4l2.5 4"/><path d="M10 12h1.5"/><path d="M7.5 4.21v.01"/><path d="M4.21 7.5v.01"/><path d="M3 12v.01"/><path d="M4.21 16.5v.01"/><path d="M7.5 19.79v.01"/><path d="M12 21v.01"/><path d="M16.5 19.79v.01"/><path d="M19.79 16.5v.01"/><path d="M21 12v.01"/><path d="M19.79 7.5v.01"/><path d="M16.5 4.21v.01"/><path d="M12 3v.01"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: circle-dotted-letter-k
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circle-dotted-letter-k (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circle-dotted-letter-k {
...
@keyframes motion-ai-idle-circle-dotted-letter-k {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circle-dotted-letter-k 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circle-dotted-letter-k 3s ease-in-out infinite alternate;
}
</style>