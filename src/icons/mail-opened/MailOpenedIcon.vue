...
// AI Generated Motion Component for: mail-opened
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for mail-opened (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mail-opened {
...
@keyframes motion-ai-idle-mail-opened {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mail-opened 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-mail-opened 2.5s ease-in-out infinite alternate;
}
</style>