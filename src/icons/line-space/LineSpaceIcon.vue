<template>
  ...
  >
    ...
    >
      <path d="M11 6H21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 12H21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 18H21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 19V5M5 19L3 16.5M5 19L7 16.5M5 5L3 7M5 5L7 7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: line-space
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for line-space (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-line-space {
...
@keyframes motion-ai-idle-line-space {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-line-space 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-line-space 3s ease-in-out infinite alternate;
}
</style>