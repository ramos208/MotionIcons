...
@keyframes motion-ai-sign-language-c {
...
@keyframes motion-ai-idle-sign-language-c {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sign-language-c 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sign-language-c 3s ease-in-out infinite alternate;
}
</style>