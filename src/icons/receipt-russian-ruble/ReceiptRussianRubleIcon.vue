...
@keyframes motion-ai-receipt-russian-ruble {
...
@keyframes motion-ai-idle-receipt-russian-ruble {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-russian-ruble 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-russian-ruble 3s ease-in-out infinite alternate;
}
</style>