...
// AI Generated Motion Component for: fork-knife
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for fork-knife (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-fork-knife {
...
@keyframes motion-ai-idle-fork-knife {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-fork-knife 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-fork-knife 3s ease-in-out infinite alternate;
}
</style>