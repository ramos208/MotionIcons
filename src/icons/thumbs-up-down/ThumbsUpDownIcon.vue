...
@keyframes motion-ai-thumbs-up-down {
...
@keyframes motion-ai-idle-thumbs-up-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thumbs-up-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thumbs-up-down 3s ease-in-out infinite alternate;
}
</style>