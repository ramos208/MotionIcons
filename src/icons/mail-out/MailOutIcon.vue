<template>
  ...
  >
    ...
    >
      <path d="M5 9L9.5 12L14 9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 19H3C1.89543 19 1 18.1046 1 17V7C1 5.89543 1.89543 5 3 5H16C17.1046 5 18 5.89543 18 7V9" stroke="currentColor" stroke-linecap="round"/><path d="M17 14H23M23 14L20 11M23 14L20 17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: mail-out
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for mail-out (iconoir). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-mail-out {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mail-out 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-mail-out 2.5s ease-in-out infinite alternate;
}
</style>