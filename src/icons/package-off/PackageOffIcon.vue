...
// AI Generated Motion Component for: package-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for package-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-package-off {
...
@keyframes motion-ai-idle-package-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-package-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-package-off 3s ease-in-out infinite alternate;
}
</style>