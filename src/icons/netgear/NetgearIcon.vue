...
// AI Generated Motion Component for: netgear
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for netgear (simpleicons). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-netgear {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-netgear 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-netgear 3s ease-in-out infinite alternate;
}
</style>