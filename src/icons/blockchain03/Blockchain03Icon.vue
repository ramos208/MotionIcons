...
@keyframes motion-ai-blockchain03 {
...
@keyframes motion-ai-idle-blockchain03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-blockchain03 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-blockchain03 2s ease-in-out infinite alternate;
}
</style>