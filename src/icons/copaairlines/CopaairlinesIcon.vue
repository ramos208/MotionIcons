...
@keyframes motion-ai-copaairlines {
...
@keyframes motion-ai-idle-copaairlines {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-copaairlines 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-copaairlines 2s ease-in-out infinite alternate;
}
</style>