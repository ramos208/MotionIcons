...
@keyframes motion-ai-idle-caprover {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-caprover 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-caprover 3s ease-in-out infinite alternate;
}
</style>