...
@keyframes motion-ai-time-quarter-pass {
...
@keyframes motion-ai-idle-time-quarter-pass {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-time-quarter-pass 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-time-quarter-pass 3s ease-in-out infinite alternate;
}
</style>