...
// AI Generated Motion Component for: form-input
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for form-input (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-form-input {
...
@keyframes motion-ai-idle-form-input {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-form-input 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-form-input 3s ease-in-out infinite alternate;
}
</style>