...
@keyframes motion-ai-pathfinder-crop {
...
@keyframes motion-ai-idle-pathfinder-crop {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pathfinder-crop 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pathfinder-crop 3s ease-in-out infinite alternate;
}
</style>