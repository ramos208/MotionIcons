...
// AI Generated Motion Component for: information-square
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for information-square (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-information-square {
...
@keyframes motion-ai-idle-information-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-information-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-information-square 3s ease-in-out infinite alternate;
}
</style>