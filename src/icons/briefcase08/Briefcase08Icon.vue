...
@keyframes motion-ai-briefcase08 {
...
@keyframes motion-ai-idle-briefcase08 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-briefcase08 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-briefcase08 3s ease-in-out infinite alternate;
}
</style>