...
// AI Generated Motion Component for: circles-relation
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circles-relation (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circles-relation {
...
@keyframes motion-ai-idle-circles-relation {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circles-relation 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circles-relation 3s ease-in-out infinite alternate;
}
</style>