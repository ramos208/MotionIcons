...
@keyframes motion-ai-idle-zabka {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zabka 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zabka 3s ease-in-out infinite alternate;
}
</style>