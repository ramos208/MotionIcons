...
// AI Generated Motion Component for: microsoft-teams-logo
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for microsoft-teams-logo (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-microsoft-teams-logo {
...
@keyframes motion-ai-idle-microsoft-teams-logo {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-microsoft-teams-logo 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-microsoft-teams-logo 3s ease-in-out infinite alternate;
}
</style>