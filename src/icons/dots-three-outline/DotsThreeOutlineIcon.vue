...
// AI Generated Motion Component for: dots-three-outline
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for dots-three-outline (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-dots-three-outline {
...
@keyframes motion-ai-idle-dots-three-outline {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dots-three-outline 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dots-three-outline 3s ease-in-out infinite alternate;
}
</style>