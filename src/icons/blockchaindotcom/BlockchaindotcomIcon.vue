...
// AI Generated Motion Component for: blockchaindotcom
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for blockchaindotcom (simpleicons). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-blockchaindotcom {
...
@keyframes motion-ai-idle-blockchaindotcom {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-blockchaindotcom 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-blockchaindotcom 2s ease-in-out infinite alternate;
}
</style>