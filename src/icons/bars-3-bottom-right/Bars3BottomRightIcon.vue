...
// AI Generated Motion Component for: bars-3-bottom-right
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for bars-3-bottom-right (heroicons). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bars-3-bottom-right {
...
@keyframes motion-ai-idle-bars-3-bottom-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bars-3-bottom-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-bars-3-bottom-right 2s ease-in-out infinite alternate;
}
</style>