...
// AI Generated Motion Component for: thermometer-three-quarters
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for thermometer-three-quarters (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-thermometer-three-quarters {
...
@keyframes motion-ai-idle-thermometer-three-quarters {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thermometer-three-quarters 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thermometer-three-quarters 3s ease-in-out infinite alternate;
}
</style>