...
// AI Generated Motion Component for: googleclassroom
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for googleclassroom (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-googleclassroom {
...
@keyframes motion-ai-idle-googleclassroom {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-googleclassroom 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-googleclassroom 3s ease-in-out infinite alternate;
}
</style>