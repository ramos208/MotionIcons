...
@keyframes motion-ai-bitcoin-cpu {
...
@keyframes motion-ai-idle-bitcoin-cpu {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bitcoin-cpu 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-bitcoin-cpu 2s ease-in-out infinite alternate;
}
</style>