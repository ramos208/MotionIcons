...
@keyframes motion-ai-person-snowboarding {
...
@keyframes motion-ai-idle-person-snowboarding {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-snowboarding 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-snowboarding 3s ease-in-out infinite alternate;
}
</style>