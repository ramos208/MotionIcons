...
// AI Generated Motion Component for: emoji-ball
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for emoji-ball (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-emoji-ball {
...
@keyframes motion-ai-idle-emoji-ball {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-emoji-ball 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-emoji-ball 3s ease-in-out infinite alternate;
}
</style>