...
@keyframes motion-ai-shared-wifi {
...
@keyframes motion-ai-idle-shared-wifi {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shared-wifi 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-shared-wifi 3s ease-in-out infinite alternate;
}
</style>