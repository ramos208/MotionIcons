...
// AI Generated Motion Component for: swatch-book
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for swatch-book (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-swatch-book {
...
@keyframes motion-ai-idle-swatch-book {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-swatch-book 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-swatch-book 3s ease-in-out infinite alternate;
}
</style>