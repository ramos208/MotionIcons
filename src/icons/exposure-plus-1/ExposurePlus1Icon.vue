...
// AI Generated Motion Component for: exposure-plus-1
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for exposure-plus-1 (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-exposure-plus-1 {
...
@keyframes motion-ai-idle-exposure-plus-1 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-exposure-plus-1 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-exposure-plus-1 3s ease-in-out infinite alternate;
}
</style>