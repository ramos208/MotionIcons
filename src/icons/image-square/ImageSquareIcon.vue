...
// AI Generated Motion Component for: image-square
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for image-square (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-image-square {
...
@keyframes motion-ai-idle-image-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-image-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-image-square 3s ease-in-out infinite alternate;
}
</style>