...
// AI Generated Motion Component for: music-notes-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for music-notes-minus (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-music-notes-minus {
...
@keyframes motion-ai-idle-music-notes-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-music-notes-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-music-notes-minus 3s ease-in-out infinite alternate;
}
</style>