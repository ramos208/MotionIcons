...
// AI Generated Motion Component for: grin-tongue
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for grin-tongue (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-grin-tongue {
...
@keyframes motion-ai-idle-grin-tongue {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grin-tongue 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grin-tongue 3s ease-in-out infinite alternate;
}
</style>