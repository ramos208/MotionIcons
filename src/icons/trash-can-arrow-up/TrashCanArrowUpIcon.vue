...
@keyframes motion-ai-trash-can-arrow-up {
...
@keyframes motion-ai-idle-trash-can-arrow-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-trash-can-arrow-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-trash-can-arrow-up 3s ease-in-out infinite alternate;
}
</style>