...
// AI Generated Motion Component for: pointer-code
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for pointer-code (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pointer-code {
...
@keyframes motion-ai-idle-pointer-code {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pointer-code 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-pointer-code 2s ease-in-out infinite alternate;
}
</style>