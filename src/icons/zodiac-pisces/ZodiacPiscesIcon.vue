...
// AI Generated Motion Component for: zodiac-pisces
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for zodiac-pisces (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zodiac-pisces {
...
@keyframes motion-ai-idle-zodiac-pisces {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zodiac-pisces 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zodiac-pisces 3s ease-in-out infinite alternate;
}
</style>