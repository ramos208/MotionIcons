...
// AI Generated Motion Component for: line-height
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for line-height (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-line-height {
...
@keyframes motion-ai-idle-line-height {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-line-height 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-line-height 3s ease-in-out infinite alternate;
}
</style>