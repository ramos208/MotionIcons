...
// AI Generated Motion Component for: hexagon-letter-h
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hexagon-letter-h (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hexagon-letter-h {
...
@keyframes motion-ai-idle-hexagon-letter-h {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hexagon-letter-h 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hexagon-letter-h 3s ease-in-out infinite alternate;
}
</style>