...
// AI Generated Motion Component for: medical-cross
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for medical-cross (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-medical-cross {
...
@keyframes motion-ai-idle-medical-cross {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-medical-cross 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-medical-cross 3s ease-in-out infinite alternate;
}
</style>