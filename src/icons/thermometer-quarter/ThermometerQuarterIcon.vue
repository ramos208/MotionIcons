...
// AI Generated Motion Component for: thermometer-quarter
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for thermometer-quarter (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-thermometer-quarter {
...
@keyframes motion-ai-idle-thermometer-quarter {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thermometer-quarter 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thermometer-quarter 3s ease-in-out infinite alternate;
}
</style>