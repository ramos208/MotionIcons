...
@keyframes motion-ai-grid-minus {
...
@keyframes motion-ai-idle-grid-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grid-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grid-minus 3s ease-in-out infinite alternate;
}
</style>