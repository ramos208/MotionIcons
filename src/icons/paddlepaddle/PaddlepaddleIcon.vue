...
@keyframes motion-ai-paddlepaddle {
...
@keyframes motion-ai-idle-paddlepaddle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-paddlepaddle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-paddlepaddle 3s ease-in-out infinite alternate;
}
</style>