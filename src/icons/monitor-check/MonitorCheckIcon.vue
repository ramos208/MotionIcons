...
// AI Generated Motion Component for: monitor-check
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for monitor-check (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-monitor-check {
...
@keyframes motion-ai-idle-monitor-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-monitor-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-monitor-check 3s ease-in-out infinite alternate;
}
</style>