...
// AI Generated Motion Component for: chef-hat-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for chef-hat-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chef-hat-off {
...
@keyframes motion-ai-idle-chef-hat-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chef-hat-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chef-hat-off 3s ease-in-out infinite alternate;
}
</style>