...
// AI Generated Motion Component for: arrow-circle-down-right
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-circle-down-right (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-circle-down-right {
...
@keyframes motion-ai-idle-arrow-circle-down-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-circle-down-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-circle-down-right 3s ease-in-out infinite alternate;
}
</style>