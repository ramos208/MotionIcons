<template>
  ...
  >
    ...
    >
      <path d="M21 16V4C21 2.89543 20.1046 2 19 2H5C3.89543 2 3 2.89543 3 4V20C3 21.1046 3.89543 22 5 22H14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 8L11 8L11 6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 8L13 8L13 6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 20L18 22L22 18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: bed-ready
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bed-ready (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-bed-ready {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bed-ready 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bed-ready 3s ease-in-out infinite alternate;
}
</style>