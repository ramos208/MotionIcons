<template>
  ...
  >
    ...
    >
      <path d="M14 16.5V15M14 11.5V10.5M16 19C16 20.1046 15.1046 21 14 21C12.8954 21 12 20.1046 12 19C12 17.8954 12.8954 17 14 17C15.1046 17 16 17.8954 16 19Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M8 7.00447H16.75C18.8567 7.00447 19.91 7.00447 20.6667 7.51062C20.9943 7.72974 21.2755 8.01131 21.4944 8.33925C22 9.09676 22 10.1513 22 12.2603C22 15.7754 22 17.5329 21.1573 18.7955C20.7926 19.342 20.3238 19.8113 19.7779 20.1765C19.5391 20.3362 19.2827 20.4657 19 20.5706M12 7.00447L11.3666 5.73618C10.8418 4.68546 10.3622 3.62782 9.19926 3.19122C8.6899 3 8.10802 3 6.94427 3C5.1278 3 4.21956 3 3.53806 3.38074C3.05227 3.65215 2.65142 4.05344 2.38032 4.53978C2 5.22204 2 6.13129 2 7.94979V11.0089C2 15.7282 2 18.0879 3.46447 19.554C4.5784 20.6692 6.20875 20.9361 9 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: folder-archive
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for folder-archive (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-folder-archive {
...
@keyframes motion-ai-idle-folder-archive {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-folder-archive 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-folder-archive 3s ease-in-out infinite alternate;
}
</style>