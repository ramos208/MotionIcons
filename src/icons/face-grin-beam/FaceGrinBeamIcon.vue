...
// AI Generated Motion Component for: face-grin-beam
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for face-grin-beam (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-face-grin-beam {
...
@keyframes motion-ai-idle-face-grin-beam {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-face-grin-beam 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-face-grin-beam 3s ease-in-out infinite alternate;
}
</style>