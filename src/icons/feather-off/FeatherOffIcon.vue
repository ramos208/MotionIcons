...
// AI Generated Motion Component for: feather-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for feather-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-feather-off {
...
@keyframes motion-ai-idle-feather-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-feather-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-feather-off 3s ease-in-out infinite alternate;
}
</style>