...
// AI Generated Motion Component for: chart-line-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for chart-line-down (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chart-line-down {
...
@keyframes motion-ai-idle-chart-line-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chart-line-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chart-line-down 3s ease-in-out infinite alternate;
}
</style>