...
// AI Generated Motion Component for: layers-union
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for layers-union (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-layers-union {
...
@keyframes motion-ai-idle-layers-union {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-layers-union 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-layers-union 3s ease-in-out infinite alternate;
}
</style>