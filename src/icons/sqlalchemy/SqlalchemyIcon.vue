...
// AI Generated Motion Component for: sqlalchemy
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sqlalchemy (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sqlalchemy {
...
@keyframes motion-ai-idle-sqlalchemy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sqlalchemy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sqlalchemy 3s ease-in-out infinite alternate;
}
</style>