<template>
  ...
  >
    ...
    >
      <path d="M10 16H14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M2 8L11.7317 3.13416C11.9006 3.04971 12.0994 3.0497 12.2683 3.13416L22 8" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 11V19C20 20.1046 19.1046 21 18 21H6C4.89543 21 4 20.1046 4 19V11" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: home-alt-slim-horiz
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for home-alt-slim-horiz (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-home-alt-slim-horiz {
...
@keyframes motion-ai-idle-home-alt-slim-horiz {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-home-alt-slim-horiz 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-home-alt-slim-horiz 3s ease-in-out infinite alternate;
}
</style>