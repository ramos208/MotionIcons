...
// AI Generated Motion Component for: article-ny-times
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for article-ny-times (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-article-ny-times {
...
@keyframes motion-ai-idle-article-ny-times {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-article-ny-times 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-article-ny-times 3s ease-in-out infinite alternate;
}
</style>