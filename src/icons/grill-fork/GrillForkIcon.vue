...
// AI Generated Motion Component for: grill-fork
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for grill-fork (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-grill-fork {
...
@keyframes motion-ai-idle-grill-fork {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grill-fork 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grill-fork 3s ease-in-out infinite alternate;
}
</style>