...
@keyframes motion-ai-bridge-surface {
...
@keyframes motion-ai-idle-bridge-surface {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bridge-surface 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bridge-surface 3s ease-in-out infinite alternate;
}
</style>