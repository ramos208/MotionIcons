...
// AI Generated Motion Component for: reacttable
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for reacttable (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-reacttable {
...
@keyframes motion-ai-idle-reacttable {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-reacttable 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-reacttable 3s ease-in-out infinite alternate;
}
</style>