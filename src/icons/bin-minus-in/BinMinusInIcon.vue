...
@keyframes motion-ai-bin-minus-in {
...
@keyframes motion-ai-idle-bin-minus-in {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bin-minus-in 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bin-minus-in 3s ease-in-out infinite alternate;
}
</style>