...
// AI Generated Motion Component for: security-check
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for security-check (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-security-check {
...
@keyframes motion-ai-idle-security-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-security-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-security-check 3s ease-in-out infinite alternate;
}
</style>