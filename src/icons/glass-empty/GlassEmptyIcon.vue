...
@keyframes motion-ai-glass-empty {
...
@keyframes motion-ai-idle-glass-empty {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-glass-empty 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-glass-empty 3s ease-in-out infinite alternate;
}
</style>