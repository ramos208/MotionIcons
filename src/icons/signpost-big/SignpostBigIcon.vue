...
// AI Generated Motion Component for: signpost-big
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for signpost-big (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-signpost-big {
...
@keyframes motion-ai-idle-signpost-big {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-signpost-big 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-signpost-big 3s ease-in-out infinite alternate;
}
</style>