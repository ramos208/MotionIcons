...
// AI Generated Motion Component for: bleach-no-chlorine
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bleach-no-chlorine (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bleach-no-chlorine {
...
@keyframes motion-ai-idle-bleach-no-chlorine {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bleach-no-chlorine 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bleach-no-chlorine 3s ease-in-out infinite alternate;
}
</style>