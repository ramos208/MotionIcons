...
@keyframes motion-ai-computer-add {
...
@keyframes motion-ai-idle-computer-add {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-computer-add 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-computer-add 3s ease-in-out infinite alternate;
}
</style>