...
@keyframes motion-ai-wolframlanguage {
...
@keyframes motion-ai-idle-wolframlanguage {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wolframlanguage 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wolframlanguage 3s ease-in-out infinite alternate;
}
</style>