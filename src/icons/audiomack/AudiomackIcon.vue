...
// AI Generated Motion Component for: audiomack
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for audiomack (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-audiomack {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-audiomack 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-audiomack 3s ease-in-out infinite alternate;
}
</style>