...
@keyframes motion-ai-touch-interaction04 {
...
@keyframes motion-ai-idle-touch-interaction04 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-touch-interaction04 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-touch-interaction04 3s ease-in-out infinite alternate;
}
</style>