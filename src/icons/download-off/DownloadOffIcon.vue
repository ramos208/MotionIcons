...
// AI Generated Motion Component for: download-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for download-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-download-off {
...
@keyframes motion-ai-idle-download-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-download-off 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-download-off 3s ease-in-out infinite alternate;
}
</style>