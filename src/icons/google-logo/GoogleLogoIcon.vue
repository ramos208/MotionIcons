...
// AI Generated Motion Component for: google-logo
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for google-logo (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-google-logo {
...
@keyframes motion-ai-idle-google-logo {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-google-logo 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-google-logo 3s ease-in-out infinite alternate;
}
</style>