...
// AI Generated Motion Component for: font-awesome-logo-full
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for font-awesome-logo-full (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-font-awesome-logo-full {
...
@keyframes motion-ai-idle-font-awesome-logo-full {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-font-awesome-logo-full 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-font-awesome-logo-full 3s ease-in-out infinite alternate;
}
</style>