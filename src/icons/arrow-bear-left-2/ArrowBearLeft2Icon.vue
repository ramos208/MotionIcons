...
// AI Generated Motion Component for: arrow-bear-left-2
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-bear-left-2 (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-bear-left-2 {
...
@keyframes motion-ai-idle-arrow-bear-left-2 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-bear-left-2 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-bear-left-2 3s ease-in-out infinite alternate;
}
</style>