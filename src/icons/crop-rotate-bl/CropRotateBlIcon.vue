...
@keyframes motion-ai-crop-rotate-bl {
...
@keyframes motion-ai-idle-crop-rotate-bl {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-crop-rotate-bl 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-crop-rotate-bl 4s linear infinite alternate;
}
</style>