...
// AI Generated Motion Component for: corners-in
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for corners-in (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-corners-in {
...
@keyframes motion-ai-idle-corners-in {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-corners-in 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-corners-in 3s ease-in-out infinite alternate;
}
</style>