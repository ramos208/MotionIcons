<template>
  ...
  >
    ...
    >
      <path d="M8 12L11 15L16 10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.8214 2.48697 15.5291 3.33782 17L2.5 21.5L7 20.6622C8.47087 21.513 10.1786 22 12 22Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: chat-bubble-check
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for chat-bubble-check (iconoir). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chat-bubble-check {
...
@keyframes motion-ai-idle-chat-bubble-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-bubble-check 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-bubble-check 2.5s ease-in-out infinite alternate;
}
</style>