...
// AI Generated Motion Component for: electronics-transistor
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for electronics-transistor (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-electronics-transistor {
...
@keyframes motion-ai-idle-electronics-transistor {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-electronics-transistor 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-electronics-transistor 3s ease-in-out infinite alternate;
}
</style>