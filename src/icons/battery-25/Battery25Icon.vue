...
@keyframes motion-ai-battery-25 {
...
@keyframes motion-ai-idle-battery-25 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-battery-25 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-battery-25 3s ease-in-out infinite alternate;
}
</style>