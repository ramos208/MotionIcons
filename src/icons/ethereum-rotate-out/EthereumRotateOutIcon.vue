...
// AI Generated Motion Component for: ethereum-rotate-out
// Category: loading
// Physics Presets: Dynamic kinetic adaptation for ethereum-rotate-out (iconoir). Selected semantic motion: rotate with custom idle (gear-sync) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ethereum-rotate-out {
...
@keyframes motion-ai-idle-ethereum-rotate-out {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ethereum-rotate-out 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-ethereum-rotate-out 4s linear infinite alternate;
}
</style>