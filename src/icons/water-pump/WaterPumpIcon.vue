...
@keyframes motion-ai-water-pump {
...
@keyframes motion-ai-idle-water-pump {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-water-pump 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-water-pump 3s ease-in-out infinite alternate;
}
</style>