...
// AI Generated Motion Component for: building-bank
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for building-bank (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-building-bank {
...
@keyframes motion-ai-idle-building-bank {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-building-bank 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-building-bank 3s ease-in-out infinite alternate;
}
</style>