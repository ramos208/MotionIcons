...
@keyframes motion-ai-sun-plant-wilt {
...
@keyframes motion-ai-idle-sun-plant-wilt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sun-plant-wilt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sun-plant-wilt 3s ease-in-out infinite alternate;
}
</style>