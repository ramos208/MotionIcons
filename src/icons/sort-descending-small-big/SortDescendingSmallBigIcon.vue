...
// AI Generated Motion Component for: sort-descending-small-big
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sort-descending-small-big (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sort-descending-small-big {
...
@keyframes motion-ai-idle-sort-descending-small-big {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sort-descending-small-big 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sort-descending-small-big 3s ease-in-out infinite alternate;
}
</style>