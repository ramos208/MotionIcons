...
@keyframes motion-ai-apple-music {
...
@keyframes motion-ai-idle-apple-music {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-apple-music 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-apple-music 3s ease-in-out infinite alternate;
}
</style>