...
@keyframes motion-ai-blockchain02 {
...
@keyframes motion-ai-idle-blockchain02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-blockchain02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-blockchain02 2s ease-in-out infinite alternate;
}
</style>