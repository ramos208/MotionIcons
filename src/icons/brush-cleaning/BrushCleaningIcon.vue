...
// AI Generated Motion Component for: brush-cleaning
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brush-cleaning (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brush-cleaning {
...
@keyframes motion-ai-idle-brush-cleaning {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brush-cleaning 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brush-cleaning 3s ease-in-out infinite alternate;
}
</style>