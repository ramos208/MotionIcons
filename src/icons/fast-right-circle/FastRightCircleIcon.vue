<template>
  ...
  >
    ...
    >
      <path d="M8 8.5L11.5 12L8 15.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 8.5L17.5 12L14 15.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: fast-right-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for fast-right-circle (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-fast-right-circle {
...
@keyframes motion-ai-idle-fast-right-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-fast-right-circle 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-fast-right-circle 3s ease-in-out infinite alternate;
}
</style>