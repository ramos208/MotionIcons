...
// AI Generated Motion Component for: snapchat-logo
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for snapchat-logo (phosphor). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-snapchat-logo {
...
@keyframes motion-ai-idle-snapchat-logo {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-snapchat-logo 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-snapchat-logo 2.5s ease-in-out infinite alternate;
}
</style>