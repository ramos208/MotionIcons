...
@keyframes motion-ai-low-signal {
...
@keyframes motion-ai-idle-low-signal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-low-signal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-low-signal 3s ease-in-out infinite alternate;
}
</style>