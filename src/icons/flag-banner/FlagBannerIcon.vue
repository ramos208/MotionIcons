...
// AI Generated Motion Component for: flag-banner
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for flag-banner (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-flag-banner {
...
@keyframes motion-ai-idle-flag-banner {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flag-banner 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flag-banner 3s ease-in-out infinite alternate;
}
</style>