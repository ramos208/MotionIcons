<template>
  ...
  >
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M13 3a14.5 14.5 0 0 0 -1 6"/><path d="M12 8.9s-2.77 .52 -4.1 -.8s-.8 -4 -.8 -4s2.57 -.53 3.88 .8s1.02 4 1.02 4"/><path d="M14 19a2 2 0 1 0 -4 0a2 2 0 0 0 4 0"/><path d="M14 17a2 2 0 1 1 0 -4a2 2 0 0 1 0 4"/><path d="M10 17a2 2 0 1 1 0 -4a2 2 0 0 1 0 4"/><path d="M12 13a2 2 0 1 1 0 -4a2 2 0 0 1 0 4"/><path d="M16 13a2 2 0 1 1 0 -4a2 2 0 0 1 0 4"/><path d="M8 13a2 2 0 1 1 0 -4a2 2 0 0 1 0 4"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: grape
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for grape (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-grape {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grape 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grape 3s ease-in-out infinite alternate;
}
</style>