...
@keyframes motion-ai-house-flood-water {
...
@keyframes motion-ai-idle-house-flood-water {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-flood-water 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-flood-water 3s ease-in-out infinite alternate;
}
</style>