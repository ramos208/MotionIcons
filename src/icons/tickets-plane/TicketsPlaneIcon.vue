...
// AI Generated Motion Component for: tickets-plane
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for tickets-plane (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-tickets-plane {
...
@keyframes motion-ai-idle-tickets-plane {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-tickets-plane 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-tickets-plane 3s ease-in-out infinite alternate;
}
</style>