...
// AI Generated Motion Component for: hexagon-asterisk
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hexagon-asterisk (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hexagon-asterisk {
...
@keyframes motion-ai-idle-hexagon-asterisk {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hexagon-asterisk 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hexagon-asterisk 3s ease-in-out infinite alternate;
}
</style>