...
// AI Generated Motion Component for: harmonyos
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for harmonyos (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-harmonyos {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-harmonyos 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-harmonyos 3s ease-in-out infinite alternate;
}
</style>