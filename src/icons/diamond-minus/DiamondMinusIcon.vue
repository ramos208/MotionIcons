...
// AI Generated Motion Component for: diamond-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for diamond-minus (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-diamond-minus {
...
@keyframes motion-ai-idle-diamond-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-diamond-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-diamond-minus 3s ease-in-out infinite alternate;
}
</style>