...
// AI Generated Motion Component for: square-dashed-bottom
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for square-dashed-bottom (lucide). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-square-dashed-bottom {
...
@keyframes motion-ai-idle-square-dashed-bottom {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-square-dashed-bottom 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-square-dashed-bottom 2s ease-in-out infinite alternate;
}
</style>