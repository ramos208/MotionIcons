<template>
  ...
  >
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M17 10l-2 -6"/><path d="M7 10l2 -6"/><path d="M11 20h-3.756a3 3 0 0 1 -2.965 -2.544l-1.255 -7.152a2 2 0 0 1 1.977 -2.304h13.999a2 2 0 0 1 1.977 2.304l-.215 1.227"/><path d="M13.483 12.658a2 2 0 1 0 -2.162 3.224"/><path d="M15 18a3 3 0 1 0 6 0a3 3 0 1 0 -6 0"/><path d="M20.2 20.2l1.8 1.8"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: basket-search
// Category: search
// Physics Presets: Dynamic kinetic adaptation for basket-search (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-basket-search {
...
@keyframes motion-ai-idle-basket-search {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-basket-search 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-basket-search 3s ease-in-out infinite alternate;
}
</style>