...
// AI Generated Motion Component for: analyze-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for analyze-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-analyze-off {
...
@keyframes motion-ai-idle-analyze-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-analyze-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-analyze-off 3s ease-in-out infinite alternate;
}
</style>