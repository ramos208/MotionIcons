...
// AI Generated Motion Component for: facebook-tag
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for facebook-tag (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-facebook-tag {
...
@keyframes motion-ai-idle-facebook-tag {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-facebook-tag 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-facebook-tag 3s ease-in-out infinite alternate;
}
</style>