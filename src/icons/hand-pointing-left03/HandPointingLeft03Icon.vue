...
// AI Generated Motion Component for: hand-pointing-left03
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-pointing-left03 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hand-pointing-left03 {
...
@keyframes motion-ai-idle-hand-pointing-left03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-pointing-left03 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-pointing-left03 3s ease-in-out infinite alternate;
}
</style>