...
@keyframes motion-ai-solar-system {
...
@keyframes motion-ai-idle-solar-system {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-solar-system 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-solar-system 3s ease-in-out infinite alternate;
}
</style>