...
@keyframes motion-ai-map-location {
...
@keyframes motion-ai-idle-map-location {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-map-location 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-map-location 3s ease-in-out infinite alternate;
}
</style>