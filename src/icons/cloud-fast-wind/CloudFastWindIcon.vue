...
@keyframes motion-ai-cloud-fast-wind {
...
@keyframes motion-ai-idle-cloud-fast-wind {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-fast-wind 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-fast-wind 3s ease-in-out infinite alternate;
}
</style>