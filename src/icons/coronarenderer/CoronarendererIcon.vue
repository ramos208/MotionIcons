...
@keyframes motion-ai-coronarenderer {
...
@keyframes motion-ai-idle-coronarenderer {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-coronarenderer 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-coronarenderer 3s ease-in-out infinite alternate;
}
</style>