...
// AI Generated Motion Component for: receipt-refund
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for receipt-refund (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-receipt-refund {
...
@keyframes motion-ai-idle-receipt-refund {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-refund 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-refund 3s ease-in-out infinite alternate;
}
</style>