...
// AI Generated Motion Component for: compress-lines
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for compress-lines (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-compress-lines {
...
@keyframes motion-ai-idle-compress-lines {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-compress-lines 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-compress-lines 3s ease-in-out infinite alternate;
}
</style>