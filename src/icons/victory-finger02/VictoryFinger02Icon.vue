...
// AI Generated Motion Component for: victory-finger02
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for victory-finger02 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-victory-finger02 {
...
@keyframes motion-ai-idle-victory-finger02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-victory-finger02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-victory-finger02 3s ease-in-out infinite alternate;
}
</style>