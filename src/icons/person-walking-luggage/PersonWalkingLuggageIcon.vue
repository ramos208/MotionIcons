...
@keyframes motion-ai-person-walking-luggage {
...
@keyframes motion-ai-idle-person-walking-luggage {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-walking-luggage 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-walking-luggage 3s ease-in-out infinite alternate;
}
</style>