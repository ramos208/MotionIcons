...
// AI Generated Motion Component for: check-line
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for check-line (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-check-line {
...
@keyframes motion-ai-idle-check-line {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-check-line 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-check-line 3s ease-in-out infinite alternate;
}
</style>