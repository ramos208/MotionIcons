...
// AI Generated Motion Component for: hand-swipe-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-swipe-right (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hand-swipe-right {
...
@keyframes motion-ai-idle-hand-swipe-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-swipe-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-swipe-right 3s ease-in-out infinite alternate;
}
</style>