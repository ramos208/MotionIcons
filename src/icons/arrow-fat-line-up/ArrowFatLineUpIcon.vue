...
// AI Generated Motion Component for: arrow-fat-line-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-fat-line-up (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-fat-line-up {
...
@keyframes motion-ai-idle-arrow-fat-line-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-fat-line-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-fat-line-up 3s ease-in-out infinite alternate;
}
</style>