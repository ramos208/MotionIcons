...
// AI Generated Motion Component for: caret-line-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for caret-line-up (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-caret-line-up {
...
@keyframes motion-ai-idle-caret-line-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-caret-line-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-caret-line-up 3s ease-in-out infinite alternate;
}
</style>