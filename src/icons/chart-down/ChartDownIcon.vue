...
@keyframes motion-ai-chart-down {
...
@keyframes motion-ai-idle-chart-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chart-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chart-down 3s ease-in-out infinite alternate;
}
</style>