...
// AI Generated Motion Component for: text-cursor-input
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for text-cursor-input (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-text-cursor-input {
...
@keyframes motion-ai-idle-text-cursor-input {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-text-cursor-input 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-text-cursor-input 3s ease-in-out infinite alternate;
}
</style>