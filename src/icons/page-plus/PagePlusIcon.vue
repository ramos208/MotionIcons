...
// AI Generated Motion Component for: page-plus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for page-plus (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-page-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-page-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-page-plus 3s ease-in-out infinite alternate;
}
</style>