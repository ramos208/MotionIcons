...
// AI Generated Motion Component for: sort-amount-down-alt
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sort-amount-down-alt (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sort-amount-down-alt {
...
@keyframes motion-ai-idle-sort-amount-down-alt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sort-amount-down-alt 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sort-amount-down-alt 3s ease-in-out infinite alternate;
}
</style>