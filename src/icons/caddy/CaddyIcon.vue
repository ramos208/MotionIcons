...
@keyframes motion-ai-idle-caddy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-caddy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-caddy 3s ease-in-out infinite alternate;
}
</style>