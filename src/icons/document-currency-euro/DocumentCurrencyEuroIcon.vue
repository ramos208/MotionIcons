...
// AI Generated Motion Component for: document-currency-euro
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for document-currency-euro (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-document-currency-euro {
...
@keyframes motion-ai-idle-document-currency-euro {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-document-currency-euro 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-document-currency-euro 3s ease-in-out infinite alternate;
}
</style>