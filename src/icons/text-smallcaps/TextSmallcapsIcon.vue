...
@keyframes motion-ai-text-smallcaps {
...
@keyframes motion-ai-idle-text-smallcaps {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-text-smallcaps 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-text-smallcaps 3s ease-in-out infinite alternate;
}
</style>