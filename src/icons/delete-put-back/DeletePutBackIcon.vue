...
@keyframes motion-ai-delete-put-back {
...
@keyframes motion-ai-idle-delete-put-back {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-delete-put-back 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-delete-put-back 3s ease-in-out infinite alternate;
}
</style>