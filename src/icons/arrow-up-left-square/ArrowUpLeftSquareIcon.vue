<template>
  ...
  >
    ...
    >
      <path d="M14.8284 14.8284L9.17153 9.17152M9.17153 9.17152H14.1213M9.17153 9.17152V14.1213" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 3.6V20.4C21 20.7314 20.7314 21 20.4 21H3.6C3.26863 21 3 20.7314 3 20.4V3.6C3 3.26863 3.26863 3 3.6 3H20.4C20.7314 3 21 3.26863 21 3.6Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: arrow-up-left-square
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-up-left-square (iconoir). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-up-left-square {
...
@keyframes motion-ai-idle-arrow-up-left-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-up-left-square 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-up-left-square 3s ease-in-out infinite alternate;
}
</style>