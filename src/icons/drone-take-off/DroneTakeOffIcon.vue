...
@keyframes motion-ai-drone-take-off {
...
@keyframes motion-ai-idle-drone-take-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-drone-take-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-drone-take-off 3s ease-in-out infinite alternate;
}
</style>