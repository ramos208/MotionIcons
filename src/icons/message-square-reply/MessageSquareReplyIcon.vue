...
// AI Generated Motion Component for: message-square-reply
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-square-reply (lucide). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-square-reply {
...
@keyframes motion-ai-idle-message-square-reply {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-square-reply 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-square-reply 2.5s ease-in-out infinite alternate;
}
</style>