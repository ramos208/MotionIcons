...
@keyframes motion-ai-receipt-cent {
...
@keyframes motion-ai-idle-receipt-cent {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-cent 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-cent 3s ease-in-out infinite alternate;
}
</style>