...
// AI Generated Motion Component for: snowflake-off
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for snowflake-off (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-snowflake-off {
...
@keyframes motion-ai-idle-snowflake-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-snowflake-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-snowflake-off 3s ease-in-out infinite alternate;
}
</style>