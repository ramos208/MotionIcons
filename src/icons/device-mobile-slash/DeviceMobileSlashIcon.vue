...
// AI Generated Motion Component for: device-mobile-slash
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for device-mobile-slash (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-device-mobile-slash {
...
@keyframes motion-ai-idle-device-mobile-slash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-device-mobile-slash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-device-mobile-slash 3s ease-in-out infinite alternate;
}
</style>