...
// AI Generated Motion Component for: mouse-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mouse-left (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mouse-left {
...
@keyframes motion-ai-idle-mouse-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mouse-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mouse-left 3s ease-in-out infinite alternate;
}
</style>