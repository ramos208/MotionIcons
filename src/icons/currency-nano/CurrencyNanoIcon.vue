...
// AI Generated Motion Component for: currency-nano
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-nano (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-nano {
...
@keyframes motion-ai-idle-currency-nano {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-nano 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-nano 3s ease-in-out infinite alternate;
}
</style>