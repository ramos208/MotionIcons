...
@keyframes motion-ai-face-kiss-wink-heart {
...
@keyframes motion-ai-idle-face-kiss-wink-heart {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-face-kiss-wink-heart 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-face-kiss-wink-heart 3s ease-in-out infinite alternate;
}
</style>