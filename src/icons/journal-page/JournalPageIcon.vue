...
// AI Generated Motion Component for: journal-page
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for journal-page (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-journal-page {
...
@keyframes motion-ai-idle-journal-page {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-journal-page 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-journal-page 3s ease-in-out infinite alternate;
}
</style>