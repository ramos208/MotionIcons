...
@keyframes motion-ai-microphone-plus {
...
@keyframes motion-ai-idle-microphone-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-microphone-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-microphone-plus 3s ease-in-out infinite alternate;
}
</style>