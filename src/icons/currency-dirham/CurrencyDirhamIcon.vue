...
// AI Generated Motion Component for: currency-dirham
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-dirham (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-dirham {
...
@keyframes motion-ai-idle-currency-dirham {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-dirham 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-dirham 3s ease-in-out infinite alternate;
}
</style>