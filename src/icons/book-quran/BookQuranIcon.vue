...
@keyframes motion-ai-book-quran {
...
@keyframes motion-ai-idle-book-quran {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-book-quran 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-book-quran 3s ease-in-out infinite alternate;
}
</style>