...
// AI Generated Motion Component for: bell-snooze
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for bell-snooze (heroicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bell-snooze {
...
@keyframes motion-ai-idle-bell-snooze {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bell-snooze 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bell-snooze 2.5s ease-in-out infinite alternate;
}
</style>