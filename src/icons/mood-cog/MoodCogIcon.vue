...
// AI Generated Motion Component for: mood-cog
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for mood-cog (tabler). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-mood-cog {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mood-cog 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mood-cog 3s ease-in-out infinite alternate;
}
</style>