...
@keyframes motion-ai-director-chair {
...
@keyframes motion-ai-idle-director-chair {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-director-chair 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-director-chair 2s ease-in-out infinite alternate;
}
</style>