...
// AI Generated Motion Component for: cloud-storm
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for cloud-storm (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cloud-storm {
...
@keyframes motion-ai-idle-cloud-storm {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-storm 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-storm 3s ease-in-out infinite alternate;
}
</style>