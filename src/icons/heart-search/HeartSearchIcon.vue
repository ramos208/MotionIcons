...
// AI Generated Motion Component for: heart-search
// Category: search
// Physics Presets: Dynamic kinetic adaptation for heart-search (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-heart-search {
...
@keyframes motion-ai-idle-heart-search {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-heart-search 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-heart-search 3s ease-in-out infinite alternate;
}
</style>