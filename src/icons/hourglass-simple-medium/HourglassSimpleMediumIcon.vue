...
// AI Generated Motion Component for: hourglass-simple-medium
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hourglass-simple-medium (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hourglass-simple-medium {
...
@keyframes motion-ai-idle-hourglass-simple-medium {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hourglass-simple-medium 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hourglass-simple-medium 3s ease-in-out infinite alternate;
}
</style>