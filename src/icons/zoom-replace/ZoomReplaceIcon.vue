...
// AI Generated Motion Component for: zoom-replace
// Category: search
// Physics Presets: Dynamic kinetic adaptation for zoom-replace (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zoom-replace {
...
@keyframes motion-ai-idle-zoom-replace {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zoom-replace 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zoom-replace 3s ease-in-out infinite alternate;
}
</style>