...
// AI Generated Motion Component for: airplane-helix-45deg
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for airplane-helix-45deg (iconoir). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-airplane-helix-45deg {
...
@keyframes motion-ai-idle-airplane-helix-45deg {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-airplane-helix-45deg 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-airplane-helix-45deg 2s ease-in-out infinite alternate;
}
</style>