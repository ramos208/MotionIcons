...
// AI Generated Motion Component for: stack-simple
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for stack-simple (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-stack-simple {
...
@keyframes motion-ai-idle-stack-simple {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-stack-simple 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-stack-simple 3s ease-in-out infinite alternate;
}
</style>