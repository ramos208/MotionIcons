...
// AI Generated Motion Component for: screen-share-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for screen-share-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-screen-share-off {
...
@keyframes motion-ai-idle-screen-share-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-screen-share-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-screen-share-off 3s ease-in-out infinite alternate;
}
</style>