...
// AI Generated Motion Component for: basket-discount
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for basket-discount (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-basket-discount {
...
@keyframes motion-ai-idle-basket-discount {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-basket-discount 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-basket-discount 3s ease-in-out infinite alternate;
}
</style>