...
// AI Generated Motion Component for: bug-play
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for bug-play (lucide). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-bug-play {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bug-play 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bug-play 3s ease-in-out infinite alternate;
}
</style>