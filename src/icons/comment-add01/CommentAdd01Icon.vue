...
// AI Generated Motion Component for: comment-add01
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for comment-add01 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-comment-add01 {
...
@keyframes motion-ai-idle-comment-add01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-comment-add01 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-comment-add01 3s ease-in-out infinite alternate;
}
</style>