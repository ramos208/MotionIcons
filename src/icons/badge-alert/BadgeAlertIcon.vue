...
// AI Generated Motion Component for: badge-alert
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for badge-alert (hugeicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-badge-alert {
...
@keyframes motion-ai-idle-badge-alert {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-alert 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-badge-alert 2.5s ease-in-out infinite alternate;
}
</style>