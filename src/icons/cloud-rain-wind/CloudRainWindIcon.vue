...
// AI Generated Motion Component for: cloud-rain-wind
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for cloud-rain-wind (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cloud-rain-wind {
...
@keyframes motion-ai-idle-cloud-rain-wind {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-rain-wind 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-rain-wind 3s ease-in-out infinite alternate;
}
</style>