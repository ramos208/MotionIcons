...
@keyframes motion-ai-hand-point-down {
...
@keyframes motion-ai-idle-hand-point-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-point-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-point-down 3s ease-in-out infinite alternate;
}
</style>