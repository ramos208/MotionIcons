...
// AI Generated Motion Component for: rotate01
// Category: loading
// Physics Presets: Dynamic kinetic adaptation for rotate01 (hugeicons). Selected semantic motion: rotate with custom idle (gear-sync) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-rotate01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rotate01 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-rotate01 4s linear infinite alternate;
}
</style>