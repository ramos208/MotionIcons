...
// AI Generated Motion Component for: brackets-contain-end
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for brackets-contain-end (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brackets-contain-end {
...
@keyframes motion-ai-idle-brackets-contain-end {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brackets-contain-end 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-brackets-contain-end 2s ease-in-out infinite alternate;
}
</style>