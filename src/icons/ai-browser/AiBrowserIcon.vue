...
@keyframes motion-ai-ai-browser {
...
@keyframes motion-ai-idle-ai-browser {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ai-browser 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-ai-browser 2s ease-in-out infinite alternate;
}
</style>