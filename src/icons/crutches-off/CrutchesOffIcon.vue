...
// AI Generated Motion Component for: crutches-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for crutches-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-crutches-off {
...
@keyframes motion-ai-idle-crutches-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-crutches-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-crutches-off 3s ease-in-out infinite alternate;
}
</style>