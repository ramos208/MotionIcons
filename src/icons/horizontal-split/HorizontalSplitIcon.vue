...
// AI Generated Motion Component for: horizontal-split
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for horizontal-split (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-horizontal-split {
...
@keyframes motion-ai-idle-horizontal-split {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-horizontal-split 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-horizontal-split 3s ease-in-out infinite alternate;
}
</style>