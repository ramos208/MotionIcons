...
@keyframes motion-ai-greek-helmet {
...
@keyframes motion-ai-idle-greek-helmet {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-greek-helmet 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-greek-helmet 3s ease-in-out infinite alternate;
}
</style>