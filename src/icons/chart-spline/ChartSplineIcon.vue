...
// AI Generated Motion Component for: chart-spline
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for chart-spline (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chart-spline {
...
@keyframes motion-ai-idle-chart-spline {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chart-spline 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chart-spline 3s ease-in-out infinite alternate;
}
</style>