...
// AI Generated Motion Component for: towel-rack
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for towel-rack (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-towel-rack {
...
@keyframes motion-ai-idle-towel-rack {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-towel-rack 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-towel-rack 3s ease-in-out infinite alternate;
}
</style>