...
// AI Generated Motion Component for: letter-case-upper
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for letter-case-upper (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-letter-case-upper {
...
@keyframes motion-ai-idle-letter-case-upper {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-letter-case-upper 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-letter-case-upper 3s ease-in-out infinite alternate;
}
</style>