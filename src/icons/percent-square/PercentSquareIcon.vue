...
@keyframes motion-ai-percent-square {
...
@keyframes motion-ai-idle-percent-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-percent-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-percent-square 3s ease-in-out infinite alternate;
}
</style>