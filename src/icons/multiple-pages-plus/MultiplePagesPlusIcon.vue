...
// AI Generated Motion Component for: multiple-pages-plus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for multiple-pages-plus (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-multiple-pages-plus {
...
@keyframes motion-ai-idle-multiple-pages-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-multiple-pages-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-multiple-pages-plus 3s ease-in-out infinite alternate;
}
</style>