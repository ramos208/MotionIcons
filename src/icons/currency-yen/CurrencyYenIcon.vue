...
// AI Generated Motion Component for: currency-yen
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-yen (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-yen {
...
@keyframes motion-ai-idle-currency-yen {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-yen 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-yen 3s ease-in-out infinite alternate;
}
</style>