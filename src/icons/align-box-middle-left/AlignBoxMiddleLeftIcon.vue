...
@keyframes motion-ai-align-box-middle-left {
...
@keyframes motion-ai-idle-align-box-middle-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-align-box-middle-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-align-box-middle-left 3s ease-in-out infinite alternate;
}
</style>