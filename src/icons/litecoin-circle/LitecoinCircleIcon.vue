<template>
  ...
  >
    ...
    >
      <path d="M10.5 7V16.4C10.5 16.7314 10.7686 17 11.1 17H15.5" stroke="currentColor" stroke-linecap="round"/><path d="M8.5 13L13 11" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: litecoin-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for litecoin-circle (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-litecoin-circle {
...
@keyframes motion-ai-idle-litecoin-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-litecoin-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-litecoin-circle 3s ease-in-out infinite alternate;
}
</style>