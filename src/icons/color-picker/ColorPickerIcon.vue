...
// AI Generated Motion Component for: color-picker
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for color-picker (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-color-picker {
...
@keyframes motion-ai-idle-color-picker {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-color-picker 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-color-picker 3s ease-in-out infinite alternate;
}
</style>