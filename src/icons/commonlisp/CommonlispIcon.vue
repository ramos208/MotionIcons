...
@keyframes motion-ai-commonlisp {
...
@keyframes motion-ai-idle-commonlisp {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-commonlisp 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-commonlisp 3s ease-in-out infinite alternate;
}
</style>