...
@keyframes motion-ai-theregister {
...
@keyframes motion-ai-idle-theregister {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-theregister 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-theregister 3s ease-in-out infinite alternate;
}
</style>