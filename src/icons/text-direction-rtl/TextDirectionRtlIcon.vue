...
// AI Generated Motion Component for: text-direction-rtl
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for text-direction-rtl (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-text-direction-rtl {
...
@keyframes motion-ai-idle-text-direction-rtl {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-text-direction-rtl 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-text-direction-rtl 3s ease-in-out infinite alternate;
}
</style>