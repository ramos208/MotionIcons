...
// AI Generated Motion Component for: smiley-blank
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for smiley-blank (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-smiley-blank {
...
@keyframes motion-ai-idle-smiley-blank {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-smiley-blank 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-smiley-blank 3s ease-in-out infinite alternate;
}
</style>