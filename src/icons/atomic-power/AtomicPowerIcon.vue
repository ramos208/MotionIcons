...
@keyframes motion-ai-atomic-power {
...
@keyframes motion-ai-idle-atomic-power {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-atomic-power 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-atomic-power 3s ease-in-out infinite alternate;
}
</style>