...
// AI Generated Motion Component for: ladder-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ladder-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ladder-off {
...
@keyframes motion-ai-idle-ladder-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ladder-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ladder-off 3s ease-in-out infinite alternate;
}
</style>