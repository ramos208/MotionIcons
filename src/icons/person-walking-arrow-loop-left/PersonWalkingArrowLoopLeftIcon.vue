...
@keyframes motion-ai-person-walking-arrow-loop-left {
...
@keyframes motion-ai-idle-person-walking-arrow-loop-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-walking-arrow-loop-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-walking-arrow-loop-left 3s ease-in-out infinite alternate;
}
</style>