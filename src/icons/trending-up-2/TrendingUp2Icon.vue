...
// AI Generated Motion Component for: trending-up-2
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for trending-up-2 (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-trending-up-2 {
...
@keyframes motion-ai-idle-trending-up-2 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-trending-up-2 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-trending-up-2 3s ease-in-out infinite alternate;
}
</style>