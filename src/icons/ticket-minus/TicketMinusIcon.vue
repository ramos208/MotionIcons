...
// AI Generated Motion Component for: ticket-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ticket-minus (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ticket-minus {
...
@keyframes motion-ai-idle-ticket-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ticket-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ticket-minus 3s ease-in-out infinite alternate;
}
</style>