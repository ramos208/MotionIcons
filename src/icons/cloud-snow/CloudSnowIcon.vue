...
@keyframes motion-ai-cloud-snow {
...
@keyframes motion-ai-idle-cloud-snow {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-snow 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-snow 3s ease-in-out infinite alternate;
}
</style>