...
// AI Generated Motion Component for: green-house
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for green-house (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-green-house {
...
@keyframes motion-ai-idle-green-house {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-green-house 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-green-house 3s ease-in-out infinite alternate;
}
</style>