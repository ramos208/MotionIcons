...
@keyframes motion-ai-copy-slash {
...
@keyframes motion-ai-idle-copy-slash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-copy-slash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-copy-slash 3s ease-in-out infinite alternate;
}
</style>