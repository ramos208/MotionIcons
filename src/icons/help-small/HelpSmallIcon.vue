...
// AI Generated Motion Component for: help-small
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for help-small (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-help-small {
...
@keyframes motion-ai-idle-help-small {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-help-small 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-help-small 3s ease-in-out infinite alternate;
}
</style>