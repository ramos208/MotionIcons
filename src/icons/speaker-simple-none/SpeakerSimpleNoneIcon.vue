...
// AI Generated Motion Component for: speaker-simple-none
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for speaker-simple-none (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-speaker-simple-none {
...
@keyframes motion-ai-idle-speaker-simple-none {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-speaker-simple-none 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-speaker-simple-none 3s ease-in-out infinite alternate;
}
</style>