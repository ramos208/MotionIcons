...
// AI Generated Motion Component for: cube-3d-sphere
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for cube-3d-sphere (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cube-3d-sphere {
...
@keyframes motion-ai-idle-cube-3d-sphere {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cube-3d-sphere 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cube-3d-sphere 3s ease-in-out infinite alternate;
}
</style>