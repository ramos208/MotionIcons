...
// AI Generated Motion Component for: system-update02
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for system-update02 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-system-update02 {
...
@keyframes motion-ai-idle-system-update02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-system-update02 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-system-update02 3s ease-in-out infinite alternate;
}
</style>