...
// AI Generated Motion Component for: discogs
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for discogs (simpleicons). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-discogs {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-discogs 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-discogs 3s ease-in-out infinite alternate;
}
</style>