...
@keyframes motion-ai-drone-charge-full {
...
@keyframes motion-ai-idle-drone-charge-full {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-drone-charge-full 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-drone-charge-full 3s ease-in-out infinite alternate;
}
</style>