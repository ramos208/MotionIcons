...
// AI Generated Motion Component for: gantt-chart-square
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for gantt-chart-square (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-gantt-chart-square {
...
@keyframes motion-ai-idle-gantt-chart-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-gantt-chart-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-gantt-chart-square 3s ease-in-out infinite alternate;
}
</style>