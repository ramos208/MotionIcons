...
@keyframes motion-ai-doc-magnifying-glass {
...
@keyframes motion-ai-idle-doc-magnifying-glass {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-doc-magnifying-glass 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-doc-magnifying-glass 3s ease-in-out infinite alternate;
}
</style>