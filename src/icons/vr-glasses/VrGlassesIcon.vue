...
@keyframes motion-ai-vr-glasses {
...
@keyframes motion-ai-idle-vr-glasses {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-vr-glasses 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-vr-glasses 3s ease-in-out infinite alternate;
}
</style>