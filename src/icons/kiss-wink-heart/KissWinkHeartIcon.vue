...
// AI Generated Motion Component for: kiss-wink-heart
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for kiss-wink-heart (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-kiss-wink-heart {
...
@keyframes motion-ai-idle-kiss-wink-heart {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-kiss-wink-heart 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-kiss-wink-heart 3s ease-in-out infinite alternate;
}
</style>