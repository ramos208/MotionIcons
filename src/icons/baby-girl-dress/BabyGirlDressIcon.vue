...
@keyframes motion-ai-baby-girl-dress {
...
@keyframes motion-ai-idle-baby-girl-dress {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-baby-girl-dress 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-baby-girl-dress 3s ease-in-out infinite alternate;
}
</style>