...
// AI Generated Motion Component for: hand-point-up
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-point-up (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hand-point-up {
...
@keyframes motion-ai-idle-hand-point-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-point-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-point-up 3s ease-in-out infinite alternate;
}
</style>