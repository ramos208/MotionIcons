...
// AI Generated Motion Component for: circuit-resistor
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circuit-resistor (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circuit-resistor {
...
@keyframes motion-ai-idle-circuit-resistor {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circuit-resistor 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circuit-resistor 3s ease-in-out infinite alternate;
}
</style>