...
// AI Generated Motion Component for: door-closed-locked
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for door-closed-locked (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-door-closed-locked {
...
@keyframes motion-ai-idle-door-closed-locked {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-door-closed-locked 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-door-closed-locked 3s ease-in-out infinite alternate;
}
</style>