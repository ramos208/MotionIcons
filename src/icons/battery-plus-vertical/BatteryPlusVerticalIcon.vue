...
// AI Generated Motion Component for: battery-plus-vertical
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for battery-plus-vertical (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-battery-plus-vertical {
...
@keyframes motion-ai-idle-battery-plus-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-battery-plus-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-battery-plus-vertical 3s ease-in-out infinite alternate;
}
</style>