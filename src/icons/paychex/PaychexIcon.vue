...
@keyframes motion-ai-idle-paychex {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-paychex 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-paychex 3s ease-in-out infinite alternate;
}
</style>