...
@keyframes motion-ai-artificial-intelligence08 {
...
@keyframes motion-ai-idle-artificial-intelligence08 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-artificial-intelligence08 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-artificial-intelligence08 3s ease-in-out infinite alternate;
}
</style>