...
// AI Generated Motion Component for: inbox-stack
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for inbox-stack (heroicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-inbox-stack {
...
@keyframes motion-ai-idle-inbox-stack {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-inbox-stack 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-inbox-stack 2.5s ease-in-out infinite alternate;
}
</style>