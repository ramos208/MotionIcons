...
@keyframes motion-ai-hierarchy-square08 {
...
@keyframes motion-ai-idle-hierarchy-square08 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hierarchy-square08 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hierarchy-square08 3s ease-in-out infinite alternate;
}
</style>