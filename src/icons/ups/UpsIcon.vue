...
// AI Generated Motion Component for: ups
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ups (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ups 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ups 3s ease-in-out infinite alternate;
}
</style>