...
@keyframes motion-ai-pointing-left06 {
...
@keyframes motion-ai-idle-pointing-left06 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pointing-left06 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pointing-left06 3s ease-in-out infinite alternate;
}
</style>