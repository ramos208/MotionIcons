...
// AI Generated Motion Component for: currency-naira
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for currency-naira (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-naira {
...
@keyframes motion-ai-idle-currency-naira {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-naira 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-currency-naira 2s ease-in-out infinite alternate;
}
</style>