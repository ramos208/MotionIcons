...
@keyframes motion-ai-user-secret {
...
@keyframes motion-ai-idle-user-secret {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-user-secret 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-user-secret 3s ease-in-out infinite alternate;
}
</style>