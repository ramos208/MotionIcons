...
// AI Generated Motion Component for: archive-box
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for archive-box (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-archive-box {
...
@keyframes motion-ai-idle-archive-box {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-archive-box 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-archive-box 3s ease-in-out infinite alternate;
}
</style>