...
// AI Generated Motion Component for: car-fan-auto
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for car-fan-auto (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-car-fan-auto {
...
@keyframes motion-ai-idle-car-fan-auto {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-car-fan-auto 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-car-fan-auto 3s ease-in-out infinite alternate;
}
</style>