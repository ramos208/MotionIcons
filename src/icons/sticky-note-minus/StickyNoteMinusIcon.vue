...
// AI Generated Motion Component for: sticky-note-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sticky-note-minus (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sticky-note-minus {
...
@keyframes motion-ai-idle-sticky-note-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sticky-note-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sticky-note-minus 3s ease-in-out infinite alternate;
}
</style>