...
@keyframes motion-ai-book-open-text {
...
@keyframes motion-ai-idle-book-open-text {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-book-open-text 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-book-open-text 3s ease-in-out infinite alternate;
}
</style>