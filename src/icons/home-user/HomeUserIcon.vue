<template>
  ...
  >
    ...
    >
      <path d="M2.5 9.5L12 4L21.5 9.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 21V20C7 17.2386 9.23858 15 12 15V15C14.7614 15 17 17.2386 17 20V21" stroke="currentColor" stroke-width="1.5"/><path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: home-user
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for home-user (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-home-user {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-home-user 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-home-user 3s ease-in-out infinite alternate;
}
</style>