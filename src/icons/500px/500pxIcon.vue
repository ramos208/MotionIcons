...
// AI Generated Motion Component for: 500px
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for 500px (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-500px {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-500px 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-500px 3s ease-in-out infinite alternate;
}
</style>