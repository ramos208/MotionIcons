...
@keyframes motion-ai-zebratechnologies {
...
@keyframes motion-ai-idle-zebratechnologies {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zebratechnologies 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zebratechnologies 3s ease-in-out infinite alternate;
}
</style>