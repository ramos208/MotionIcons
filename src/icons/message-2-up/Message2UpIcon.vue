...
// AI Generated Motion Component for: message-2-up
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-2-up (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-2-up {
...
@keyframes motion-ai-idle-message-2-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-2-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-2-up 2.5s ease-in-out infinite alternate;
}
</style>