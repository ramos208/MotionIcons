...
@keyframes motion-ai-customer-service {
...
@keyframes motion-ai-idle-customer-service {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-customer-service 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-customer-service 3s ease-in-out infinite alternate;
}
</style>