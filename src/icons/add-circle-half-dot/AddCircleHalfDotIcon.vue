<template>
  ...
  >
    ...
    >
      <path d="M12 2.00012C17.5228 2.00012 22 6.47727 22 12.0001C22 17.523 17.5228 22.0001 12 22.0001C6.47715 22.0001 2 17.523 2 12.0001M8.909 2.48699C7.9 2.8146 6.96135 3.29828 6.12153 3.90953M3.90943 6.12162C3.29806 6.9616 2.81432 7.90044 2.4867 8.90964" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M12 8.00012V16.0001M16 12.0001L8 12.0001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: add-circle-half-dot
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for add-circle-half-dot (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-add-circle-half-dot {
...
@keyframes motion-ai-idle-add-circle-half-dot {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-add-circle-half-dot 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-add-circle-half-dot 3s ease-in-out infinite alternate;
}
</style>