...
// AI Generated Motion Component for: square-slash
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for square-slash (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-square-slash {
...
@keyframes motion-ai-idle-square-slash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-square-slash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-square-slash 3s ease-in-out infinite alternate;
}
</style>