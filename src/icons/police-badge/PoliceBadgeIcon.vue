...
@keyframes motion-ai-police-badge {
...
@keyframes motion-ai-idle-police-badge {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-police-badge 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-police-badge 3s ease-in-out infinite alternate;
}
</style>