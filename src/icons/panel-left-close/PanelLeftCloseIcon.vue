...
// AI Generated Motion Component for: panel-left-close
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for panel-left-close (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-panel-left-close {
...
@keyframes motion-ai-idle-panel-left-close {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-panel-left-close 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-panel-left-close 3s ease-in-out infinite alternate;
}
</style>