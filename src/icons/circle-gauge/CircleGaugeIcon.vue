...
// AI Generated Motion Component for: circle-gauge
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circle-gauge (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circle-gauge {
...
@keyframes motion-ai-idle-circle-gauge {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circle-gauge 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circle-gauge 3s ease-in-out infinite alternate;
}
</style>