...
@keyframes motion-ai-idle-chedraui {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chedraui 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chedraui 3s ease-in-out infinite alternate;
}
</style>