<template>
  ...
  >
    ...
    >
      <path d="M15 21.5C19 16 19 8 15 2.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M11.5 20C15 15 15 9 11.5 4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M8.5 18C11.1667 14.25 11.1667 9.75 8.5 6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M5.5 16C7 13.5 7 10.5 5.5 8" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: contactless
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for contactless (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-contactless {
...
@keyframes motion-ai-idle-contactless {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-contactless 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-contactless 3s ease-in-out infinite alternate;
}
</style>