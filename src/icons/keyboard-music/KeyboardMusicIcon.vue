...
// AI Generated Motion Component for: keyboard-music
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for keyboard-music (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-keyboard-music {
...
@keyframes motion-ai-idle-keyboard-music {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-keyboard-music 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-keyboard-music 3s ease-in-out infinite alternate;
}
</style>