...
// AI Generated Motion Component for: hands-holding-child
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hands-holding-child (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hands-holding-child {
...
@keyframes motion-ai-idle-hands-holding-child {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hands-holding-child 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hands-holding-child 3s ease-in-out infinite alternate;
}
</style>