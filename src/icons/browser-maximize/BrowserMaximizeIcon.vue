...
// AI Generated Motion Component for: browser-maximize
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for browser-maximize (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-browser-maximize {
...
@keyframes motion-ai-idle-browser-maximize {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-browser-maximize 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-browser-maximize 3s ease-in-out infinite alternate;
}
</style>