...
// AI Generated Motion Component for: currency-rupee-nepalese
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-rupee-nepalese (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-rupee-nepalese {
...
@keyframes motion-ai-idle-currency-rupee-nepalese {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-rupee-nepalese 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-rupee-nepalese 3s ease-in-out infinite alternate;
}
</style>