...
@keyframes motion-ai-kanban-board {
...
@keyframes motion-ai-idle-kanban-board {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-kanban-board 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-kanban-board 3s ease-in-out infinite alternate;
}
</style>