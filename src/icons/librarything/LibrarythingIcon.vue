...
@keyframes motion-ai-librarything {
...
@keyframes motion-ai-idle-librarything {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-librarything 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-librarything 3s ease-in-out infinite alternate;
}
</style>