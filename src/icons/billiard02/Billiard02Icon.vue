...
// AI Generated Motion Component for: billiard02
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for billiard02 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-billiard02 {
...
@keyframes motion-ai-idle-billiard02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-billiard02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-billiard02 3s ease-in-out infinite alternate;
}
</style>