...
// AI Generated Motion Component for: smiley-sad
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for smiley-sad (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-smiley-sad {
...
@keyframes motion-ai-idle-smiley-sad {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-smiley-sad 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-smiley-sad 3s ease-in-out infinite alternate;
}
</style>