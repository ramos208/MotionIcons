<template>
  ...
  >
    ...
    >
      <path d="M0 0v24h24V0H0zm3.873 3.6875c1.0359-.0008 1.8758.8391 1.875 1.875-.0003 1.035-.8399 1.8738-1.875 1.873C2.8387 7.4352 2.0003 6.5968 2 5.5625c-.0008-1.035.838-1.8747 1.873-1.875zm4.4903.5078h3.5312l6.7344 10.8125h.045V4.1953H22v16.1172h-3.5469l-6.7168-10.791h-.0468v10.791H8.3633V4.1953zm-6.123 4.7871s.013.0041 3.3886 0v11.2754H2.2402V8.9824z"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: inspire
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for inspire (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-inspire {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-inspire 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-inspire 3s ease-in-out infinite alternate;
}
</style>