...
@keyframes motion-ai-long-sleeve-shirt {
...
@keyframes motion-ai-idle-long-sleeve-shirt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-long-sleeve-shirt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-long-sleeve-shirt 3s ease-in-out infinite alternate;
}
</style>