...
// AI Generated Motion Component for: bell-bolt
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for bell-bolt (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-bell-bolt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bell-bolt 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bell-bolt 2.5s ease-in-out infinite alternate;
}
</style>