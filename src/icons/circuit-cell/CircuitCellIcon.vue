...
// AI Generated Motion Component for: circuit-cell
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circuit-cell (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circuit-cell {
...
@keyframes motion-ai-idle-circuit-cell {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circuit-cell 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circuit-cell 3s ease-in-out infinite alternate;
}
</style>