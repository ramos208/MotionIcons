...
// AI Generated Motion Component for: location-broken
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for location-broken (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-location-broken {
...
@keyframes motion-ai-idle-location-broken {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-location-broken 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-location-broken 3s ease-in-out infinite alternate;
}
</style>