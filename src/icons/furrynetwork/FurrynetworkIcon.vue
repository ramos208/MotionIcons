...
@keyframes motion-ai-furrynetwork {
...
@keyframes motion-ai-idle-furrynetwork {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-furrynetwork 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-furrynetwork 2s ease-in-out infinite alternate;
}
</style>