...
// AI Generated Motion Component for: curly-loop
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for curly-loop (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-curly-loop {
...
@keyframes motion-ai-idle-curly-loop {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-curly-loop 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-curly-loop 3s ease-in-out infinite alternate;
}
</style>