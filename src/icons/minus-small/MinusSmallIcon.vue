...
// AI Generated Motion Component for: minus-small
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for minus-small (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-minus-small {
...
@keyframes motion-ai-idle-minus-small {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-minus-small 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-minus-small 3s ease-in-out infinite alternate;
}
</style>