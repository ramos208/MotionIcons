...
// AI Generated Motion Component for: mail-exclamation
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for mail-exclamation (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mail-exclamation {
...
@keyframes motion-ai-idle-mail-exclamation {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mail-exclamation 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-mail-exclamation 2.5s ease-in-out infinite alternate;
}
</style>