...
// AI Generated Motion Component for: hash-straight
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for hash-straight (phosphor). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hash-straight {
...
@keyframes motion-ai-idle-hash-straight {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hash-straight 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-hash-straight 2s ease-in-out infinite alternate;
}
</style>