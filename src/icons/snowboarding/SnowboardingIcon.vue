...
// AI Generated Motion Component for: snowboarding
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for snowboarding (fontawesome). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-snowboarding {
...
@keyframes motion-ai-idle-snowboarding {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-snowboarding 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-snowboarding 3s ease-in-out infinite alternate;
}
</style>