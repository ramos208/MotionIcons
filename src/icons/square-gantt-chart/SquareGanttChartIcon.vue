...
// AI Generated Motion Component for: square-gantt-chart
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for square-gantt-chart (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-square-gantt-chart {
...
@keyframes motion-ai-idle-square-gantt-chart {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-square-gantt-chart 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-square-gantt-chart 3s ease-in-out infinite alternate;
}
</style>