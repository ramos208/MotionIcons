...
// AI Generated Motion Component for: briefcase-metal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for briefcase-metal (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-briefcase-metal {
...
@keyframes motion-ai-idle-briefcase-metal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-briefcase-metal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-briefcase-metal 3s ease-in-out infinite alternate;
}
</style>