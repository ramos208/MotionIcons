...
// AI Generated Motion Component for: infinityfree
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for infinityfree (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-infinityfree {
...
@keyframes motion-ai-idle-infinityfree {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-infinityfree 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-infinityfree 3s ease-in-out infinite alternate;
}
</style>