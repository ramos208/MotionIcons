...
// AI Generated Motion Component for: brackets-contain
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for brackets-contain (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brackets-contain {
...
@keyframes motion-ai-idle-brackets-contain {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brackets-contain 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-brackets-contain 2s ease-in-out infinite alternate;
}
</style>