...
@keyframes motion-ai-idle-ice-cubes {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ice-cubes 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ice-cubes 3s ease-in-out infinite alternate;
}
</style>