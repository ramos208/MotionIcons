...
@keyframes motion-ai-credit-card-validation {
...
@keyframes motion-ai-idle-credit-card-validation {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-credit-card-validation 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-credit-card-validation 3s ease-in-out infinite alternate;
}
</style>