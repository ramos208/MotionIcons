...
@keyframes motion-ai-bitcoin-withdraw {
...
@keyframes motion-ai-idle-bitcoin-withdraw {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bitcoin-withdraw 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bitcoin-withdraw 3s ease-in-out infinite alternate;
}
</style>