...
@keyframes motion-ai-person-booth {
...
@keyframes motion-ai-idle-person-booth {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-booth 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-booth 3s ease-in-out infinite alternate;
}
</style>