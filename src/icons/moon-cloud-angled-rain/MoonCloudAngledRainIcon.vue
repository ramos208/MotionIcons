...
@keyframes motion-ai-moon-cloud-angled-rain {
...
@keyframes motion-ai-idle-moon-cloud-angled-rain {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-moon-cloud-angled-rain 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-moon-cloud-angled-rain 3s ease-in-out infinite alternate;
}
</style>