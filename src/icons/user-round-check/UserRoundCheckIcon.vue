...
// AI Generated Motion Component for: user-round-check
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for user-round-check (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-user-round-check {
...
@keyframes motion-ai-idle-user-round-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-user-round-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-user-round-check 3s ease-in-out infinite alternate;
}
</style>