...
@keyframes motion-ai-computer-remove {
...
@keyframes motion-ai-idle-computer-remove {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-computer-remove 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-computer-remove 3s ease-in-out infinite alternate;
}
</style>