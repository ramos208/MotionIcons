...
// AI Generated Motion Component for: face-laugh-wink
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for face-laugh-wink (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-face-laugh-wink {
...
@keyframes motion-ai-idle-face-laugh-wink {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-face-laugh-wink 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-face-laugh-wink 3s ease-in-out infinite alternate;
}
</style>