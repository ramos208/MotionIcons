...
// AI Generated Motion Component for: wrench-screwdriver
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for wrench-screwdriver (heroicons). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-wrench-screwdriver {
...
@keyframes motion-ai-idle-wrench-screwdriver {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wrench-screwdriver 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wrench-screwdriver 3s ease-in-out infinite alternate;
}
</style>