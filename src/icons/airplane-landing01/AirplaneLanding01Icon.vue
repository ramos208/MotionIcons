...
@keyframes motion-ai-airplane-landing01 {
...
@keyframes motion-ai-idle-airplane-landing01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-airplane-landing01 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-airplane-landing01 2s ease-in-out infinite alternate;
}
</style>