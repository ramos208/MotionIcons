...
// AI Generated Motion Component for: mail-up
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for mail-up (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-mail-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mail-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-mail-up 2.5s ease-in-out infinite alternate;
}
</style>