...
@keyframes motion-ai-dashboard-circle-settings {
...
@keyframes motion-ai-idle-dashboard-circle-settings {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dashboard-circle-settings 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dashboard-circle-settings 3s ease-in-out infinite alternate;
}
</style>