...
// AI Generated Motion Component for: quote-down-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for quote-down-circle (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-quote-down-circle {
...
@keyframes motion-ai-idle-quote-down-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-quote-down-circle 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-quote-down-circle 3s ease-in-out infinite alternate;
}
</style>