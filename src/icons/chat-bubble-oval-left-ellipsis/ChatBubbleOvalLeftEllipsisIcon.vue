...
// AI Generated Motion Component for: chat-bubble-oval-left-ellipsis
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for chat-bubble-oval-left-ellipsis (heroicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chat-bubble-oval-left-ellipsis {
...
@keyframes motion-ai-idle-chat-bubble-oval-left-ellipsis {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-bubble-oval-left-ellipsis 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-bubble-oval-left-ellipsis 2.5s ease-in-out infinite alternate;
}
</style>