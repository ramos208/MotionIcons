...
// AI Generated Motion Component for: free-rights
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for free-rights (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-free-rights {
...
@keyframes motion-ai-idle-free-rights {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-free-rights 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-free-rights 3s ease-in-out infinite alternate;
}
</style>