...
// AI Generated Motion Component for: pound-sterling
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for pound-sterling (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pound-sterling {
...
@keyframes motion-ai-idle-pound-sterling {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pound-sterling 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pound-sterling 3s ease-in-out infinite alternate;
}
</style>