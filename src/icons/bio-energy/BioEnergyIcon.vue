...
@keyframes motion-ai-bio-energy {
...
@keyframes motion-ai-idle-bio-energy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bio-energy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bio-energy 3s ease-in-out infinite alternate;
}
</style>