...
@keyframes motion-ai-camera-rotated01 {
...
@keyframes motion-ai-idle-camera-rotated01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-camera-rotated01 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-camera-rotated01 4s linear infinite alternate;
}
</style>