...
// AI Generated Motion Component for: person-standing
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for person-standing (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-person-standing {
...
@keyframes motion-ai-idle-person-standing {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-standing 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-standing 3s ease-in-out infinite alternate;
}
</style>