...
@keyframes motion-ai-spartan-helmet {
...
@keyframes motion-ai-idle-spartan-helmet {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-spartan-helmet 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-spartan-helmet 3s ease-in-out infinite alternate;
}
</style>