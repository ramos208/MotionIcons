...
// AI Generated Motion Component for: stereo-glasses
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for stereo-glasses (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-stereo-glasses {
...
@keyframes motion-ai-idle-stereo-glasses {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-stereo-glasses 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-stereo-glasses 3s ease-in-out infinite alternate;
}
</style>