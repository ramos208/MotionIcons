...
// AI Generated Motion Component for: cloud-drizzle
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for cloud-drizzle (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cloud-drizzle {
...
@keyframes motion-ai-idle-cloud-drizzle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-drizzle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-drizzle 3s ease-in-out infinite alternate;
}
</style>