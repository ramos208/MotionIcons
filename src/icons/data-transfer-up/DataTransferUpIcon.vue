<template>
  ...
  >
    ...
    >
      <path d="M7 4L7 5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 9L7 10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 20V4M17 4L20 7M17 4L14 7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 14V20M7 20L10 17M7 20L4 17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: data-transfer-up
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for data-transfer-up (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-data-transfer-up {
...
@keyframes motion-ai-idle-data-transfer-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-data-transfer-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-data-transfer-up 3s ease-in-out infinite alternate;
}
</style>