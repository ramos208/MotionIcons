...
// AI Generated Motion Component for: rewind-forward-60
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for rewind-forward-60 (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-rewind-forward-60 {
...
@keyframes motion-ai-idle-rewind-forward-60 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rewind-forward-60 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-rewind-forward-60 3s ease-in-out infinite alternate;
}
</style>