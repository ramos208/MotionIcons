...
// AI Generated Motion Component for: pathfinder-unite
// Category: search
// Physics Presets: Dynamic kinetic adaptation for pathfinder-unite (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pathfinder-unite {
...
@keyframes motion-ai-idle-pathfinder-unite {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pathfinder-unite 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pathfinder-unite 3s ease-in-out infinite alternate;
}
</style>