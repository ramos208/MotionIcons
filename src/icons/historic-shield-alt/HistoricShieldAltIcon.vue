...
// AI Generated Motion Component for: historic-shield-alt
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for historic-shield-alt (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-historic-shield-alt {
...
@keyframes motion-ai-idle-historic-shield-alt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-historic-shield-alt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-historic-shield-alt 3s ease-in-out infinite alternate;
}
</style>