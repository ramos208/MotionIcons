...
@keyframes motion-ai-material-and-texture {
...
@keyframes motion-ai-idle-material-and-texture {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-material-and-texture 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-material-and-texture 3s ease-in-out infinite alternate;
}
</style>