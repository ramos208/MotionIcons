...
@keyframes motion-ai-keyframe-plus {
...
@keyframes motion-ai-idle-keyframe-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-keyframe-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-keyframe-plus 3s ease-in-out infinite alternate;
}
</style>