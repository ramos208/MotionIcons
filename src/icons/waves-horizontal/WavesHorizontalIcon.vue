...
// AI Generated Motion Component for: waves-horizontal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for waves-horizontal (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-waves-horizontal {
...
@keyframes motion-ai-idle-waves-horizontal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-waves-horizontal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-waves-horizontal 3s ease-in-out infinite alternate;
}
</style>