...
// AI Generated Motion Component for: corner-up-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for corner-up-right (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-corner-up-right {
...
@keyframes motion-ai-idle-corner-up-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-corner-up-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-corner-up-right 3s ease-in-out infinite alternate;
}
</style>