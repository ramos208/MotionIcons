...
// AI Generated Motion Component for: link-simple-horizontal-break
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for link-simple-horizontal-break (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-link-simple-horizontal-break {
...
@keyframes motion-ai-idle-link-simple-horizontal-break {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-link-simple-horizontal-break 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-link-simple-horizontal-break 3s ease-in-out infinite alternate;
}
</style>