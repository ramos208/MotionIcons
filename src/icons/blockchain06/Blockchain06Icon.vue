...
@keyframes motion-ai-blockchain06 {
...
@keyframes motion-ai-idle-blockchain06 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-blockchain06 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-blockchain06 2s ease-in-out infinite alternate;
}
</style>