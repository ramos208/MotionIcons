...
// AI Generated Motion Component for: topology-star-ring
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for topology-star-ring (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-topology-star-ring {
...
@keyframes motion-ai-idle-topology-star-ring {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-topology-star-ring 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-topology-star-ring 2.5s ease-in-out infinite alternate;
}
</style>