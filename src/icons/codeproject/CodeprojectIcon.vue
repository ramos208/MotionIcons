...
@keyframes motion-ai-codeproject {
...
@keyframes motion-ai-idle-codeproject {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-codeproject 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-codeproject 2s ease-in-out infinite alternate;
}
</style>