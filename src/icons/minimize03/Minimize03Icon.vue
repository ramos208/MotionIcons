...
// AI Generated Motion Component for: minimize03
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for minimize03 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-minimize03 {
...
@keyframes motion-ai-idle-minimize03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-minimize03 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-minimize03 3s ease-in-out infinite alternate;
}
</style>