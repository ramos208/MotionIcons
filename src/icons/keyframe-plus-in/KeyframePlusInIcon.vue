...
// AI Generated Motion Component for: keyframe-plus-in
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for keyframe-plus-in (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-keyframe-plus-in {
...
@keyframes motion-ai-idle-keyframe-plus-in {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-keyframe-plus-in 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-keyframe-plus-in 3s ease-in-out infinite alternate;
}
</style>