...
// AI Generated Motion Component for: letter-case-toggle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for letter-case-toggle (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-letter-case-toggle {
...
@keyframes motion-ai-idle-letter-case-toggle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-letter-case-toggle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-letter-case-toggle 3s ease-in-out infinite alternate;
}
</style>