...
// AI Generated Motion Component for: phone-list
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for phone-list (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-phone-list {
...
@keyframes motion-ai-idle-phone-list {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-phone-list 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-phone-list 3s ease-in-out infinite alternate;
}
</style>