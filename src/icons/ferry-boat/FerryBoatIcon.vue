...
@keyframes motion-ai-ferry-boat {
...
@keyframes motion-ai-idle-ferry-boat {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ferry-boat 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ferry-boat 3s ease-in-out infinite alternate;
}
</style>