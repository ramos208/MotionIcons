...
// AI Generated Motion Component for: brackets-angle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brackets-angle (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brackets-angle {
...
@keyframes motion-ai-idle-brackets-angle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brackets-angle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brackets-angle 3s ease-in-out infinite alternate;
}
</style>