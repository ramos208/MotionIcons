...
@keyframes motion-ai-multiple-pages-xmark {
...
@keyframes motion-ai-idle-multiple-pages-xmark {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-multiple-pages-xmark 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-multiple-pages-xmark 3s ease-in-out infinite alternate;
}
</style>