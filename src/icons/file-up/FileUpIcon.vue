...
@keyframes motion-ai-idle-file-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-up 3s ease-in-out infinite alternate;
}
</style>