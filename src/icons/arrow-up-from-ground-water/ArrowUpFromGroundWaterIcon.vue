...
@keyframes motion-ai-arrow-up-from-ground-water {
...
@keyframes motion-ai-idle-arrow-up-from-ground-water {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-up-from-ground-water 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-up-from-ground-water 3s ease-in-out infinite alternate;
}
</style>