...
// AI Generated Motion Component for: clear-formatting
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for clear-formatting (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-clear-formatting {
...
@keyframes motion-ai-idle-clear-formatting {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-clear-formatting 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-clear-formatting 3s ease-in-out infinite alternate;
}
</style>