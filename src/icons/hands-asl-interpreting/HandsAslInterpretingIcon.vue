...
@keyframes motion-ai-hands-asl-interpreting {
...
@keyframes motion-ai-idle-hands-asl-interpreting {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hands-asl-interpreting 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hands-asl-interpreting 3s ease-in-out infinite alternate;
}
</style>