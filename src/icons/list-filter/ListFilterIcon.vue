...
// AI Generated Motion Component for: list-filter
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for list-filter (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-list-filter {
...
@keyframes motion-ai-idle-list-filter {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-list-filter 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-list-filter 3s ease-in-out infinite alternate;
}
</style>