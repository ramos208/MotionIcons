...
// AI Generated Motion Component for: signal-high
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for signal-high (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-signal-high {
...
@keyframes motion-ai-idle-signal-high {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-signal-high 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-signal-high 3s ease-in-out infinite alternate;
}
</style>