...
// AI Generated Motion Component for: corner-left-up
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for corner-left-up (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-corner-left-up {
...
@keyframes motion-ai-idle-corner-left-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-corner-left-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-corner-left-up 3s ease-in-out infinite alternate;
}
</style>