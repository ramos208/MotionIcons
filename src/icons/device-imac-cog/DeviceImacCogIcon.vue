...
// AI Generated Motion Component for: device-imac-cog
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for device-imac-cog (tabler). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-device-imac-cog {
...
@keyframes motion-ai-idle-device-imac-cog {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-device-imac-cog 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-device-imac-cog 3s ease-in-out infinite alternate;
}
</style>