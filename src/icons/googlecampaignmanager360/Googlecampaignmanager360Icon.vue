...
@keyframes motion-ai-googlecampaignmanager360 {
...
@keyframes motion-ai-idle-googlecampaignmanager360 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-googlecampaignmanager360 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-googlecampaignmanager360 2s ease-in-out infinite alternate;
}
</style>