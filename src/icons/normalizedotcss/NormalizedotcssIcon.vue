...
// AI Generated Motion Component for: normalizedotcss
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for normalizedotcss (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-normalizedotcss {
...
@keyframes motion-ai-idle-normalizedotcss {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-normalizedotcss 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-normalizedotcss 3s ease-in-out infinite alternate;
}
</style>