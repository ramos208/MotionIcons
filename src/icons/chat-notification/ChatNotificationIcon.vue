...
@keyframes motion-ai-chat-notification {
...
@keyframes motion-ai-idle-chat-notification {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-notification 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-notification 2.5s ease-in-out infinite alternate;
}
</style>