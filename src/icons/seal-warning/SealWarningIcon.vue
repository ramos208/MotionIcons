...
// AI Generated Motion Component for: seal-warning
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for seal-warning (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-seal-warning {
...
@keyframes motion-ai-idle-seal-warning {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-seal-warning 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-seal-warning 3s ease-in-out infinite alternate;
}
</style>