...
@keyframes motion-ai-house-tsunami {
...
@keyframes motion-ai-idle-house-tsunami {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-tsunami 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-tsunami 3s ease-in-out infinite alternate;
}
</style>