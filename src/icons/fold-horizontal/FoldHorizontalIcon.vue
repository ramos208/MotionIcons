...
// AI Generated Motion Component for: fold-horizontal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for fold-horizontal (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-fold-horizontal {
...
@keyframes motion-ai-idle-fold-horizontal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-fold-horizontal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-fold-horizontal 3s ease-in-out infinite alternate;
}
</style>