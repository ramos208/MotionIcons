...
// AI Generated Motion Component for: phone-arrow-down-left
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for phone-arrow-down-left (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-phone-arrow-down-left {
...
@keyframes motion-ai-idle-phone-arrow-down-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-phone-arrow-down-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-phone-arrow-down-left 3s ease-in-out infinite alternate;
}
</style>