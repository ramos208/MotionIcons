...
@keyframes motion-ai-hand-spock {
...
@keyframes motion-ai-idle-hand-spock {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-spock 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-spock 3s ease-in-out infinite alternate;
}
</style>