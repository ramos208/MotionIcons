...
@keyframes motion-ai-lungs-virus {
...
@keyframes motion-ai-idle-lungs-virus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lungs-virus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lungs-virus 3s ease-in-out infinite alternate;
}
</style>