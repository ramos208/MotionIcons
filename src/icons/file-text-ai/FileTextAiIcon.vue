...
// AI Generated Motion Component for: file-text-ai
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for file-text-ai (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-file-text-ai {
...
@keyframes motion-ai-idle-file-text-ai {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-text-ai 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-file-text-ai 2s ease-in-out infinite alternate;
}
</style>