...
// AI Generated Motion Component for: bell-school
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for bell-school (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bell-school {
...
@keyframes motion-ai-idle-bell-school {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bell-school 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bell-school 2.5s ease-in-out infinite alternate;
}
</style>