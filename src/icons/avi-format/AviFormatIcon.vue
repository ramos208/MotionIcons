...
@keyframes motion-ai-avi-format {
...
@keyframes motion-ai-idle-avi-format {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-avi-format 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-avi-format 3s ease-in-out infinite alternate;
}
</style>