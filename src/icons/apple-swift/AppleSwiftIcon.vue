...
// AI Generated Motion Component for: apple-swift
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for apple-swift (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-apple-swift {
...
@keyframes motion-ai-idle-apple-swift {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-apple-swift 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-apple-swift 3s ease-in-out infinite alternate;
}
</style>