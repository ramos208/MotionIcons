...
// AI Generated Motion Component for: math-symbols
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for math-symbols (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-math-symbols {
...
@keyframes motion-ai-idle-math-symbols {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-math-symbols 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-math-symbols 3s ease-in-out infinite alternate;
}
</style>