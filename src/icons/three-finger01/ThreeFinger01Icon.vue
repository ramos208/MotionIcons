...
// AI Generated Motion Component for: three-finger01
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for three-finger01 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-three-finger01 {
...
@keyframes motion-ai-idle-three-finger01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-three-finger01 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-three-finger01 3s ease-in-out infinite alternate;
}
</style>