<template>
  ...
  >
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M11.33 13.447a5.001 5.001 0 0 0 -6.33 .553v-9a5 5 0 0 1 7 0a5 5 0 0 0 7 0v6"/><path d="M5 21v-7"/><path d="M18 22l3.35 -3.284a2.143 2.143 0 0 0 .005 -3.071a2.242 2.242 0 0 0 -3.129 -.006l-.224 .22l-.223 -.22a2.242 2.242 0 0 0 -3.128 -.006a2.143 2.143 0 0 0 -.006 3.071l3.355 3.296"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: flag-heart
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for flag-heart (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-flag-heart {
...
@keyframes motion-ai-idle-flag-heart {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flag-heart 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flag-heart 3s ease-in-out infinite alternate;
}
</style>