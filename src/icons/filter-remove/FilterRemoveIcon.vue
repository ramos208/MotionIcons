...
@keyframes motion-ai-filter-remove {
...
@keyframes motion-ai-idle-filter-remove {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-filter-remove 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-filter-remove 3s ease-in-out infinite alternate;
}
</style>