...
@keyframes motion-ai-call-ringing04 {
...
@keyframes motion-ai-idle-call-ringing04 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-call-ringing04 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-call-ringing04 2.5s ease-in-out infinite alternate;
}
</style>