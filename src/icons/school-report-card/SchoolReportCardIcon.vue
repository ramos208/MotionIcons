...
@keyframes motion-ai-school-report-card {
...
@keyframes motion-ai-idle-school-report-card {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-school-report-card 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-school-report-card 3s ease-in-out infinite alternate;
}
</style>