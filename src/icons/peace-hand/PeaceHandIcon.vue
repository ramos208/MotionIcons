...
@keyframes motion-ai-peace-hand {
...
@keyframes motion-ai-idle-peace-hand {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-peace-hand 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-peace-hand 3s ease-in-out infinite alternate;
}
</style>