...
// AI Generated Motion Component for: chevron-circle-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for chevron-circle-up (fontawesome). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chevron-circle-up {
...
@keyframes motion-ai-idle-chevron-circle-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chevron-circle-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chevron-circle-up 3s ease-in-out infinite alternate;
}
</style>