...
// AI Generated Motion Component for: zodiac-leo
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for zodiac-leo (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zodiac-leo {
...
@keyframes motion-ai-idle-zodiac-leo {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zodiac-leo 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zodiac-leo 3s ease-in-out infinite alternate;
}
</style>