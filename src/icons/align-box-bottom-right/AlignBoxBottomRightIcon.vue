...
@keyframes motion-ai-align-box-bottom-right {
...
@keyframes motion-ai-idle-align-box-bottom-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-align-box-bottom-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-align-box-bottom-right 2s ease-in-out infinite alternate;
}
</style>