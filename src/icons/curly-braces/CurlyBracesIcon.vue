...
// AI Generated Motion Component for: curly-braces
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for curly-braces (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-curly-braces {
...
@keyframes motion-ai-idle-curly-braces {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-curly-braces 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-curly-braces 3s ease-in-out infinite alternate;
}
</style>