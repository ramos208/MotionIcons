...
// AI Generated Motion Component for: squares-subtract
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for squares-subtract (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-squares-subtract {
...
@keyframes motion-ai-idle-squares-subtract {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-squares-subtract 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-squares-subtract 3s ease-in-out infinite alternate;
}
</style>