...
// AI Generated Motion Component for: sort-ascending-letters
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for sort-ascending-letters (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-sort-ascending-letters {
...
@keyframes motion-ai-idle-sort-ascending-letters {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sort-ascending-letters 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-sort-ascending-letters 3s ease-in-out infinite alternate;
}
</style>