...
// AI Generated Motion Component for: arrow-down-left-circle
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-down-left-circle (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-down-left-circle {
...
@keyframes motion-ai-idle-arrow-down-left-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-down-left-circle 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-down-left-circle 3s ease-in-out infinite alternate;
}
</style>