...
// AI Generated Motion Component for: folder-share
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for folder-share (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-folder-share {
...
@keyframes motion-ai-idle-folder-share {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-folder-share 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-folder-share 3s ease-in-out infinite alternate;
}
</style>