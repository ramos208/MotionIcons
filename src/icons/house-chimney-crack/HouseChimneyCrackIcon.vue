...
@keyframes motion-ai-house-chimney-crack {
...
@keyframes motion-ai-idle-house-chimney-crack {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-chimney-crack 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-chimney-crack 3s ease-in-out infinite alternate;
}
</style>