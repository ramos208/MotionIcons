...
// AI Generated Motion Component for: split-square-vertical
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for split-square-vertical (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-split-square-vertical {
...
@keyframes motion-ai-idle-split-square-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-split-square-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-split-square-vertical 3s ease-in-out infinite alternate;
}
</style>