...
// AI Generated Motion Component for: chat-plus-in
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for chat-plus-in (iconoir). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chat-plus-in {
...
@keyframes motion-ai-idle-chat-plus-in {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-plus-in 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-plus-in 2.5s ease-in-out infinite alternate;
}
</style>