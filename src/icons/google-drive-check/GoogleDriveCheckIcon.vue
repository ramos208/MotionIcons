<template>
  ...
  >
    ...
    >
      <path d="M9.14286 3.00375L14.8571 3M9.14286 3.00375L2 15.0038M9.14286 3.00375L14.0446 12.5M14.8571 3L5.575 21M14.8571 3L21.5 14M5.575 21L2 15.0038M5.575 21H12.0036M2 15.0038H12.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 19L18 22L23 17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: google-drive-check
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for google-drive-check (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-google-drive-check {
...
@keyframes motion-ai-idle-google-drive-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-google-drive-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-google-drive-check 3s ease-in-out infinite alternate;
}
</style>