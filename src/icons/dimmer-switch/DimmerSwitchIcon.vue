...
// AI Generated Motion Component for: dimmer-switch
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for dimmer-switch (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-dimmer-switch {
...
@keyframes motion-ai-idle-dimmer-switch {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dimmer-switch 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dimmer-switch 3s ease-in-out infinite alternate;
}
</style>