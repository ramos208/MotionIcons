...
// AI Generated Motion Component for: tray-arrow-down
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for tray-arrow-down (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-tray-arrow-down {
...
@keyframes motion-ai-idle-tray-arrow-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-tray-arrow-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-tray-arrow-down 3s ease-in-out infinite alternate;
}
</style>