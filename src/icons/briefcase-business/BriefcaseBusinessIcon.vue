...
// AI Generated Motion Component for: briefcase-business
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for briefcase-business (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-briefcase-business {
...
@keyframes motion-ai-idle-briefcase-business {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-briefcase-business 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-briefcase-business 3s ease-in-out infinite alternate;
}
</style>