...
// AI Generated Motion Component for: badge-indian-rupee
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for badge-indian-rupee (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-badge-indian-rupee {
...
@keyframes motion-ai-idle-badge-indian-rupee {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-indian-rupee 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-indian-rupee 3s ease-in-out infinite alternate;
}
</style>