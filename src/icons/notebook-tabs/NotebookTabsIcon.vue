...
// AI Generated Motion Component for: notebook-tabs
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for notebook-tabs (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-notebook-tabs {
...
@keyframes motion-ai-idle-notebook-tabs {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-notebook-tabs 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-notebook-tabs 3s ease-in-out infinite alternate;
}
</style>