...
// AI Generated Motion Component for: binary-tree
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for binary-tree (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-binary-tree {
...
@keyframes motion-ai-idle-binary-tree {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-binary-tree 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-binary-tree 3s ease-in-out infinite alternate;
}
</style>