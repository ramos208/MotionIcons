...
@keyframes motion-ai-keyframe-align-horizontal {
...
@keyframes motion-ai-idle-keyframe-align-horizontal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-keyframe-align-horizontal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-keyframe-align-horizontal 3s ease-in-out infinite alternate;
}
</style>