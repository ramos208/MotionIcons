...
// AI Generated Motion Component for: book-up
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for book-up (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-book-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-book-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-book-up 3s ease-in-out infinite alternate;
}
</style>