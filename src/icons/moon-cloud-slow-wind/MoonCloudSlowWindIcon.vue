...
@keyframes motion-ai-moon-cloud-slow-wind {
...
@keyframes motion-ai-idle-moon-cloud-slow-wind {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-moon-cloud-slow-wind 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-moon-cloud-slow-wind 3s ease-in-out infinite alternate;
}
</style>