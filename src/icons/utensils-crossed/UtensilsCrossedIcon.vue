...
// AI Generated Motion Component for: utensils-crossed
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for utensils-crossed (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-utensils-crossed {
...
@keyframes motion-ai-idle-utensils-crossed {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-utensils-crossed 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-utensils-crossed 3s ease-in-out infinite alternate;
}
</style>