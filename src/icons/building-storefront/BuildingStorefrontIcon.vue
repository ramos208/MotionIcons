...
// AI Generated Motion Component for: building-storefront
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for building-storefront (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-building-storefront {
...
@keyframes motion-ai-idle-building-storefront {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-building-storefront 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-building-storefront 3s ease-in-out infinite alternate;
}
</style>