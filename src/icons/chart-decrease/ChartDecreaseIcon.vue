...
// AI Generated Motion Component for: chart-decrease
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for chart-decrease (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chart-decrease {
...
@keyframes motion-ai-idle-chart-decrease {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chart-decrease 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chart-decrease 3s ease-in-out infinite alternate;
}
</style>