...
@keyframes motion-ai-store-slash {
...
@keyframes motion-ai-idle-store-slash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-store-slash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-store-slash 3s ease-in-out infinite alternate;
}
</style>