...
@keyframes motion-ai-message-outgoing01 {
...
@keyframes motion-ai-idle-message-outgoing01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-outgoing01 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-outgoing01 2.5s ease-in-out infinite alternate;
}
</style>