...
// AI Generated Motion Component for: firefoxbrowser
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for firefoxbrowser (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-firefoxbrowser {
...
@keyframes motion-ai-idle-firefoxbrowser {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-firefoxbrowser 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-firefoxbrowser 3s ease-in-out infinite alternate;
}
</style>