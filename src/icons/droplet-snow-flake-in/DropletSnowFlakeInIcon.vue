...
// AI Generated Motion Component for: droplet-snow-flake-in
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for droplet-snow-flake-in (iconoir). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-droplet-snow-flake-in {
...
@keyframes motion-ai-idle-droplet-snow-flake-in {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-droplet-snow-flake-in 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-droplet-snow-flake-in 3s ease-in-out infinite alternate;
}
</style>