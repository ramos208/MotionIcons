...
// AI Generated Motion Component for: protools
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for protools (simpleicons). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-protools {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-protools 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-protools 3s ease-in-out infinite alternate;
}
</style>