...
@keyframes motion-ai-idle-layer-add {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-layer-add 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-layer-add 3s ease-in-out infinite alternate;
}
</style>