...
// AI Generated Motion Component for: adjustments-vertical
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for adjustments-vertical (heroicons). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-adjustments-vertical {
...
@keyframes motion-ai-idle-adjustments-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-adjustments-vertical 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-adjustments-vertical 3s ease-in-out infinite alternate;
}
</style>