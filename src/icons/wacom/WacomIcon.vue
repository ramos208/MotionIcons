...
@keyframes motion-ai-idle-wacom {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wacom 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wacom 3s ease-in-out infinite alternate;
}
</style>