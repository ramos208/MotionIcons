...
// AI Generated Motion Component for: tax-euro
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for tax-euro (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-tax-euro {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-tax-euro 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-tax-euro 3s ease-in-out infinite alternate;
}
</style>