...
// AI Generated Motion Component for: percentage-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for percentage-circle (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-percentage-circle {
...
@keyframes motion-ai-idle-percentage-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-percentage-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-percentage-circle 3s ease-in-out infinite alternate;
}
</style>