...
// AI Generated Motion Component for: brand-cupra
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-cupra (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-cupra {
...
@keyframes motion-ai-idle-brand-cupra {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-cupra 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-cupra 3s ease-in-out infinite alternate;
}
</style>