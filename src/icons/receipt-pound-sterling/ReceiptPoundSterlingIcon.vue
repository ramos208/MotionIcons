...
@keyframes motion-ai-receipt-pound-sterling {
...
@keyframes motion-ai-idle-receipt-pound-sterling {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-pound-sterling 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-pound-sterling 3s ease-in-out infinite alternate;
}
</style>