...
// AI Generated Motion Component for: users-group
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for users-group (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-users-group {
...
@keyframes motion-ai-idle-users-group {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-users-group 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-users-group 3s ease-in-out infinite alternate;
}
</style>