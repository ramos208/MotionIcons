...
@keyframes motion-ai-chat-outcome {
...
@keyframes motion-ai-idle-chat-outcome {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-outcome 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-outcome 2.5s ease-in-out infinite alternate;
}
</style>