...
// AI Generated Motion Component for: laugh-squint
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for laugh-squint (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-laugh-squint {
...
@keyframes motion-ai-idle-laugh-squint {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-laugh-squint 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-laugh-squint 3s ease-in-out infinite alternate;
}
</style>