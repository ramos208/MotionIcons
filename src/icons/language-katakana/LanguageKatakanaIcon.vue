...
// AI Generated Motion Component for: language-katakana
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for language-katakana (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-language-katakana {
...
@keyframes motion-ai-idle-language-katakana {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-language-katakana 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-language-katakana 3s ease-in-out infinite alternate;
}
</style>