...
@keyframes motion-ai-idle-vectary {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-vectary 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-vectary 3s ease-in-out infinite alternate;
}
</style>