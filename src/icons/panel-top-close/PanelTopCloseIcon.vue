...
// AI Generated Motion Component for: panel-top-close
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for panel-top-close (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-panel-top-close {
...
@keyframes motion-ai-idle-panel-top-close {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-panel-top-close 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-panel-top-close 3s ease-in-out infinite alternate;
}
</style>