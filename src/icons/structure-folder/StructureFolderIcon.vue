...
@keyframes motion-ai-structure-folder {
...
@keyframes motion-ai-idle-structure-folder {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-structure-folder 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-structure-folder 3s ease-in-out infinite alternate;
}
</style>