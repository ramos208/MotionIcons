...
// AI Generated Motion Component for: bell-question
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for bell-question (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bell-question {
...
@keyframes motion-ai-idle-bell-question {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bell-question 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bell-question 2.5s ease-in-out infinite alternate;
}
</style>