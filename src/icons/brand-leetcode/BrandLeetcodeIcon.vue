...
// AI Generated Motion Component for: brand-leetcode
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for brand-leetcode (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-leetcode {
...
@keyframes motion-ai-idle-brand-leetcode {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-leetcode 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-brand-leetcode 2s ease-in-out infinite alternate;
}
</style>