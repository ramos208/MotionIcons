...
// AI Generated Motion Component for: h2database
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for h2database (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-h2database {
...
@keyframes motion-ai-idle-h2database {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-h2database 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-h2database 3s ease-in-out infinite alternate;
}
</style>