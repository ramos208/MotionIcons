...
// AI Generated Motion Component for: hospital-symbol
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hospital-symbol (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hospital-symbol {
...
@keyframes motion-ai-idle-hospital-symbol {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hospital-symbol 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hospital-symbol 3s ease-in-out infinite alternate;
}
</style>