...
@keyframes motion-ai-house-medical-circle-exclamation {
...
@keyframes motion-ai-idle-house-medical-circle-exclamation {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-medical-circle-exclamation 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-medical-circle-exclamation 3s ease-in-out infinite alternate;
}
</style>