...
@keyframes motion-ai-truck-field {
...
@keyframes motion-ai-idle-truck-field {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-truck-field 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-truck-field 3s ease-in-out infinite alternate;
}
</style>