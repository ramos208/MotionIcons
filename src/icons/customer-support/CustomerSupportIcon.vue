...
@keyframes motion-ai-customer-support {
...
@keyframes motion-ai-idle-customer-support {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-customer-support 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-customer-support 3s ease-in-out infinite alternate;
}
</style>