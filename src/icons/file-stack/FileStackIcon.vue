...
@keyframes motion-ai-file-stack {
...
@keyframes motion-ai-idle-file-stack {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-stack 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-stack 3s ease-in-out infinite alternate;
}
</style>