...
// AI Generated Motion Component for: pointer-share
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for pointer-share (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pointer-share {
...
@keyframes motion-ai-idle-pointer-share {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pointer-share 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pointer-share 3s ease-in-out infinite alternate;
}
</style>