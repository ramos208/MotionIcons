...
// AI Generated Motion Component for: arrow-circle-up-left
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-circle-up-left (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-circle-up-left {
...
@keyframes motion-ai-idle-arrow-circle-up-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-circle-up-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-circle-up-left 3s ease-in-out infinite alternate;
}
</style>