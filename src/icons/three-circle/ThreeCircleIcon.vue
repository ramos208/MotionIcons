...
// AI Generated Motion Component for: three-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for three-circle (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-three-circle {
...
@keyframes motion-ai-idle-three-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-three-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-three-circle 3s ease-in-out infinite alternate;
}
</style>