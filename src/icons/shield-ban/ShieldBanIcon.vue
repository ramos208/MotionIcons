...
@keyframes motion-ai-shield-ban {
...
@keyframes motion-ai-idle-shield-ban {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shield-ban 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-shield-ban 3s ease-in-out infinite alternate;
}
</style>