<template>
  ...
  >
    ...
    >
      <path d="M22 17C13 17 11 22.9999 2 22.9999" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M22 1C13 1 11 6.9999 2 6.9999" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 16.5V7.5M12 16.5L14.5 14M12 16.5L9.5 14M12 7.5L14.5 10M12 7.5L9.5 10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: loft-3d
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for loft-3d (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-loft-3d {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-loft-3d 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-loft-3d 3s ease-in-out infinite alternate;
}
</style>