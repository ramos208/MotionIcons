...
@keyframes motion-ai-person-circle-plus {
...
@keyframes motion-ai-idle-person-circle-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-circle-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-circle-plus 3s ease-in-out infinite alternate;
}
</style>