...
// AI Generated Motion Component for: coin-vertical
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for coin-vertical (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-coin-vertical {
...
@keyframes motion-ai-idle-coin-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-coin-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-coin-vertical 3s ease-in-out infinite alternate;
}
</style>