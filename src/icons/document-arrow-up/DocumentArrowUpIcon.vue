...
// AI Generated Motion Component for: document-arrow-up
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for document-arrow-up (heroicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-document-arrow-up {
...
@keyframes motion-ai-idle-document-arrow-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-document-arrow-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-document-arrow-up 3s ease-in-out infinite alternate;
}
</style>