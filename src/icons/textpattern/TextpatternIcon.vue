...
@keyframes motion-ai-textpattern {
...
@keyframes motion-ai-idle-textpattern {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-textpattern 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-textpattern 3s ease-in-out infinite alternate;
}
</style>