...
// AI Generated Motion Component for: venus-and-mars
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for venus-and-mars (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-venus-and-mars {
...
@keyframes motion-ai-idle-venus-and-mars {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-venus-and-mars 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-venus-and-mars 3s ease-in-out infinite alternate;
}
</style>