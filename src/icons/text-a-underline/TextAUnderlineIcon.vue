...
// AI Generated Motion Component for: text-a-underline
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for text-a-underline (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-text-a-underline {
...
@keyframes motion-ai-idle-text-a-underline {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-text-a-underline 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-text-a-underline 3s ease-in-out infinite alternate;
}
</style>