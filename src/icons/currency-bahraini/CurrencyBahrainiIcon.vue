...
// AI Generated Motion Component for: currency-bahraini
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for currency-bahraini (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-bahraini {
...
@keyframes motion-ai-idle-currency-bahraini {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-bahraini 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-bahraini 3s ease-in-out infinite alternate;
}
</style>