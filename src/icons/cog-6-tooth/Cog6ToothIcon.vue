...
// AI Generated Motion Component for: cog-6-tooth
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for cog-6-tooth (heroicons). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cog-6-tooth {
...
@keyframes motion-ai-idle-cog-6-tooth {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cog-6-tooth 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cog-6-tooth 3s ease-in-out infinite alternate;
}
</style>