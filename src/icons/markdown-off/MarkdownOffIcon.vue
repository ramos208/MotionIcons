...
// AI Generated Motion Component for: markdown-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for markdown-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-markdown-off {
...
@keyframes motion-ai-idle-markdown-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-markdown-off 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-markdown-off 3s ease-in-out infinite alternate;
}
</style>