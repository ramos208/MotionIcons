...
@keyframes motion-ai-headset-warning {
...
@keyframes motion-ai-idle-headset-warning {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-headset-warning 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-headset-warning 3s ease-in-out infinite alternate;
}
</style>