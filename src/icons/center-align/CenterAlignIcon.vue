...
@keyframes motion-ai-center-align {
...
@keyframes motion-ai-idle-center-align {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-center-align 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-center-align 3s ease-in-out infinite alternate;
}
</style>