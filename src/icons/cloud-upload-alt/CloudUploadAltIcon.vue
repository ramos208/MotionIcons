...
// AI Generated Motion Component for: cloud-upload-alt
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for cloud-upload-alt (fontawesome). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cloud-upload-alt {
...
@keyframes motion-ai-idle-cloud-upload-alt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-upload-alt 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-upload-alt 3s ease-in-out infinite alternate;
}
</style>