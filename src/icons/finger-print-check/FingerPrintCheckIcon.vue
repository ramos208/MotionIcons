...
@keyframes motion-ai-finger-print-check {
...
@keyframes motion-ai-idle-finger-print-check {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-finger-print-check 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-finger-print-check 3s ease-in-out infinite alternate;
}
</style>