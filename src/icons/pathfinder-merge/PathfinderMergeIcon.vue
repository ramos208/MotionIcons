...
@keyframes motion-ai-pathfinder-merge {
...
@keyframes motion-ai-idle-pathfinder-merge {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pathfinder-merge 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pathfinder-merge 3s ease-in-out infinite alternate;
}
</style>