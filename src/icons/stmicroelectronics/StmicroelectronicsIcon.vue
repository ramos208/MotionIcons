...
// AI Generated Motion Component for: stmicroelectronics
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for stmicroelectronics (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-stmicroelectronics {
...
@keyframes motion-ai-idle-stmicroelectronics {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-stmicroelectronics 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-stmicroelectronics 3s ease-in-out infinite alternate;
}
</style>