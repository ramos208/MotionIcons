...
// AI Generated Motion Component for: badge-japanese-yen
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for badge-japanese-yen (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-badge-japanese-yen {
...
@keyframes motion-ai-idle-badge-japanese-yen {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-japanese-yen 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-japanese-yen 3s ease-in-out infinite alternate;
}
</style>