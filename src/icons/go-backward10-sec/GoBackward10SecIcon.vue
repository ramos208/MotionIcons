...
@keyframes motion-ai-go-backward10-sec {
...
@keyframes motion-ai-idle-go-backward10-sec {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-go-backward10-sec 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-go-backward10-sec 3s ease-in-out infinite alternate;
}
</style>