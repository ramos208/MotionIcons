...
// AI Generated Motion Component for: superset-of
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for superset-of (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-superset-of {
...
@keyframes motion-ai-idle-superset-of {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-superset-of 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-superset-of 3s ease-in-out infinite alternate;
}
</style>