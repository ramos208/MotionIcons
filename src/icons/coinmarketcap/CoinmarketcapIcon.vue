...
// AI Generated Motion Component for: coinmarketcap
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for coinmarketcap (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-coinmarketcap {
...
@keyframes motion-ai-idle-coinmarketcap {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-coinmarketcap 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-coinmarketcap 3s ease-in-out infinite alternate;
}
</style>