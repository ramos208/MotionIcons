...
// AI Generated Motion Component for: coffeescript
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for coffeescript (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-coffeescript {
...
@keyframes motion-ai-idle-coffeescript {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-coffeescript 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-coffeescript 3s ease-in-out infinite alternate;
}
</style>