...
// AI Generated Motion Component for: currency-won
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-won (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-won {
...
@keyframes motion-ai-idle-currency-won {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-won 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-won 3s ease-in-out infinite alternate;
}
</style>