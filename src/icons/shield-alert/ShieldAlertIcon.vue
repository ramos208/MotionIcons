...
// AI Generated Motion Component for: shield-alert
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for shield-alert (lucide). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-shield-alert {
...
@keyframes motion-ai-idle-shield-alert {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shield-alert 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-shield-alert 2.5s ease-in-out infinite alternate;
}
</style>