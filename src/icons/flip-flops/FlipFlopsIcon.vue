...
// AI Generated Motion Component for: flip-flops
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for flip-flops (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-flip-flops {
...
@keyframes motion-ai-idle-flip-flops {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flip-flops 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flip-flops 3s ease-in-out infinite alternate;
}
</style>