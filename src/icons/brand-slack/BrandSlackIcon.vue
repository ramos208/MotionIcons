...
// AI Generated Motion Component for: brand-slack
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-slack (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-slack {
...
@keyframes motion-ai-idle-brand-slack {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-slack 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-slack 3s ease-in-out infinite alternate;
}
</style>