...
// AI Generated Motion Component for: paperclip-horizontal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for paperclip-horizontal (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-paperclip-horizontal {
...
@keyframes motion-ai-idle-paperclip-horizontal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-paperclip-horizontal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-paperclip-horizontal 3s ease-in-out infinite alternate;
}
</style>