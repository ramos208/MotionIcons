...
@keyframes motion-ai-arrow-up19 {
...
@keyframes motion-ai-idle-arrow-up19 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-up19 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-up19 3s ease-in-out infinite alternate;
}
</style>