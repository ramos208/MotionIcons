...
// AI Generated Motion Component for: box-align-top-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for box-align-top-right (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-box-align-top-right {
...
@keyframes motion-ai-idle-box-align-top-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-box-align-top-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-box-align-top-right 3s ease-in-out infinite alternate;
}
</style>