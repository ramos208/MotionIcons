...
// AI Generated Motion Component for: lamp-floor
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for lamp-floor (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lamp-floor {
...
@keyframes motion-ai-idle-lamp-floor {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lamp-floor 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lamp-floor 3s ease-in-out infinite alternate;
}
</style>