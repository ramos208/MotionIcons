...
@keyframes motion-ai-file-script {
...
@keyframes motion-ai-idle-file-script {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-script 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-script 3s ease-in-out infinite alternate;
}
</style>