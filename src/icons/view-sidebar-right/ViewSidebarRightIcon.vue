...
// AI Generated Motion Component for: view-sidebar-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for view-sidebar-right (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-view-sidebar-right {
...
@keyframes motion-ai-idle-view-sidebar-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-view-sidebar-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-view-sidebar-right 3s ease-in-out infinite alternate;
}
</style>