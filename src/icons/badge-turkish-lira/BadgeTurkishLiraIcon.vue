...
@keyframes motion-ai-badge-turkish-lira {
...
@keyframes motion-ai-idle-badge-turkish-lira {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-turkish-lira 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-turkish-lira 3s ease-in-out infinite alternate;
}
</style>