...
// AI Generated Motion Component for: subset-proper-of
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for subset-proper-of (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-subset-proper-of {
...
@keyframes motion-ai-idle-subset-proper-of {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-subset-proper-of 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-subset-proper-of 3s ease-in-out infinite alternate;
}
</style>