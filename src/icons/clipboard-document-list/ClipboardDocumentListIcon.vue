...
// AI Generated Motion Component for: clipboard-document-list
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for clipboard-document-list (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-clipboard-document-list {
...
@keyframes motion-ai-idle-clipboard-document-list {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-clipboard-document-list 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-clipboard-document-list 3s ease-in-out infinite alternate;
}
</style>