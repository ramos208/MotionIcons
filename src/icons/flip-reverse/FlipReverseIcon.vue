...
@keyframes motion-ai-flip-reverse {
...
@keyframes motion-ai-idle-flip-reverse {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flip-reverse 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flip-reverse 3s ease-in-out infinite alternate;
}
</style>