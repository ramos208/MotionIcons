...
@keyframes motion-ai-cloud-showers-heavy {
...
@keyframes motion-ai-idle-cloud-showers-heavy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-showers-heavy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-showers-heavy 3s ease-in-out infinite alternate;
}
</style>