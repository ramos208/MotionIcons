...
// AI Generated Motion Component for: settings-cog
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for settings-cog (tabler). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-settings-cog {
...
@keyframes motion-ai-idle-settings-cog {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-settings-cog 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-settings-cog 3s ease-in-out infinite alternate;
}
</style>