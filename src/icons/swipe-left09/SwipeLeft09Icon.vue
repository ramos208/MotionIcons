...
@keyframes motion-ai-swipe-left09 {
...
@keyframes motion-ai-idle-swipe-left09 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-swipe-left09 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-swipe-left09 3s ease-in-out infinite alternate;
}
</style>