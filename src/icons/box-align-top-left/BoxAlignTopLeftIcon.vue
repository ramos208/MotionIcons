...
// AI Generated Motion Component for: box-align-top-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for box-align-top-left (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-box-align-top-left {
...
@keyframes motion-ai-idle-box-align-top-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-box-align-top-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-box-align-top-left 3s ease-in-out infinite alternate;
}
</style>