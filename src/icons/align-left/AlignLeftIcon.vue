...
// AI Generated Motion Component for: align-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for align-left (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-align-left {
...
@keyframes motion-ai-idle-align-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-align-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-align-left 3s ease-in-out infinite alternate;
}
</style>