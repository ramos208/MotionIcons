...
// AI Generated Motion Component for: presentation-analytics
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for presentation-analytics (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-presentation-analytics {
...
@keyframes motion-ai-idle-presentation-analytics {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-presentation-analytics 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-presentation-analytics 3s ease-in-out infinite alternate;
}
</style>