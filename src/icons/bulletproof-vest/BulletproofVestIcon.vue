...
@keyframes motion-ai-bulletproof-vest {
...
@keyframes motion-ai-idle-bulletproof-vest {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bulletproof-vest 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bulletproof-vest 3s ease-in-out infinite alternate;
}
</style>