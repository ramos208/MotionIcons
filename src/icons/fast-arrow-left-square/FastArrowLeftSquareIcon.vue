...
// AI Generated Motion Component for: fast-arrow-left-square
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for fast-arrow-left-square (iconoir). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-fast-arrow-left-square {
...
@keyframes motion-ai-idle-fast-arrow-left-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-fast-arrow-left-square 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-fast-arrow-left-square 3s ease-in-out infinite alternate;
}
</style>