...
// AI Generated Motion Component for: wind-arrow-down
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for wind-arrow-down (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-wind-arrow-down {
...
@keyframes motion-ai-idle-wind-arrow-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wind-arrow-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wind-arrow-down 3s ease-in-out infinite alternate;
}
</style>