...
// AI Generated Motion Component for: hat-glasses
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hat-glasses (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hat-glasses {
...
@keyframes motion-ai-idle-hat-glasses {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hat-glasses 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hat-glasses 3s ease-in-out infinite alternate;
}
</style>