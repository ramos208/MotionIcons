...
// AI Generated Motion Component for: zoom-reset
// Category: search
// Physics Presets: Dynamic kinetic adaptation for zoom-reset (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zoom-reset {
...
@keyframes motion-ai-idle-zoom-reset {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zoom-reset 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zoom-reset 3s ease-in-out infinite alternate;
}
</style>