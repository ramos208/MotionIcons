...
// AI Generated Motion Component for: cell-signal-medium
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for cell-signal-medium (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cell-signal-medium {
...
@keyframes motion-ai-idle-cell-signal-medium {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cell-signal-medium 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cell-signal-medium 3s ease-in-out infinite alternate;
}
</style>