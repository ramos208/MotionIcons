...
@keyframes motion-ai-swipe-down07 {
...
@keyframes motion-ai-idle-swipe-down07 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-swipe-down07 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-swipe-down07 3s ease-in-out infinite alternate;
}
</style>