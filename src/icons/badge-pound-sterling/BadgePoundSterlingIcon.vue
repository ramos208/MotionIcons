...
@keyframes motion-ai-badge-pound-sterling {
...
@keyframes motion-ai-idle-badge-pound-sterling {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-pound-sterling 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-pound-sterling 3s ease-in-out infinite alternate;
}
</style>