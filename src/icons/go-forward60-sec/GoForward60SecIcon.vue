...
// AI Generated Motion Component for: go-forward60-sec
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for go-forward60-sec (hugeicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-go-forward60-sec {
...
@keyframes motion-ai-idle-go-forward60-sec {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-go-forward60-sec 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-go-forward60-sec 3s ease-in-out infinite alternate;
}
</style>