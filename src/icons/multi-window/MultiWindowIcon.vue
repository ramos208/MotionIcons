...
@keyframes motion-ai-multi-window {
...
@keyframes motion-ai-idle-multi-window {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-multi-window 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-multi-window 3s ease-in-out infinite alternate;
}
</style>