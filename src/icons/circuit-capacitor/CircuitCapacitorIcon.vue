...
// AI Generated Motion Component for: circuit-capacitor
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circuit-capacitor (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circuit-capacitor {
...
@keyframes motion-ai-idle-circuit-capacitor {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circuit-capacitor 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circuit-capacitor 3s ease-in-out infinite alternate;
}
</style>