...
// AI Generated Motion Component for: book-marked
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for book-marked (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-book-marked {
...
@keyframes motion-ai-idle-book-marked {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-book-marked 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-book-marked 3s ease-in-out infinite alternate;
}
</style>