...
// AI Generated Motion Component for: message-down
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-down (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-down {
...
@keyframes motion-ai-idle-message-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-down 2.5s ease-in-out infinite alternate;
}
</style>