...
@keyframes motion-ai-badge-swiss-franc {
...
@keyframes motion-ai-idle-badge-swiss-franc {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-badge-swiss-franc 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-badge-swiss-franc 3s ease-in-out infinite alternate;
}
</style>