...
@keyframes motion-ai-ai-scheduling {
...
@keyframes motion-ai-idle-ai-scheduling {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ai-scheduling 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-ai-scheduling 2s ease-in-out infinite alternate;
}
</style>