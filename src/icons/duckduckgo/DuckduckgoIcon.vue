...
// AI Generated Motion Component for: duckduckgo
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for duckduckgo (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-duckduckgo {
...
@keyframes motion-ai-idle-duckduckgo {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-duckduckgo 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-duckduckgo 3s ease-in-out infinite alternate;
}
</style>