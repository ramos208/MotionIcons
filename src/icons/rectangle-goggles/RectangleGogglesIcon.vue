...
// AI Generated Motion Component for: rectangle-goggles
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for rectangle-goggles (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-rectangle-goggles {
...
@keyframes motion-ai-idle-rectangle-goggles {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rectangle-goggles 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-rectangle-goggles 3s ease-in-out infinite alternate;
}
</style>