...
// AI Generated Motion Component for: viewport-short
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for viewport-short (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-viewport-short {
...
@keyframes motion-ai-idle-viewport-short {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-viewport-short 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-viewport-short 3s ease-in-out infinite alternate;
}
</style>