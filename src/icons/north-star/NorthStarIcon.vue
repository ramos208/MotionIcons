...
// AI Generated Motion Component for: north-star
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for north-star (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-north-star {
...
@keyframes motion-ai-idle-north-star {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-north-star 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-north-star 3s ease-in-out infinite alternate;
}
</style>