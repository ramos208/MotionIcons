...
@keyframes motion-ai-truck-delivery {
...
@keyframes motion-ai-idle-truck-delivery {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-truck-delivery 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-truck-delivery 3s ease-in-out infinite alternate;
}
</style>