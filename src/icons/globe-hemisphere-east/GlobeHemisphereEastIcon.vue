...
// AI Generated Motion Component for: globe-hemisphere-east
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for globe-hemisphere-east (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-globe-hemisphere-east {
...
@keyframes motion-ai-idle-globe-hemisphere-east {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-globe-hemisphere-east 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-globe-hemisphere-east 3s ease-in-out infinite alternate;
}
</style>