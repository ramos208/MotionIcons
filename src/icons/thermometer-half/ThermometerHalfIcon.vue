...
// AI Generated Motion Component for: thermometer-half
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for thermometer-half (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-thermometer-half {
...
@keyframes motion-ai-idle-thermometer-half {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thermometer-half 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thermometer-half 3s ease-in-out infinite alternate;
}
</style>