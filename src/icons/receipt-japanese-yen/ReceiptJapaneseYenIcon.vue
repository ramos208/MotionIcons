...
@keyframes motion-ai-receipt-japanese-yen {
...
@keyframes motion-ai-idle-receipt-japanese-yen {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-japanese-yen 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-japanese-yen 3s ease-in-out infinite alternate;
}
</style>