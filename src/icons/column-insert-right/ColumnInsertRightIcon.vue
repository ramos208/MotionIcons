...
// AI Generated Motion Component for: column-insert-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for column-insert-right (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-column-insert-right {
...
@keyframes motion-ai-idle-column-insert-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-column-insert-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-column-insert-right 3s ease-in-out infinite alternate;
}
</style>