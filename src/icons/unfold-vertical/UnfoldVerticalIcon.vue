...
// AI Generated Motion Component for: unfold-vertical
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for unfold-vertical (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-unfold-vertical {
...
@keyframes motion-ai-idle-unfold-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-unfold-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-unfold-vertical 3s ease-in-out infinite alternate;
}
</style>