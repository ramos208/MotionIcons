...
@keyframes motion-ai-align-bottom-box {
...
@keyframes motion-ai-idle-align-bottom-box {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-align-bottom-box 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-align-bottom-box 2s ease-in-out infinite alternate;
}
</style>