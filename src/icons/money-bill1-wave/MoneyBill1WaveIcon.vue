...
@keyframes motion-ai-money-bill1-wave {
...
@keyframes motion-ai-idle-money-bill1-wave {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-money-bill1-wave 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-money-bill1-wave 3s ease-in-out infinite alternate;
}
</style>