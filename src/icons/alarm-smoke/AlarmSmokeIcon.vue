...
@keyframes motion-ai-alarm-smoke {
...
@keyframes motion-ai-idle-alarm-smoke {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-alarm-smoke 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-alarm-smoke 2.5s ease-in-out infinite alternate;
}
</style>