...
@keyframes motion-ai-drone-refresh {
...
@keyframes motion-ai-idle-drone-refresh {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-drone-refresh 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-drone-refresh 4s linear infinite alternate;
}
</style>