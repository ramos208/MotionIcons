...
// AI Generated Motion Component for: quote-up-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for quote-up-circle (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-quote-up-circle {
...
@keyframes motion-ai-idle-quote-up-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-quote-up-circle 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-quote-up-circle 3s ease-in-out infinite alternate;
}
</style>