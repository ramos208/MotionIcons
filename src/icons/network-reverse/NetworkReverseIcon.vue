...
@keyframes motion-ai-network-reverse {
...
@keyframes motion-ai-idle-network-reverse {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-network-reverse 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-network-reverse 2s ease-in-out infinite alternate;
}
</style>