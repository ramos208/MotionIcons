...
// AI Generated Motion Component for: soap-dispenser-droplet
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for soap-dispenser-droplet (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-soap-dispenser-droplet {
...
@keyframes motion-ai-idle-soap-dispenser-droplet {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-soap-dispenser-droplet 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-soap-dispenser-droplet 3s ease-in-out infinite alternate;
}
</style>