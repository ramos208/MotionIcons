...
@keyframes motion-ai-house-flood-water-circle-arrow-right {
...
@keyframes motion-ai-idle-house-flood-water-circle-arrow-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-flood-water-circle-arrow-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-flood-water-circle-arrow-right 3s ease-in-out infinite alternate;
}
</style>