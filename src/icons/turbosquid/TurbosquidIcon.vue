...
@keyframes motion-ai-turbosquid {
...
@keyframes motion-ai-idle-turbosquid {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-turbosquid 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-turbosquid 3s ease-in-out infinite alternate;
}
</style>