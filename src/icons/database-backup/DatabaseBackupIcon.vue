...
@keyframes motion-ai-database-backup {
...
@keyframes motion-ai-idle-database-backup {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-database-backup 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-database-backup 3s ease-in-out infinite alternate;
}
</style>