...
@keyframes motion-ai-eraser-add {
...
@keyframes motion-ai-idle-eraser-add {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-eraser-add 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-eraser-add 3s ease-in-out infinite alternate;
}
</style>