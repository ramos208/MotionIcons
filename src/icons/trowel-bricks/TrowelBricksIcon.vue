...
@keyframes motion-ai-trowel-bricks {
...
@keyframes motion-ai-idle-trowel-bricks {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-trowel-bricks 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-trowel-bricks 3s ease-in-out infinite alternate;
}
</style>