...
// AI Generated Motion Component for: square-terminal
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for square-terminal (lucide). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-square-terminal {
...
@keyframes motion-ai-idle-square-terminal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-square-terminal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-square-terminal 2s ease-in-out infinite alternate;
}
</style>