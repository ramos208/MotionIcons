...
// AI Generated Motion Component for: samsung
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for samsung (simpleicons). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-samsung {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-samsung 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-samsung 3s ease-in-out infinite alternate;
}
</style>