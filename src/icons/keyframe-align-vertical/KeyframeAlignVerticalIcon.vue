...
@keyframes motion-ai-keyframe-align-vertical {
...
@keyframes motion-ai-idle-keyframe-align-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-keyframe-align-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-keyframe-align-vertical 3s ease-in-out infinite alternate;
}
</style>