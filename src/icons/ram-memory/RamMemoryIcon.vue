<template>
  ...
  >
    ...
    >
      <path d="M2 12.5C3.10457 12.5 4 11.6046 4 10.5C4 9.39543 3.10457 8.5 2 8.5C2 7.09554 2 6.39331 2.33706 5.88886C2.48298 5.67048 2.67048 5.48298 2.88886 5.33706C3.39331 5 4.09554 5 5.5 5H18.5C19.9045 5 20.6067 5 21.1111 5.33706C21.3295 5.48298 21.517 5.67048 21.6629 5.88886C22 6.39331 22 7.09554 22 8.5C20.8954 8.5 20 9.39543 20 10.5C20 11.6046 20.8954 12.5 22 12.5C22 13.9045 22 14.6067 21.6629 15.1111C21.517 15.3295 21.3295 15.517 21.1111 15.6629C20.6067 16 19.9045 16 18.5 16H5.5C4.09554 16 3.39331 16 2.88886 15.6629C2.67048 15.517 2.48298 15.3295 2.33706 15.1111C2 14.6067 2 13.9045 2 12.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M4 16V18C4 18.5523 4.44772 19 5 19H8C8.55228 19 9 18.5523 9 18V16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M13 16V18C13 18.5523 13.4477 19 14 19H19C19.5523 19 20 18.5523 20 18V16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M12 9V12M16 9V12M8 9V12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: ram-memory
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ram-memory (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ram-memory {
...
@keyframes motion-ai-idle-ram-memory {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ram-memory 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ram-memory 3s ease-in-out infinite alternate;
}
</style>