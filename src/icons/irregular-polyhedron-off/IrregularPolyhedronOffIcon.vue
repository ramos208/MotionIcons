...
// AI Generated Motion Component for: irregular-polyhedron-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for irregular-polyhedron-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-irregular-polyhedron-off {
...
@keyframes motion-ai-idle-irregular-polyhedron-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-irregular-polyhedron-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-irregular-polyhedron-off 3s ease-in-out infinite alternate;
}
</style>