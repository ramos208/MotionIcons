...
// AI Generated Motion Component for: bars-3-center-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bars-3-center-left (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bars-3-center-left {
...
@keyframes motion-ai-idle-bars-3-center-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bars-3-center-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bars-3-center-left 3s ease-in-out infinite alternate;
}
</style>