...
// AI Generated Motion Component for: circle-chevron-right
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for circle-chevron-right (fontawesome). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circle-chevron-right {
...
@keyframes motion-ai-idle-circle-chevron-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circle-chevron-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circle-chevron-right 3s ease-in-out infinite alternate;
}
</style>