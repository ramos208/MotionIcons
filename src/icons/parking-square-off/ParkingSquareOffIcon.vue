...
// AI Generated Motion Component for: parking-square-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for parking-square-off (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-parking-square-off {
...
@keyframes motion-ai-idle-parking-square-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-parking-square-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-parking-square-off 3s ease-in-out infinite alternate;
}
</style>