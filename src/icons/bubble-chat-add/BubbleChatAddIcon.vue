...
// AI Generated Motion Component for: bubble-chat-add
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for bubble-chat-add (hugeicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bubble-chat-add {
...
@keyframes motion-ai-idle-bubble-chat-add {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bubble-chat-add 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bubble-chat-add 2.5s ease-in-out infinite alternate;
}
</style>