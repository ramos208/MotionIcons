...
// AI Generated Motion Component for: home-simple-door
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for home-simple-door (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-home-simple-door {
...
@keyframes motion-ai-idle-home-simple-door {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-home-simple-door 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-home-simple-door 3s ease-in-out infinite alternate;
}
</style>