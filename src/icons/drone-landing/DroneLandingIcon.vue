...
// AI Generated Motion Component for: drone-landing
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for drone-landing (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-drone-landing {
...
@keyframes motion-ai-idle-drone-landing {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-drone-landing 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-drone-landing 3s ease-in-out infinite alternate;
}
</style>