...
// AI Generated Motion Component for: building-estate
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for building-estate (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-building-estate {
...
@keyframes motion-ai-idle-building-estate {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-building-estate 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-building-estate 3s ease-in-out infinite alternate;
}
</style>