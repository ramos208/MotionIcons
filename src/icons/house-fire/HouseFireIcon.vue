...
@keyframes motion-ai-house-fire {
...
@keyframes motion-ai-idle-house-fire {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-house-fire 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-house-fire 3s ease-in-out infinite alternate;
}
</style>