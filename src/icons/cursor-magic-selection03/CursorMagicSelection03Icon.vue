...
@keyframes motion-ai-cursor-magic-selection03 {
...
@keyframes motion-ai-idle-cursor-magic-selection03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cursor-magic-selection03 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-cursor-magic-selection03 2s ease-in-out infinite alternate;
}
</style>