...
// AI Generated Motion Component for: computer-video
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for computer-video (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-computer-video {
...
@keyframes motion-ai-idle-computer-video {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-computer-video 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-computer-video 3s ease-in-out infinite alternate;
}
</style>