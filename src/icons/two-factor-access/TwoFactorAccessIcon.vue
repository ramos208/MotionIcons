...
@keyframes motion-ai-two-factor-access {
...
@keyframes motion-ai-idle-two-factor-access {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-two-factor-access 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-two-factor-access 3s ease-in-out infinite alternate;
}
</style>