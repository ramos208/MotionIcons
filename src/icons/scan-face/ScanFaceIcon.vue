...
// AI Generated Motion Component for: scan-face
// Category: search
// Physics Presets: Dynamic kinetic adaptation for scan-face (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-scan-face {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-scan-face 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-scan-face 3s ease-in-out infinite alternate;
}
</style>