...
@keyframes motion-ai-open-caption {
...
@keyframes motion-ai-idle-open-caption {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-open-caption 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-open-caption 3s ease-in-out infinite alternate;
}
</style>