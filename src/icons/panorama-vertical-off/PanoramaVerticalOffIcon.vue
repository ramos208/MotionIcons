...
// AI Generated Motion Component for: panorama-vertical-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for panorama-vertical-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-panorama-vertical-off {
...
@keyframes motion-ai-idle-panorama-vertical-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-panorama-vertical-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-panorama-vertical-off 3s ease-in-out infinite alternate;
}
</style>