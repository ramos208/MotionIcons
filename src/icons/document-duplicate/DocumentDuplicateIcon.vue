...
// AI Generated Motion Component for: document-duplicate
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for document-duplicate (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-document-duplicate {
...
@keyframes motion-ai-idle-document-duplicate {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-document-duplicate 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-document-duplicate 3s ease-in-out infinite alternate;
}
</style>