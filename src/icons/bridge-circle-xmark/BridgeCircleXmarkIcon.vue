...
// AI Generated Motion Component for: bridge-circle-xmark
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bridge-circle-xmark (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bridge-circle-xmark {
...
@keyframes motion-ai-idle-bridge-circle-xmark {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bridge-circle-xmark 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bridge-circle-xmark 3s ease-in-out infinite alternate;
}
</style>