...
@keyframes motion-ai-heavy-rain {
...
@keyframes motion-ai-idle-heavy-rain {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-heavy-rain 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-heavy-rain 3s ease-in-out infinite alternate;
}
</style>