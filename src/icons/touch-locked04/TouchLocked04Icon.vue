...
@keyframes motion-ai-touch-locked04 {
...
@keyframes motion-ai-idle-touch-locked04 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-touch-locked04 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-touch-locked04 3s ease-in-out infinite alternate;
}
</style>