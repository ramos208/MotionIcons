...
@keyframes motion-ai-monitor-pause {
...
@keyframes motion-ai-idle-monitor-pause {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-monitor-pause 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-monitor-pause 3s ease-in-out infinite alternate;
}
</style>