...
// AI Generated Motion Component for: mail-off
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for mail-off (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-mail-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mail-off 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-mail-off 2.5s ease-in-out infinite alternate;
}
</style>