...
@keyframes motion-ai-square-rss {
...
@keyframes motion-ai-idle-square-rss {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-square-rss 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-square-rss 3s ease-in-out infinite alternate;
}
</style>