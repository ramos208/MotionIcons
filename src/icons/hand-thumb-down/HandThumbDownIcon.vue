...
// AI Generated Motion Component for: hand-thumb-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-thumb-down (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hand-thumb-down {
...
@keyframes motion-ai-idle-hand-thumb-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-thumb-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-thumb-down 3s ease-in-out infinite alternate;
}
</style>