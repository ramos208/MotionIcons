...
// AI Generated Motion Component for: thespritersresource
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for thespritersresource (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-thespritersresource {
...
@keyframes motion-ai-idle-thespritersresource {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thespritersresource 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thespritersresource 3s ease-in-out infinite alternate;
}
</style>