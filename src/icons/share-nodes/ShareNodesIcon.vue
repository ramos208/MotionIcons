...
// AI Generated Motion Component for: share-nodes
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for share-nodes (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-share-nodes {
...
@keyframes motion-ai-idle-share-nodes {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-share-nodes 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-share-nodes 3s ease-in-out infinite alternate;
}
</style>