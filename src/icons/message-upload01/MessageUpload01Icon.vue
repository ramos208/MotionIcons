...
@keyframes motion-ai-message-upload01 {
...
@keyframes motion-ai-idle-message-upload01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-upload01 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-upload01 2.5s ease-in-out infinite alternate;
}
</style>