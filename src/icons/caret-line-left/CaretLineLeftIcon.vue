...
// AI Generated Motion Component for: caret-line-left
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for caret-line-left (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-caret-line-left {
...
@keyframes motion-ai-idle-caret-line-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-caret-line-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-caret-line-left 3s ease-in-out infinite alternate;
}
</style>