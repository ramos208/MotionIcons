...
// AI Generated Motion Component for: battery-vertical-low
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for battery-vertical-low (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-battery-vertical-low {
...
@keyframes motion-ai-idle-battery-vertical-low {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-battery-vertical-low 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-battery-vertical-low 3s ease-in-out infinite alternate;
}
</style>