...
@keyframes motion-ai-package-out-of-stock {
...
@keyframes motion-ai-idle-package-out-of-stock {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-package-out-of-stock 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-package-out-of-stock 3s ease-in-out infinite alternate;
}
</style>