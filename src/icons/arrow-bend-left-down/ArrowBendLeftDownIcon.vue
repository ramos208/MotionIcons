...
// AI Generated Motion Component for: arrow-bend-left-down
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-bend-left-down (phosphor). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-bend-left-down {
...
@keyframes motion-ai-idle-arrow-bend-left-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-bend-left-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-bend-left-down 3s ease-in-out infinite alternate;
}
</style>