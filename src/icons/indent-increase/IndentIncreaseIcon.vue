...
// AI Generated Motion Component for: indent-increase
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for indent-increase (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-indent-increase {
...
@keyframes motion-ai-idle-indent-increase {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-indent-increase 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-indent-increase 3s ease-in-out infinite alternate;
}
</style>