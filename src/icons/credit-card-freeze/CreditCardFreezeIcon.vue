...
@keyframes motion-ai-credit-card-freeze {
...
@keyframes motion-ai-idle-credit-card-freeze {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-credit-card-freeze 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-credit-card-freeze 3s ease-in-out infinite alternate;
}
</style>