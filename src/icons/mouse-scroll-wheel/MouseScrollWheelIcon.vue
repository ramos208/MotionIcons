...
// AI Generated Motion Component for: mouse-scroll-wheel
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mouse-scroll-wheel (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mouse-scroll-wheel {
...
@keyframes motion-ai-idle-mouse-scroll-wheel {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mouse-scroll-wheel 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mouse-scroll-wheel 3s ease-in-out infinite alternate;
}
</style>