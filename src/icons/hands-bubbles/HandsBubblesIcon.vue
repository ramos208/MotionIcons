...
@keyframes motion-ai-hands-bubbles {
...
@keyframes motion-ai-idle-hands-bubbles {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hands-bubbles 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hands-bubbles 3s ease-in-out infinite alternate;
}
</style>