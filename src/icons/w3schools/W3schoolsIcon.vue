...
@keyframes motion-ai-idle-w3schools {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-w3schools 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-w3schools 3s ease-in-out infinite alternate;
}
</style>