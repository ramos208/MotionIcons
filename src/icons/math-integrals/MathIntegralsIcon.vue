...
// AI Generated Motion Component for: math-integrals
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for math-integrals (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-math-integrals {
...
@keyframes motion-ai-idle-math-integrals {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-math-integrals 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-math-integrals 3s ease-in-out infinite alternate;
}
</style>