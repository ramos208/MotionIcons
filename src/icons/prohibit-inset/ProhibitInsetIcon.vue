...
// AI Generated Motion Component for: prohibit-inset
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for prohibit-inset (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-prohibit-inset {
...
@keyframes motion-ai-idle-prohibit-inset {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-prohibit-inset 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-prohibit-inset 3s ease-in-out infinite alternate;
}
</style>