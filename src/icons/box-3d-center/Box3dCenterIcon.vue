...
// AI Generated Motion Component for: box-3d-center
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for box-3d-center (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-box-3d-center {
...
@keyframes motion-ai-idle-box-3d-center {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-box-3d-center 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-box-3d-center 3s ease-in-out infinite alternate;
}
</style>