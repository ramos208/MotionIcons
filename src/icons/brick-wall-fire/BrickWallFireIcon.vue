...
// AI Generated Motion Component for: brick-wall-fire
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brick-wall-fire (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brick-wall-fire {
...
@keyframes motion-ai-idle-brick-wall-fire {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brick-wall-fire 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brick-wall-fire 3s ease-in-out infinite alternate;
}
</style>