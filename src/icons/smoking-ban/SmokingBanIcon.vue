...
// AI Generated Motion Component for: smoking-ban
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for smoking-ban (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-smoking-ban {
...
@keyframes motion-ai-idle-smoking-ban {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-smoking-ban 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-smoking-ban 3s ease-in-out infinite alternate;
}
</style>