...
// AI Generated Motion Component for: table-export
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for table-export (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-table-export {
...
@keyframes motion-ai-idle-table-export {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-table-export 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-table-export 3s ease-in-out infinite alternate;
}
</style>