...
// AI Generated Motion Component for: zodiac-aries
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for zodiac-aries (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zodiac-aries {
...
@keyframes motion-ai-idle-zodiac-aries {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zodiac-aries 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zodiac-aries 3s ease-in-out infinite alternate;
}
</style>