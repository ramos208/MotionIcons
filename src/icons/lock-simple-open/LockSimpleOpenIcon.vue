...
// AI Generated Motion Component for: lock-simple-open
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for lock-simple-open (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lock-simple-open {
...
@keyframes motion-ai-idle-lock-simple-open {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lock-simple-open 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lock-simple-open 3s ease-in-out infinite alternate;
}
</style>