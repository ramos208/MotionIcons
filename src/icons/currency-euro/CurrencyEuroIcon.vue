...
// AI Generated Motion Component for: currency-euro
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-euro (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-euro {
...
@keyframes motion-ai-idle-currency-euro {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-euro 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-euro 3s ease-in-out infinite alternate;
}
</style>