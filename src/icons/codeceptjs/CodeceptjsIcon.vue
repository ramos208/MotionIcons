...
@keyframes motion-ai-codeceptjs {
...
@keyframes motion-ai-idle-codeceptjs {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-codeceptjs 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-codeceptjs 2s ease-in-out infinite alternate;
}
</style>