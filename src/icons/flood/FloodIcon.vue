...
// AI Generated Motion Component for: flood
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for flood (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-flood {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flood 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flood 3s ease-in-out infinite alternate;
}
</style>