...
// AI Generated Motion Component for: mediamarkt
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mediamarkt (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mediamarkt {
...
@keyframes motion-ai-idle-mediamarkt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mediamarkt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mediamarkt 3s ease-in-out infinite alternate;
}
</style>