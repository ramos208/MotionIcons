...
// AI Generated Motion Component for: plus-equal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for plus-equal (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-plus-equal {
...
@keyframes motion-ai-idle-plus-equal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-plus-equal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-plus-equal 3s ease-in-out infinite alternate;
}
</style>