...
// AI Generated Motion Component for: percentage-0
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for percentage-0 (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-percentage-0 {
...
@keyframes motion-ai-idle-percentage-0 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-percentage-0 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-percentage-0 3s ease-in-out infinite alternate;
}
</style>