<template>
  ...
  >
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 7v-2a2 2 0 0 1 2 -2h2"/><path d="M3 17v2a2 2 0 0 0 2 2h2"/><path d="M17 3h2a2 2 0 0 1 2 2v2"/><path d="M17 21h2a2 2 0 0 0 2 -2v-2"/><path d="M7 12v-3h3"/><path d="M14 9h3v3"/><path d="M7 9l4.414 4.414a2 2 0 0 1 .586 1.414v2.172"/><path d="M17 9l-4.414 4.414a2 2 0 0 0 -.586 1.414v2.172"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: route-scan
// Category: search
// Physics Presets: Dynamic kinetic adaptation for route-scan (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-route-scan {
...
@keyframes motion-ai-idle-route-scan {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-route-scan 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-route-scan 3s ease-in-out infinite alternate;
}
</style>