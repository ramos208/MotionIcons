...
// AI Generated Motion Component for: row-insert-top
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for row-insert-top (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-row-insert-top {
...
@keyframes motion-ai-idle-row-insert-top {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-row-insert-top 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-row-insert-top 3s ease-in-out infinite alternate;
}
</style>