<template>
  ...
  >
    ...
    >
      <path d="M8 16H16L16 8H8L8 16Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M13 11V16" stroke="currentColor" stroke-linecap="round"/><path d="M21 3.6V20.4C21 20.7314 20.7314 21 20.4 21H3.6C3.26863 21 3 20.7314 3 20.4V3.6C3 3.26863 3.26863 3 3.6 3H20.4C20.7314 3 21 3.26863 21 3.6Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: npm-square
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for npm-square (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-npm-square {
...
@keyframes motion-ai-idle-npm-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-npm-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-npm-square 3s ease-in-out infinite alternate;
}
</style>