...
// AI Generated Motion Component for: mangaupdates
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mangaupdates (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mangaupdates {
...
@keyframes motion-ai-idle-mangaupdates {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mangaupdates 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mangaupdates 3s ease-in-out infinite alternate;
}
</style>