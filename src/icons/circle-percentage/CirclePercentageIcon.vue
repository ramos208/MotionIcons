...
// AI Generated Motion Component for: circle-percentage
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circle-percentage (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circle-percentage {
...
@keyframes motion-ai-idle-circle-percentage {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circle-percentage 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circle-percentage 3s ease-in-out infinite alternate;
}
</style>