...
@keyframes motion-ai-message-favourite01 {
...
@keyframes motion-ai-idle-message-favourite01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-favourite01 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-favourite01 2.5s ease-in-out infinite alternate;
}
</style>