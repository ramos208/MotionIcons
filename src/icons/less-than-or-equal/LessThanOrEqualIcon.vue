...
// AI Generated Motion Component for: less-than-or-equal
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for less-than-or-equal (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-less-than-or-equal {
...
@keyframes motion-ai-idle-less-than-or-equal {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-less-than-or-equal 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-less-than-or-equal 3s ease-in-out infinite alternate;
}
</style>