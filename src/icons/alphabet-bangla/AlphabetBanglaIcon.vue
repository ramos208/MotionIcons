...
@keyframes motion-ai-alphabet-bangla {
...
@keyframes motion-ai-idle-alphabet-bangla {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-alphabet-bangla 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-alphabet-bangla 3s ease-in-out infinite alternate;
}
</style>