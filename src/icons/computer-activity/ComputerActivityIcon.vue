...
@keyframes motion-ai-computer-activity {
...
@keyframes motion-ai-idle-computer-activity {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-computer-activity 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-computer-activity 3s ease-in-out infinite alternate;
}
</style>