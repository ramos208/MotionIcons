...
// AI Generated Motion Component for: line-dashed
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for line-dashed (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-line-dashed {
...
@keyframes motion-ai-idle-line-dashed {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-line-dashed 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-line-dashed 3s ease-in-out infinite alternate;
}
</style>