...
// AI Generated Motion Component for: grin-squint
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for grin-squint (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-grin-squint {
...
@keyframes motion-ai-idle-grin-squint {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-grin-squint 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-grin-squint 3s ease-in-out infinite alternate;
}
</style>