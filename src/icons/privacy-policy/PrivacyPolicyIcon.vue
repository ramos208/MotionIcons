...
@keyframes motion-ai-privacy-policy {
...
@keyframes motion-ai-idle-privacy-policy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-privacy-policy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-privacy-policy 3s ease-in-out infinite alternate;
}
</style>