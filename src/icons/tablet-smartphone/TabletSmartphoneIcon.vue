...
// AI Generated Motion Component for: tablet-smartphone
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for tablet-smartphone (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-tablet-smartphone {
...
@keyframes motion-ai-idle-tablet-smartphone {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-tablet-smartphone 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-tablet-smartphone 3s ease-in-out infinite alternate;
}
</style>