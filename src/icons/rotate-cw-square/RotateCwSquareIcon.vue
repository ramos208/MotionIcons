...
@keyframes motion-ai-rotate-cw-square {
...
@keyframes motion-ai-idle-rotate-cw-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rotate-cw-square 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-rotate-cw-square 4s linear infinite alternate;
}
</style>