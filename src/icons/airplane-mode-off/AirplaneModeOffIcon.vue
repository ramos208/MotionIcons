...
@keyframes motion-ai-airplane-mode-off {
...
@keyframes motion-ai-idle-airplane-mode-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-airplane-mode-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-airplane-mode-off 2s ease-in-out infinite alternate;
}
</style>