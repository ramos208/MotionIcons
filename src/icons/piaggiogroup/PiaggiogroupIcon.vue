...
@keyframes motion-ai-piaggiogroup {
...
@keyframes motion-ai-idle-piaggiogroup {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-piaggiogroup 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-piaggiogroup 3s ease-in-out infinite alternate;
}
</style>