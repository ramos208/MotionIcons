...
// AI Generated Motion Component for: swipe-right03
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for swipe-right03 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-swipe-right03 {
...
@keyframes motion-ai-idle-swipe-right03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-swipe-right03 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-swipe-right03 3s ease-in-out infinite alternate;
}
</style>