...
// AI Generated Motion Component for: leaf-maple
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for leaf-maple (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-leaf-maple {
...
@keyframes motion-ai-idle-leaf-maple {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-leaf-maple 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-leaf-maple 3s ease-in-out infinite alternate;
}
</style>