...
// AI Generated Motion Component for: message-2-x
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-2-x (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-2-x {
...
@keyframes motion-ai-idle-message-2-x {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-2-x 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-2-x 2.5s ease-in-out infinite alternate;
}
</style>