...
// AI Generated Motion Component for: align-center-vertical-simple
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for align-center-vertical-simple (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-align-center-vertical-simple {
...
@keyframes motion-ai-idle-align-center-vertical-simple {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-align-center-vertical-simple 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-align-center-vertical-simple 3s ease-in-out infinite alternate;
}
</style>