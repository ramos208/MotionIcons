...
// AI Generated Motion Component for: litecoin-rotate-out
// Category: loading
// Physics Presets: Dynamic kinetic adaptation for litecoin-rotate-out (iconoir). Selected semantic motion: rotate with custom idle (gear-sync) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-litecoin-rotate-out {
...
@keyframes motion-ai-idle-litecoin-rotate-out {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-litecoin-rotate-out 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-litecoin-rotate-out 4s linear infinite alternate;
}
</style>