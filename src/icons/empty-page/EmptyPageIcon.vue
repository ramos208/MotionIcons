...
// AI Generated Motion Component for: empty-page
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for empty-page (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-empty-page {
...
@keyframes motion-ai-idle-empty-page {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-empty-page 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-empty-page 3s ease-in-out infinite alternate;
}
</style>