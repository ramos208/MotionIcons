...
// AI Generated Motion Component for: brand-windy
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for brand-windy (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-windy {
...
@keyframes motion-ai-idle-brand-windy {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-windy 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-windy 3s ease-in-out infinite alternate;
}
</style>