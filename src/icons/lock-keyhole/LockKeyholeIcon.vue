...
// AI Generated Motion Component for: lock-keyhole
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for lock-keyhole (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-lock-keyhole {
...
@keyframes motion-ai-idle-lock-keyhole {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-lock-keyhole 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-lock-keyhole 3s ease-in-out infinite alternate;
}
</style>