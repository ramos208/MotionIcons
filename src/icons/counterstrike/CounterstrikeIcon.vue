...
// AI Generated Motion Component for: counterstrike
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for counterstrike (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-counterstrike {
...
@keyframes motion-ai-idle-counterstrike {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-counterstrike 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-counterstrike 3s ease-in-out infinite alternate;
}
</style>