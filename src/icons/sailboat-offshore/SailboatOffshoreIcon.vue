...
@keyframes motion-ai-sailboat-offshore {
...
@keyframes motion-ai-idle-sailboat-offshore {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-sailboat-offshore 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-sailboat-offshore 2s ease-in-out infinite alternate;
}
</style>