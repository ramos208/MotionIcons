...
// AI Generated Motion Component for: rectangle-ellipsis
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for rectangle-ellipsis (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-rectangle-ellipsis {
...
@keyframes motion-ai-idle-rectangle-ellipsis {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rectangle-ellipsis 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-rectangle-ellipsis 3s ease-in-out infinite alternate;
}
</style>