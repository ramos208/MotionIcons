...
@keyframes motion-ai-dungeonsanddragons {
...
@keyframes motion-ai-idle-dungeonsanddragons {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-dungeonsanddragons 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-dungeonsanddragons 3s ease-in-out infinite alternate;
}
</style>