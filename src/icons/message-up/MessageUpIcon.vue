...
// AI Generated Motion Component for: message-up
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for message-up (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-message-up {
...
@keyframes motion-ai-idle-message-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-message-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-message-up 2.5s ease-in-out infinite alternate;
}
</style>