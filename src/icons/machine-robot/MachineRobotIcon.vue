<template>
  ...
  >
    ...
    >
      <path d="M17 13V8C17 5.23858 14.7614 3 12 3C9.23858 3 7 5.23858 7 8V13C7 14.8692 7 15.8038 7.40192 16.5C7.66523 16.9561 8.04394 17.3348 8.5 17.5981C9.19615 18 10.1308 18 12 18C13.8692 18 14.8038 18 15.5 17.5981C15.9561 17.3348 16.3348 16.9561 16.5981 16.5C17 15.8038 17 14.8692 17 13Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M18 21C18 19.8954 18.8954 19 20 19C21.1046 19 22 19.8954 22 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M2 21C2 19.8954 2.89543 19 4 19C5.10457 19 6 19.8954 6 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M10.125 7.25H10M10.25 7.25C10.25 7.38807 10.1381 7.5 10 7.5C9.86193 7.5 9.75 7.38807 9.75 7.25C9.75 7.11193 9.86193 7 10 7C10.1381 7 10.25 7.11193 10.25 7.25Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M14.125 7.25H14M14.25 7.25C14.25 7.38807 14.1381 7.5 14 7.5C13.8619 7.5 13.75 7.38807 13.75 7.25C13.75 7.11193 13.8619 7 14 7C14.1381 7 14.25 7.11193 14.25 7.25Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M20 19V15C20 13.1144 20 12.1716 19.4142 11.5858C18.8284 11 17.8856 11 16 11H8C6.11438 11 5.17157 11 4.58579 11.5858C4 12.1716 4 13.1144 4 15V19" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: machine-robot
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for machine-robot (hugeicons). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-machine-robot {
...
@keyframes motion-ai-idle-machine-robot {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-machine-robot 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-machine-robot 2s ease-in-out infinite alternate;
}
</style>