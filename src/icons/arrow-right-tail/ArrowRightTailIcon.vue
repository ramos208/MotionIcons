...
// AI Generated Motion Component for: arrow-right-tail
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-right-tail (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-right-tail {
...
@keyframes motion-ai-idle-arrow-right-tail {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-right-tail 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-right-tail 3s ease-in-out infinite alternate;
}
</style>