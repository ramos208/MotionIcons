...
// AI Generated Motion Component for: brand-booking
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-booking (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-booking {
...
@keyframes motion-ai-idle-brand-booking {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-booking 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-booking 3s ease-in-out infinite alternate;
}
</style>