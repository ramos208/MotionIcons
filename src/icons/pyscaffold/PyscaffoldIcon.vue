...
@keyframes motion-ai-pyscaffold {
...
@keyframes motion-ai-idle-pyscaffold {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pyscaffold 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pyscaffold 3s ease-in-out infinite alternate;
}
</style>