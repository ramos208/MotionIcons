<template>
  ...
  >
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M20.83 16.809c.11 -.248 .17 -.52 .17 -.801v-8.018a1.98 1.98 0 0 0 -1 -1.717l-7 -4.008a2.016 2.016 0 0 0 -2 0l-3.012 1.725m-2.547 1.458l-1.441 .825c-.619 .355 -1 1.01 -1 1.718v8.018c0 .709 .381 1.363 1 1.717l7 4.008a2.016 2.016 0 0 0 2 0l5.544 -3.174"/><path d="M12 22v-10"/><path d="M14.532 10.538l6.198 -3.578"/><path d="M3.27 6.96l8.73 5.04"/><path d="M3 3l18 18"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: cube-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for cube-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-cube-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cube-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cube-off 3s ease-in-out infinite alternate;
}
</style>