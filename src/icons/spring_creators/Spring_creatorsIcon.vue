...
// AI Generated Motion Component for: spring_creators
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for spring_creators (simpleicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-spring_creators {
...
@keyframes motion-ai-idle-spring_creators {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-spring_creators 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-spring_creators 2.5s ease-in-out infinite alternate;
}
</style>