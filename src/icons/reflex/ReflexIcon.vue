...
// AI Generated Motion Component for: reflex
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for reflex (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-reflex {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-reflex 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-reflex 3s ease-in-out infinite alternate;
}
</style>