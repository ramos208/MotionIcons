...
// AI Generated Motion Component for: brand-ctemplar
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-ctemplar (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-ctemplar {
...
@keyframes motion-ai-idle-brand-ctemplar {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-ctemplar 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-ctemplar 3s ease-in-out infinite alternate;
}
</style>