...
// AI Generated Motion Component for: monitor-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for monitor-off (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-monitor-off {
...
@keyframes motion-ai-idle-monitor-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-monitor-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-monitor-off 3s ease-in-out infinite alternate;
}
</style>