...
@keyframes motion-ai-receipt-euro {
...
@keyframes motion-ai-idle-receipt-euro {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-euro 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-euro 3s ease-in-out infinite alternate;
}
</style>