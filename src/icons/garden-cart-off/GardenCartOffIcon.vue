...
// AI Generated Motion Component for: garden-cart-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for garden-cart-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-garden-cart-off {
...
@keyframes motion-ai-idle-garden-cart-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-garden-cart-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-garden-cart-off 3s ease-in-out infinite alternate;
}
</style>