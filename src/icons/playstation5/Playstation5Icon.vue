...
// AI Generated Motion Component for: playstation5
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for playstation5 (simpleicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-playstation5 {
...
@keyframes motion-ai-idle-playstation5 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-playstation5 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-playstation5 3s ease-in-out infinite alternate;
}
</style>