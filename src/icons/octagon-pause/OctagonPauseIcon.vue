...
// AI Generated Motion Component for: octagon-pause
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for octagon-pause (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-octagon-pause {
...
@keyframes motion-ai-idle-octagon-pause {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-octagon-pause 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-octagon-pause 3s ease-in-out infinite alternate;
}
</style>