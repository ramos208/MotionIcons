...
@keyframes motion-ai-spaghetti-monster-flying {
...
@keyframes motion-ai-idle-spaghetti-monster-flying {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-spaghetti-monster-flying 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-spaghetti-monster-flying 3s ease-in-out infinite alternate;
}
</style>