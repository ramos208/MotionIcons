...
// AI Generated Motion Component for: cell-signal-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for cell-signal-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cell-signal-off {
...
@keyframes motion-ai-idle-cell-signal-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cell-signal-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cell-signal-off 3s ease-in-out infinite alternate;
}
</style>