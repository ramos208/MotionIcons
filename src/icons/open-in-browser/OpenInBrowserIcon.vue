...
// AI Generated Motion Component for: open-in-browser
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for open-in-browser (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-open-in-browser {
...
@keyframes motion-ai-idle-open-in-browser {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-open-in-browser 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-open-in-browser 3s ease-in-out infinite alternate;
}
</style>