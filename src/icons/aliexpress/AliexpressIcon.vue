...
@keyframes motion-ai-aliexpress {
...
@keyframes motion-ai-idle-aliexpress {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-aliexpress 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-aliexpress 3s ease-in-out infinite alternate;
}
</style>