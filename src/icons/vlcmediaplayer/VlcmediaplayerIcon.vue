...
// AI Generated Motion Component for: vlcmediaplayer
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for vlcmediaplayer (simpleicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-vlcmediaplayer {
...
@keyframes motion-ai-idle-vlcmediaplayer {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-vlcmediaplayer 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-vlcmediaplayer 3s ease-in-out infinite alternate;
}
</style>