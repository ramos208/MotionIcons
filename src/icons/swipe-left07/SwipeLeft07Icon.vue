...
// AI Generated Motion Component for: swipe-left07
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for swipe-left07 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-swipe-left07 {
...
@keyframes motion-ai-idle-swipe-left07 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-swipe-left07 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-swipe-left07 3s ease-in-out infinite alternate;
}
</style>