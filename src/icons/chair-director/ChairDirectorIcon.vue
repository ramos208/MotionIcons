...
// AI Generated Motion Component for: chair-director
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for chair-director (tabler). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chair-director {
...
@keyframes motion-ai-idle-chair-director {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chair-director 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-chair-director 2s ease-in-out infinite alternate;
}
</style>