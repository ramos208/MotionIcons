<template>
  ...
  >
    ...
    >
      <path d="M15 2L21 8M21 2L15 8" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><path d="M12 5H8.5C6.567 5 5 6.567 5 8.5C5 10.433 6.567 12 8.5 12H15.5C17.433 12 19 13.567 19 15.5C19 17.433 17.433 19 15.5 19H12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: route-block
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for route-block (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-route-block {
...
@keyframes motion-ai-idle-route-block {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-route-block 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-route-block 3s ease-in-out infinite alternate;
}
</style>