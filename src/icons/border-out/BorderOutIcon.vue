...
@keyframes motion-ai-border-out {
...
@keyframes motion-ai-idle-border-out {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-border-out 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-border-out 3s ease-in-out infinite alternate;
}
</style>