...
// AI Generated Motion Component for: tacobell
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for tacobell (simpleicons). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-tacobell {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-tacobell 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-tacobell 2.5s ease-in-out infinite alternate;
}
</style>