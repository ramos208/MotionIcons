...
@keyframes motion-ai-minus-square-dashed {
...
@keyframes motion-ai-idle-minus-square-dashed {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-minus-square-dashed 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-minus-square-dashed 3s ease-in-out infinite alternate;
}
</style>