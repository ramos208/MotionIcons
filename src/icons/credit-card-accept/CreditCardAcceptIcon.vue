...
// AI Generated Motion Component for: credit-card-accept
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for credit-card-accept (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-credit-card-accept {
...
@keyframes motion-ai-idle-credit-card-accept {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-credit-card-accept 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-credit-card-accept 3s ease-in-out infinite alternate;
}
</style>