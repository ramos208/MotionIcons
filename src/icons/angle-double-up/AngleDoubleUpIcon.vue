...
// AI Generated Motion Component for: angle-double-up
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for angle-double-up (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-angle-double-up {
...
@keyframes motion-ai-idle-angle-double-up {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-angle-double-up 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-angle-double-up 3s ease-in-out infinite alternate;
}
</style>