...
// AI Generated Motion Component for: coupon03
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for coupon03 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-coupon03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-coupon03 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-coupon03 3s ease-in-out infinite alternate;
}
</style>