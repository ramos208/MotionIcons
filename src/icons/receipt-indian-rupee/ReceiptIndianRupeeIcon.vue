...
@keyframes motion-ai-receipt-indian-rupee {
...
@keyframes motion-ai-idle-receipt-indian-rupee {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-indian-rupee 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-indian-rupee 3s ease-in-out infinite alternate;
}
</style>