...
// AI Generated Motion Component for: radio-button
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for radio-button (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-radio-button {
...
@keyframes motion-ai-idle-radio-button {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-radio-button 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-radio-button 3s ease-in-out infinite alternate;
}
</style>