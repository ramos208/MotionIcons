...
@keyframes motion-ai-more-vert-circle {
...
@keyframes motion-ai-idle-more-vert-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-more-vert-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-more-vert-circle 3s ease-in-out infinite alternate;
}
</style>