...
@keyframes motion-ai-call-incoming03 {
...
@keyframes motion-ai-idle-call-incoming03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-call-incoming03 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-call-incoming03 3s ease-in-out infinite alternate;
}
</style>