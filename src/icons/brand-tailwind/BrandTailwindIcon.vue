...
// AI Generated Motion Component for: brand-tailwind
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for brand-tailwind (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-tailwind {
...
@keyframes motion-ai-idle-brand-tailwind {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-tailwind 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-tailwind 3s ease-in-out infinite alternate;
}
</style>