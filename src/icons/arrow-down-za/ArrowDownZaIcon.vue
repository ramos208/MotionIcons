...
@keyframes motion-ai-arrow-down-za {
...
@keyframes motion-ai-idle-arrow-down-za {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-down-za 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-down-za 3s ease-in-out infinite alternate;
}
</style>