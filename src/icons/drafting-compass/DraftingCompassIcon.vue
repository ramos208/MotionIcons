...
// AI Generated Motion Component for: drafting-compass
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for drafting-compass (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-drafting-compass {
...
@keyframes motion-ai-idle-drafting-compass {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-drafting-compass 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-drafting-compass 3s ease-in-out infinite alternate;
}
</style>