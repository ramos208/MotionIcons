...
@keyframes motion-ai-camera-automatically02 {
...
@keyframes motion-ai-idle-camera-automatically02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-camera-automatically02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-camera-automatically02 3s ease-in-out infinite alternate;
}
</style>