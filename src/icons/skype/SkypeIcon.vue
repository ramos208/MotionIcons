...
@keyframes motion-ai-idle-skype {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-skype 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-skype 3s ease-in-out infinite alternate;
}
</style>