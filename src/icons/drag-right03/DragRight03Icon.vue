...
@keyframes motion-ai-drag-right03 {
...
@keyframes motion-ai-idle-drag-right03 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-drag-right03 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-drag-right03 3s ease-in-out infinite alternate;
}
</style>