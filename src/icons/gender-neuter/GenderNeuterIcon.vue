...
// AI Generated Motion Component for: gender-neuter
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for gender-neuter (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-gender-neuter {
...
@keyframes motion-ai-idle-gender-neuter {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-gender-neuter 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-gender-neuter 3s ease-in-out infinite alternate;
}
</style>