...
@keyframes motion-ai-brand-yarn {
...
@keyframes motion-ai-idle-brand-yarn {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-yarn 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-yarn 3s ease-in-out infinite alternate;
}
</style>