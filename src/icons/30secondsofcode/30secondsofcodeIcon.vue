...
// AI Generated Motion Component for: 30secondsofcode
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for 30secondsofcode (simpleicons). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-30secondsofcode {
...
@keyframes motion-ai-idle-30secondsofcode {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-30secondsofcode 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-30secondsofcode 2s ease-in-out infinite alternate;
}
</style>