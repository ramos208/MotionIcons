...
// AI Generated Motion Component for: film-strip
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for film-strip (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-film-strip {
...
@keyframes motion-ai-idle-film-strip {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-film-strip 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-film-strip 3s ease-in-out infinite alternate;
}
</style>