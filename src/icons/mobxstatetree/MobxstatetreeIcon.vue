...
// AI Generated Motion Component for: mobxstatetree
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for mobxstatetree (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-mobxstatetree {
...
@keyframes motion-ai-idle-mobxstatetree {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-mobxstatetree 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-mobxstatetree 3s ease-in-out infinite alternate;
}
</style>