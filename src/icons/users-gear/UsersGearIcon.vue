...
@keyframes motion-ai-users-gear {
...
@keyframes motion-ai-idle-users-gear {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-users-gear 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-users-gear 3s ease-in-out infinite alternate;
}
</style>