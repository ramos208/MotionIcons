...
// AI Generated Motion Component for: open-ai-logo
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for open-ai-logo (phosphor). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-open-ai-logo {
...
@keyframes motion-ai-idle-open-ai-logo {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-open-ai-logo 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-open-ai-logo 2s ease-in-out infinite alternate;
}
</style>