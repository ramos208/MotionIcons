...
// AI Generated Motion Component for: backendless
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for backendless (simpleicons). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-backendless {
...
@keyframes motion-ai-idle-backendless {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-backendless 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-backendless 3s ease-in-out infinite alternate;
}
</style>