...
// AI Generated Motion Component for: arrow-right-from-bracket
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-right-from-bracket (fontawesome). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-right-from-bracket {
...
@keyframes motion-ai-idle-arrow-right-from-bracket {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-right-from-bracket 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-right-from-bracket 3s ease-in-out infinite alternate;
}
</style>