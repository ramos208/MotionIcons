...
@keyframes motion-ai-maps-editing {
...
@keyframes motion-ai-idle-maps-editing {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-maps-editing 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-maps-editing 3s ease-in-out infinite alternate;
}
</style>