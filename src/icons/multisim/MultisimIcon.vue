...
@keyframes motion-ai-idle-multisim {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-multisim 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-multisim 3s ease-in-out infinite alternate;
}
</style>