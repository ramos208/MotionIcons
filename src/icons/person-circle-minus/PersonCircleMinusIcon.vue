...
@keyframes motion-ai-person-circle-minus {
...
@keyframes motion-ai-idle-person-circle-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-person-circle-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-person-circle-minus 3s ease-in-out infinite alternate;
}
</style>