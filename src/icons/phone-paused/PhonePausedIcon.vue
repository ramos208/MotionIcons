<template>
  ...
  >
    ...
    >
      <path d="M18 2L18 7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M22 2L22 7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M18.1182 14.702L14 15.5C11.2183 14.1038 9.5 12.5 8.5 10L9.26995 5.8699L7.81452 2L4.0636 2C2.93605 2 2.04814 2.93178 2.21654 4.04668C2.63695 6.83 3.87653 11.8765 7.5 15.5C11.3052 19.3052 16.7857 20.9564 19.802 21.6127C20.9668 21.8662 22 20.9575 22 19.7655L22 16.1812L18.1182 14.702Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: phone-paused
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for phone-paused (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-phone-paused {
...
@keyframes motion-ai-idle-phone-paused {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-phone-paused 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-phone-paused 3s ease-in-out infinite alternate;
}
</style>