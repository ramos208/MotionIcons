...
// AI Generated Motion Component for: highlighter-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for highlighter-circle (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-highlighter-circle {
...
@keyframes motion-ai-idle-highlighter-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-highlighter-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-highlighter-circle 3s ease-in-out infinite alternate;
}
</style>