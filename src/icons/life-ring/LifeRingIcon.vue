...
@keyframes motion-ai-idle-life-ring {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-life-ring 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-life-ring 2.5s ease-in-out infinite alternate;
}
</style>