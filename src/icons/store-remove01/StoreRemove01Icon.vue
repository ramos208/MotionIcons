...
@keyframes motion-ai-store-remove01 {
...
@keyframes motion-ai-idle-store-remove01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-store-remove01 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-store-remove01 3s ease-in-out infinite alternate;
}
</style>