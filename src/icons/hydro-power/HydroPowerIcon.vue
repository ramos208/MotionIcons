...
@keyframes motion-ai-hydro-power {
...
@keyframes motion-ai-idle-hydro-power {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hydro-power 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hydro-power 3s ease-in-out infinite alternate;
}
</style>