...
// AI Generated Motion Component for: devices-share
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for devices-share (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-devices-share {
...
@keyframes motion-ai-idle-devices-share {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-devices-share 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-devices-share 3s ease-in-out infinite alternate;
}
</style>