...
// AI Generated Motion Component for: device-ipad-horizontal-minus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for device-ipad-horizontal-minus (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-device-ipad-horizontal-minus {
...
@keyframes motion-ai-idle-device-ipad-horizontal-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-device-ipad-horizontal-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-device-ipad-horizontal-minus 3s ease-in-out infinite alternate;
}
</style>