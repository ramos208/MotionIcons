...
// AI Generated Motion Component for: hand-cash
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hand-cash (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-hand-cash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hand-cash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hand-cash 3s ease-in-out infinite alternate;
}
</style>