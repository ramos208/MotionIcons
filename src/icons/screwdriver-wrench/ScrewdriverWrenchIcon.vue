...
// AI Generated Motion Component for: screwdriver-wrench
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for screwdriver-wrench (fontawesome). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-screwdriver-wrench {
...
@keyframes motion-ai-idle-screwdriver-wrench {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-screwdriver-wrench 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-screwdriver-wrench 3s ease-in-out infinite alternate;
}
</style>