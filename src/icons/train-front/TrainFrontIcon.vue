...
// AI Generated Motion Component for: train-front
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for train-front (lucide). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-train-front {
...
@keyframes motion-ai-idle-train-front {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-train-front 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-train-front 3s ease-in-out infinite alternate;
}
</style>