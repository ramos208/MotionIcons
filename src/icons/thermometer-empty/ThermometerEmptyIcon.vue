...
// AI Generated Motion Component for: thermometer-empty
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for thermometer-empty (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-thermometer-empty {
...
@keyframes motion-ai-idle-thermometer-empty {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-thermometer-empty 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-thermometer-empty 3s ease-in-out infinite alternate;
}
</style>