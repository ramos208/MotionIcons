...
@keyframes motion-ai-border-vertical {
...
@keyframes motion-ai-idle-border-vertical {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-border-vertical 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-border-vertical 3s ease-in-out infinite alternate;
}
</style>