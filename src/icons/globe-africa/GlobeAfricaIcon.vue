...
// AI Generated Motion Component for: globe-africa
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for globe-africa (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-globe-africa {
...
@keyframes motion-ai-idle-globe-africa {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-globe-africa 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-globe-africa 3s ease-in-out infinite alternate;
}
</style>