...
// AI Generated Motion Component for: adjustments-down
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for adjustments-down (tabler). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-adjustments-down {
...
@keyframes motion-ai-idle-adjustments-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-adjustments-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-adjustments-down 3s ease-in-out infinite alternate;
}
</style>