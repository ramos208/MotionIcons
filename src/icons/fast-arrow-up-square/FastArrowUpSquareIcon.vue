<template>
  ...
  >
    ...
    >
      <path d="M15.5 16.5L12 13L8.5 16.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.5 10.5L12 7L8.5 10.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 20.4V3.6C3 3.26863 3.26863 3 3.6 3H20.4C20.7314 3 21 3.26863 21 3.6V20.4C21 20.7314 20.7314 21 20.4 21H3.6C3.26863 21 3 20.7314 3 20.4Z" stroke="currentColor" stroke-width="1.5"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: fast-arrow-up-square
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for fast-arrow-up-square (iconoir). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-fast-arrow-up-square {
...
@keyframes motion-ai-idle-fast-arrow-up-square {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-fast-arrow-up-square 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-fast-arrow-up-square 3s ease-in-out infinite alternate;
}
</style>