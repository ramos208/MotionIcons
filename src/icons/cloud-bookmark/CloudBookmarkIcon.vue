<template>
  ...
  >
    ...
    >
      <path d="M8.5 12H15.5V22L12 20L8.5 22V12Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M20 17.6073C21.4937 17.0221 23 15.6889 23 13C23 9 19.6667 8 18 8C18 6 18 2 12 2C6 2 6 6 6 8C4.33333 8 1 9 1 13C1 15.6889 2.50628 17.0221 4 17.6073" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: cloud-bookmark
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for cloud-bookmark (iconoir). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-cloud-bookmark {
...
@keyframes motion-ai-idle-cloud-bookmark {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cloud-bookmark 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cloud-bookmark 3s ease-in-out infinite alternate;
}
</style>