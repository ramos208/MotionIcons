...
// AI Generated Motion Component for: bars-staggered
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for bars-staggered (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-bars-staggered {
...
@keyframes motion-ai-idle-bars-staggered {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bars-staggered 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-bars-staggered 3s ease-in-out infinite alternate;
}
</style>