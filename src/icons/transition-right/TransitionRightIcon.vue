...
@keyframes motion-ai-transition-right {
...
@keyframes motion-ai-idle-transition-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-transition-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-transition-right 3s ease-in-out infinite alternate;
}
</style>