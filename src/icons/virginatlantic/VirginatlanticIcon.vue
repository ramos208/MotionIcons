...
// AI Generated Motion Component for: virginatlantic
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for virginatlantic (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-virginatlantic {
...
@keyframes motion-ai-idle-virginatlantic {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-virginatlantic 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-virginatlantic 3s ease-in-out infinite alternate;
}
</style>