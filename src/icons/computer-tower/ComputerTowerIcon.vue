...
// AI Generated Motion Component for: computer-tower
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for computer-tower (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-computer-tower {
...
@keyframes motion-ai-idle-computer-tower {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-computer-tower 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-computer-tower 3s ease-in-out infinite alternate;
}
</style>