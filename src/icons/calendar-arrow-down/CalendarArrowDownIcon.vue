<template>
  ...
  >
    ...
    >
      <path d="M13 21H5C3.89543 21 3 20.1046 3 19V10H21V13M15 4V2M15 4V6M15 4H10.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 10V6C3 4.89543 3.89543 4 5 4H7" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 2V6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 10V6C21 4.89543 20.1046 4 19 4H18.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M19 16V22M19 22L22 19M19 22L16 19" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: calendar-arrow-down
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for calendar-arrow-down (iconoir). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-calendar-arrow-down {
...
@keyframes motion-ai-idle-calendar-arrow-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-calendar-arrow-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-calendar-arrow-down 3s ease-in-out infinite alternate;
}
</style>