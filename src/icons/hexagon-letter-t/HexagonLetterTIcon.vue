...
// AI Generated Motion Component for: hexagon-letter-t
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for hexagon-letter-t (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-hexagon-letter-t {
...
@keyframes motion-ai-idle-hexagon-letter-t {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-hexagon-letter-t 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-hexagon-letter-t 3s ease-in-out infinite alternate;
}
</style>