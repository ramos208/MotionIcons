...
// AI Generated Motion Component for: zigbee2mqtt
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for zigbee2mqtt (simpleicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-zigbee2mqtt {
...
@keyframes motion-ai-idle-zigbee2mqtt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-zigbee2mqtt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-zigbee2mqtt 3s ease-in-out infinite alternate;
}
</style>