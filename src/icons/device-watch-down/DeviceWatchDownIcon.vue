...
// AI Generated Motion Component for: device-watch-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for device-watch-down (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-device-watch-down {
...
@keyframes motion-ai-idle-device-watch-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-device-watch-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-device-watch-down 3s ease-in-out infinite alternate;
}
</style>