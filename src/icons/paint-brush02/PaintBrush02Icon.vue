...
@keyframes motion-ai-paint-brush02 {
...
@keyframes motion-ai-idle-paint-brush02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-paint-brush02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-paint-brush02 2s ease-in-out infinite alternate;
}
</style>