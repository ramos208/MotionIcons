...
// AI Generated Motion Component for: transfer-out
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for transfer-out (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-transfer-out {
...
@keyframes motion-ai-idle-transfer-out {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-transfer-out 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-transfer-out 3s ease-in-out infinite alternate;
}
</style>