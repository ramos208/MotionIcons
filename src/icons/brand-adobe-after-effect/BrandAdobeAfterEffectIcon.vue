...
// AI Generated Motion Component for: brand-adobe-after-effect
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for brand-adobe-after-effect (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-brand-adobe-after-effect {
...
@keyframes motion-ai-idle-brand-adobe-after-effect {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-brand-adobe-after-effect 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-brand-adobe-after-effect 3s ease-in-out infinite alternate;
}
</style>