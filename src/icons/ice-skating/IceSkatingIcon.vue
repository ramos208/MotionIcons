...
@keyframes motion-ai-ice-skating {
...
@keyframes motion-ai-idle-ice-skating {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ice-skating 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ice-skating 3s ease-in-out infinite alternate;
}
</style>