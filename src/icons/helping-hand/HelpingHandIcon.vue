...
// AI Generated Motion Component for: helping-hand
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for helping-hand (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-helping-hand {
...
@keyframes motion-ai-idle-helping-hand {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-helping-hand 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-helping-hand 3s ease-in-out infinite alternate;
}
</style>