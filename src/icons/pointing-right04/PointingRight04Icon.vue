...
@keyframes motion-ai-pointing-right04 {
...
@keyframes motion-ai-idle-pointing-right04 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pointing-right04 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pointing-right04 3s ease-in-out infinite alternate;
}
</style>