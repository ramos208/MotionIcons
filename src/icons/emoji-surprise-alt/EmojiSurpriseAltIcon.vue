...
// AI Generated Motion Component for: emoji-surprise-alt
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for emoji-surprise-alt (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-emoji-surprise-alt {
...
@keyframes motion-ai-idle-emoji-surprise-alt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-emoji-surprise-alt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-emoji-surprise-alt 3s ease-in-out infinite alternate;
}
</style>