...
@keyframes motion-ai-receipt-turkish-lira {
...
@keyframes motion-ai-idle-receipt-turkish-lira {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-receipt-turkish-lira 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-receipt-turkish-lira 3s ease-in-out infinite alternate;
}
</style>