...
@keyframes motion-ai-no-internet {
...
@keyframes motion-ai-idle-no-internet {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-no-internet 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-no-internet 3s ease-in-out infinite alternate;
}
</style>