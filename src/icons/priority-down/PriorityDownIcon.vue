...
// AI Generated Motion Component for: priority-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for priority-down (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-priority-down {
...
@keyframes motion-ai-idle-priority-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-priority-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-priority-down 3s ease-in-out infinite alternate;
}
</style>