...
@keyframes motion-ai-file-chart-column {
...
@keyframes motion-ai-idle-file-chart-column {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-chart-column 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-chart-column 3s ease-in-out infinite alternate;
}
</style>