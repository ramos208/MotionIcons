...
// AI Generated Motion Component for: power-circle
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for power-circle (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-power-circle {
...
@keyframes motion-ai-idle-power-circle {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-power-circle 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-power-circle 3s ease-in-out infinite alternate;
}
</style>