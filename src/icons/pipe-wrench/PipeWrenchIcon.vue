...
// AI Generated Motion Component for: pipe-wrench
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for pipe-wrench (phosphor). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pipe-wrench {
...
@keyframes motion-ai-idle-pipe-wrench {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pipe-wrench 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pipe-wrench 3s ease-in-out infinite alternate;
}
</style>