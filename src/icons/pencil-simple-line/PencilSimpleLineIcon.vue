...
// AI Generated Motion Component for: pencil-simple-line
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for pencil-simple-line (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pencil-simple-line {
...
@keyframes motion-ai-idle-pencil-simple-line {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pencil-simple-line 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pencil-simple-line 3s ease-in-out infinite alternate;
}
</style>