...
// AI Generated Motion Component for: database-exclamation
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for database-exclamation (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-database-exclamation {
...
@keyframes motion-ai-idle-database-exclamation {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-database-exclamation 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-database-exclamation 3s ease-in-out infinite alternate;
}
</style>