...
// AI Generated Motion Component for: gas-station-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for gas-station-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-gas-station-off {
...
@keyframes motion-ai-idle-gas-station-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-gas-station-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-gas-station-off 3s ease-in-out infinite alternate;
}
</style>