...
@keyframes motion-ai-truck-droplet {
...
@keyframes motion-ai-idle-truck-droplet {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-truck-droplet 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-truck-droplet 3s ease-in-out infinite alternate;
}
</style>