...
// AI Generated Motion Component for: praying-hands
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for praying-hands (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-praying-hands {
...
@keyframes motion-ai-idle-praying-hands {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-praying-hands 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-praying-hands 3s ease-in-out infinite alternate;
}
</style>