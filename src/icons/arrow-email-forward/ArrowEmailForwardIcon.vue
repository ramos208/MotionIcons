...
// AI Generated Motion Component for: arrow-email-forward
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for arrow-email-forward (iconoir). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-email-forward {
...
@keyframes motion-ai-idle-arrow-email-forward {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-email-forward 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-arrow-email-forward 2.5s ease-in-out infinite alternate;
}
</style>