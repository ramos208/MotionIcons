<template>
  ...
  >
    ...
    >
      <path d="M19 17V7M19 17H13.6C13.2686 17 13 16.7314 13 16.4V7.6C13 7.26863 13.2686 7 13.6 7H19M19 17V20M19 7V4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 17V7M9 17H5.6C5.26863 17 5 16.7314 5 16.4V7.6C5 7.26863 5.26863 7 5.6 7H9M9 17V20M9 7V4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  </div>
</template>

<script setup lang="ts">
// AI Generated Motion Component for: horiz-distribution-left
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for horiz-distribution-left (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-horiz-distribution-left {
...
@keyframes motion-ai-idle-horiz-distribution-left {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-horiz-distribution-left 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-horiz-distribution-left 3s ease-in-out infinite alternate;
}
</style>