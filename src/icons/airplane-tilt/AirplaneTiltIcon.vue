...
// AI Generated Motion Component for: airplane-tilt
// Category: ai
// Physics Presets: Dynamic kinetic adaptation for airplane-tilt (phosphor). Selected semantic motion: neural-pulse with custom idle (neural-pulse) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-airplane-tilt {
...
@keyframes motion-ai-idle-airplane-tilt {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-airplane-tilt 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-airplane-tilt 2s ease-in-out infinite alternate;
}
</style>