...
// AI Generated Motion Component for: wave-sawtooth
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for wave-sawtooth (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-wave-sawtooth {
...
@keyframes motion-ai-idle-wave-sawtooth {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wave-sawtooth 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wave-sawtooth 3s ease-in-out infinite alternate;
}
</style>