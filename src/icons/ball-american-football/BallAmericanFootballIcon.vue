...
// AI Generated Motion Component for: ball-american-football
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for ball-american-football (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-ball-american-football {
...
@keyframes motion-ai-idle-ball-american-football {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-ball-american-football 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-ball-american-football 3s ease-in-out infinite alternate;
}
</style>