...
@keyframes motion-ai-cog-8-tooth {
...
@keyframes motion-ai-idle-cog-8-tooth {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-cog-8-tooth 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-cog-8-tooth 3s ease-in-out infinite alternate;
}
</style>