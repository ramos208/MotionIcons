...
// AI Generated Motion Component for: panel-right-close
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for panel-right-close (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-panel-right-close {
...
@keyframes motion-ai-idle-panel-right-close {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-panel-right-close 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-panel-right-close 3s ease-in-out infinite alternate;
}
</style>