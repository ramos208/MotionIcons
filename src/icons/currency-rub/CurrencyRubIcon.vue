...
// AI Generated Motion Component for: currency-rub
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for currency-rub (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-currency-rub {
...
@keyframes motion-ai-idle-currency-rub {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-currency-rub 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-currency-rub 3s ease-in-out infinite alternate;
}
</style>