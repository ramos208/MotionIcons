...
// AI Generated Motion Component for: arrow-left-tail
// Category: directional
// Physics Presets: Dynamic kinetic adaptation for arrow-left-tail (tabler). Selected semantic motion: kinetic-trail with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-arrow-left-tail {
...
@keyframes motion-ai-idle-arrow-left-tail {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-arrow-left-tail 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-arrow-left-tail 3s ease-in-out infinite alternate;
}
</style>