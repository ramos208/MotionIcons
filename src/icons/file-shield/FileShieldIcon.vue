...
// AI Generated Motion Component for: file-shield
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for file-shield (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-file-shield {
...
@keyframes motion-ai-idle-file-shield {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-shield 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-shield 3s ease-in-out infinite alternate;
}
</style>