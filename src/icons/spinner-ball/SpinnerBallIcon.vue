...
// AI Generated Motion Component for: spinner-ball
// Category: loading
// Physics Presets: Dynamic kinetic adaptation for spinner-ball (phosphor). Selected semantic motion: rotate with custom idle (gear-sync) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-spinner-ball {
...
@keyframes motion-ai-idle-spinner-ball {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-spinner-ball 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-spinner-ball 4s linear infinite alternate;
}
</style>