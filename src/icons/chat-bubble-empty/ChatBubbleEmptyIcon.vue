...
// AI Generated Motion Component for: chat-bubble-empty
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for chat-bubble-empty (iconoir). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-chat-bubble-empty {
...
@keyframes motion-ai-idle-chat-bubble-empty {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chat-bubble-empty 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-chat-bubble-empty 2.5s ease-in-out infinite alternate;
}
</style>