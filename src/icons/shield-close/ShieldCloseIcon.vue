...
// AI Generated Motion Component for: shield-close
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for shield-close (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-shield-close {
...
@keyframes motion-ai-idle-shield-close {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shield-close 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-shield-close 3s ease-in-out infinite alternate;
}
</style>