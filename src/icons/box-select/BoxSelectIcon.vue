...
// AI Generated Motion Component for: box-select
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for box-select (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-box-select {
...
@keyframes motion-ai-idle-box-select {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-box-select 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-box-select 3s ease-in-out infinite alternate;
}
</style>