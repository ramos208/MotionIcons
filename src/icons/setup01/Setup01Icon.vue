...
// AI Generated Motion Component for: setup01
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for setup01 (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-idle-setup01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-setup01 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-setup01 3s ease-in-out infinite alternate;
}
</style>