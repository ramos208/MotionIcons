...
@keyframes motion-ai-maps-search {
...
@keyframes motion-ai-idle-maps-search {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-maps-search 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-maps-search 3s ease-in-out infinite alternate;
}
</style>