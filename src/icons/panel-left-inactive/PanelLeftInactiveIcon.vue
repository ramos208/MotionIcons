...
// AI Generated Motion Component for: panel-left-inactive
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for panel-left-inactive (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-panel-left-inactive {
...
@keyframes motion-ai-idle-panel-left-inactive {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-panel-left-inactive 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-panel-left-inactive 3s ease-in-out infinite alternate;
}
</style>