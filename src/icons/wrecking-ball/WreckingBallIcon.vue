...
// AI Generated Motion Component for: wrecking-ball
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for wrecking-ball (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-wrecking-ball {
...
@keyframes motion-ai-idle-wrecking-ball {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-wrecking-ball 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-wrecking-ball 3s ease-in-out infinite alternate;
}
</style>