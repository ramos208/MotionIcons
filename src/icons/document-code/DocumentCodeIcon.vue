...
@keyframes motion-ai-document-code {
...
@keyframes motion-ai-idle-document-code {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-document-code 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-document-code 2s ease-in-out infinite alternate;
}
</style>