...
@keyframes motion-ai-aircraft-game {
...
@keyframes motion-ai-idle-aircraft-game {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-aircraft-game 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-neural-pulse {
  animation: motion-ai-idle-aircraft-game 2s ease-in-out infinite alternate;
}
</style>