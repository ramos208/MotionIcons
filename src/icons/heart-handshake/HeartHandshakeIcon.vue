...
// AI Generated Motion Component for: heart-handshake
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for heart-handshake (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-heart-handshake {
...
@keyframes motion-ai-idle-heart-handshake {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-heart-handshake 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-heart-handshake 3s ease-in-out infinite alternate;
}
</style>