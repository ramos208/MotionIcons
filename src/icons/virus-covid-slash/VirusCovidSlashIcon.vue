...
@keyframes motion-ai-virus-covid-slash {
...
@keyframes motion-ai-idle-virus-covid-slash {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-virus-covid-slash 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-virus-covid-slash 3s ease-in-out infinite alternate;
}
</style>