...
@keyframes motion-ai-bitcoin-mail {
...
@keyframes motion-ai-idle-bitcoin-mail {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-bitcoin-mail 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-bitcoin-mail 2.5s ease-in-out infinite alternate;
}
</style>