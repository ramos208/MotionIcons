...
// AI Generated Motion Component for: flying-saucer
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for flying-saucer (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-flying-saucer {
...
@keyframes motion-ai-idle-flying-saucer {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-flying-saucer 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-flying-saucer 3s ease-in-out infinite alternate;
}
</style>