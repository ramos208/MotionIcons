...
// AI Generated Motion Component for: rewind-backward-10
// Category: weather
// Physics Presets: Dynamic kinetic adaptation for rewind-backward-10 (tabler). Selected semantic motion: turbulence with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-rewind-backward-10 {
...
@keyframes motion-ai-idle-rewind-backward-10 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-rewind-backward-10 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-rewind-backward-10 3s ease-in-out infinite alternate;
}
</style>