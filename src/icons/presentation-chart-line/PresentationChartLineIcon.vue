...
// AI Generated Motion Component for: presentation-chart-line
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for presentation-chart-line (heroicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-presentation-chart-line {
...
@keyframes motion-ai-idle-presentation-chart-line {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-presentation-chart-line 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-presentation-chart-line 3s ease-in-out infinite alternate;
}
</style>