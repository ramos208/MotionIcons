...
// AI Generated Motion Component for: letter-e-small
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for letter-e-small (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-letter-e-small {
...
@keyframes motion-ai-idle-letter-e-small {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-letter-e-small 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-letter-e-small 3s ease-in-out infinite alternate;
}
</style>