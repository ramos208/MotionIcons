...
// AI Generated Motion Component for: exclamation-mark-off
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for exclamation-mark-off (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-exclamation-mark-off {
...
@keyframes motion-ai-idle-exclamation-mark-off {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-exclamation-mark-off 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-exclamation-mark-off 3s ease-in-out infinite alternate;
}
</style>