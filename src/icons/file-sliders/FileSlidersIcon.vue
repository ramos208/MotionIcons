...
@keyframes motion-ai-file-sliders {
...
@keyframes motion-ai-idle-file-sliders {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-sliders 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-sliders 3s ease-in-out infinite alternate;
}
</style>