...
// AI Generated Motion Component for: shield-down
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for shield-down (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-shield-down {
...
@keyframes motion-ai-idle-shield-down {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-shield-down 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-shield-down 3s ease-in-out infinite alternate;
}
</style>