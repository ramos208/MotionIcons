...
@keyframes motion-ai-liberadotchat {
...
@keyframes motion-ai-idle-liberadotchat {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-liberadotchat 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-liberadotchat 2.5s ease-in-out infinite alternate;
}
</style>