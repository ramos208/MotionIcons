...
@keyframes motion-ai-waving-hand01 {
...
@keyframes motion-ai-idle-waving-hand01 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-waving-hand01 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-waving-hand01 3s ease-in-out infinite alternate;
}
</style>