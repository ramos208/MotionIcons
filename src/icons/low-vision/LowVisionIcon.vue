...
// AI Generated Motion Component for: low-vision
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for low-vision (fontawesome). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-low-vision {
...
@keyframes motion-ai-idle-low-vision {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-low-vision 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-low-vision 3s ease-in-out infinite alternate;
}
</style>