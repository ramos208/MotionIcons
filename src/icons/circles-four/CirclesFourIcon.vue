...
// AI Generated Motion Component for: circles-four
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for circles-four (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-circles-four {
...
@keyframes motion-ai-idle-circles-four {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-circles-four 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-circles-four 3s ease-in-out infinite alternate;
}
</style>