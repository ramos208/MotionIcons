...
@keyframes motion-ai-chromecast-active {
...
@keyframes motion-ai-idle-chromecast-active {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-chromecast-active 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-chromecast-active 3s ease-in-out infinite alternate;
}
</style>