...
// AI Generated Motion Component for: love-korean-finger
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for love-korean-finger (hugeicons). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-love-korean-finger {
...
@keyframes motion-ai-idle-love-korean-finger {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-love-korean-finger 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-love-korean-finger 3s ease-in-out infinite alternate;
}
</style>