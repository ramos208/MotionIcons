...
// AI Generated Motion Component for: corner-up-right-double
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for corner-up-right-double (tabler). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-corner-up-right-double {
...
@keyframes motion-ai-idle-corner-up-right-double {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-corner-up-right-double 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-corner-up-right-double 3s ease-in-out infinite alternate;
}
</style>