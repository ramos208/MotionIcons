...
@keyframes motion-ai-file-minus {
...
@keyframes motion-ai-idle-file-minus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-minus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-minus 3s ease-in-out infinite alternate;
}
</style>