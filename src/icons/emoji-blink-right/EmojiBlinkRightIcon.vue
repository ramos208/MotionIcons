...
// AI Generated Motion Component for: emoji-blink-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for emoji-blink-right (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-emoji-blink-right {
...
@keyframes motion-ai-idle-emoji-blink-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-emoji-blink-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-emoji-blink-right 3s ease-in-out infinite alternate;
}
</style>