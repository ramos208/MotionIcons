...
// AI Generated Motion Component for: file-cog-2
// Category: mechanical
// Physics Presets: Dynamic kinetic adaptation for file-cog-2 (lucide). Selected semantic motion: mechanical with custom idle (ambient-floating) and interaction profile (gear-rotate) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-file-cog-2 {
...
@keyframes motion-ai-idle-file-cog-2 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-file-cog-2 0.45s cubic-bezier(0.76, 0, 0.24, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-file-cog-2 3s ease-in-out infinite alternate;
}
</style>