...
// AI Generated Motion Component for: pause-octagon
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for pause-octagon (lucide). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-pause-octagon {
...
@keyframes motion-ai-idle-pause-octagon {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-pause-octagon 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-pause-octagon 3s ease-in-out infinite alternate;
}
</style>