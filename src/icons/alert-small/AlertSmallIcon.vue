...
// AI Generated Motion Component for: alert-small
// Category: notification
// Physics Presets: Dynamic kinetic adaptation for alert-small (tabler). Selected semantic motion: pendulum with custom idle (subtle-drift) and interaction profile (bell-ring) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-alert-small {
...
@keyframes motion-ai-idle-alert-small {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-alert-small 0.5s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards;
}

.anim-subtle-drift {
  animation: motion-ai-idle-alert-small 2.5s ease-in-out infinite alternate;
}
</style>