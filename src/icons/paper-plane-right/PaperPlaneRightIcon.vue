...
// AI Generated Motion Component for: paper-plane-right
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for paper-plane-right (phosphor). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (kinetic-push) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-paper-plane-right {
...
@keyframes motion-ai-idle-paper-plane-right {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-paper-plane-right 0.25s cubic-bezier(0.25, 1, 0.5, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-paper-plane-right 3s ease-in-out infinite alternate;
}
</style>