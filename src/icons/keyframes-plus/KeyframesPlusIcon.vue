...
// AI Generated Motion Component for: keyframes-plus
// Category: generic
// Physics Presets: Dynamic kinetic adaptation for keyframes-plus (iconoir). Selected semantic motion: radar with custom idle (ambient-floating) and interaction profile (elastic-scale) matched to SVG complexity (complex) and flow geometry.
...
@keyframes motion-ai-keyframes-plus {
...
@keyframes motion-ai-idle-keyframes-plus {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-keyframes-plus 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-ambient-floating {
  animation: motion-ai-idle-keyframes-plus 3s ease-in-out infinite alternate;
}
</style>