...
@keyframes motion-ai-camera-rotated02 {
...
@keyframes motion-ai-idle-camera-rotated02 {
...
.ai-motion-icon-wrapper:hover .icon-geometry {
  animation: motion-ai-camera-rotated02 0.35s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}

.anim-gear-sync {
  animation: motion-ai-idle-camera-rotated02 4s linear infinite alternate;
}
</style>